---
name: pp-openai-ads
description: "The first OpenAI Ads client that can write, and the only one that keeps local history. Trigger phrases: `check my ChatGPT ads`, `how is my openai ads campaign pacing`, `what changed in my ad account`, `which ads are getting tired`, `audit my openai ads account structure`, `use openai-ads`, `run openai-ads`."
author: "bobe"
license: "Apache-2.0"
...
metadata:
  openclaw:
    ...
    install:
      - kind: go
        bins: [openai-ads-pp-cli]
        module: github.com/mvanhorn/printing-press-library/library/marketing/openai-ads/cmd/openai-ads-pp-cli
---
...
1. Check if installed: `which openai-ads-pp-cli`
