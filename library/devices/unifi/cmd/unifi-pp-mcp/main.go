...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/devices/unifi/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("UNIFI_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "unifi-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
