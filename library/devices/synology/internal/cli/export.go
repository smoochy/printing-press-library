...
large datasets as it has no memory pressure.`,
  ...
  synology-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  synology-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  synology-pp-cli export <resource> --format jsonl | jq '.id'`,
