...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("SYNOLOGY_STATE_DIR", "")
	t.Setenv("SYNOLOGY_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"synology-pp-cli auth login",
		"synology-pp-cli doctor",
		"synology-pp-cli help items",
		"synology-pp-cli sync",
		"synology-pp-cli profile list",
		"synology-pp-cli feedback list",
		"synology-pp-cli which",
		"synology-pp-cli agent-context",
		"synology-pp-cli completion bash",
		"synology-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"synology-pp-cli recall",
		"synology-pp-cli learnings",
		"synology-pp-cli teach-pattern",
		"synology-pp-cli teach-lookup",
		"synology-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("synology-pp-cli")); err == nil {
