...
but do not stop the import.`,
  ...
  googlehealth-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  googlehealth-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | googlehealth-pp-cli import <resource> --input -`,
