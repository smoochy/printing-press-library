...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "googlehealth-pp-cli",
		Short: "Manage googlehealth resources via the googlehealth API",
		Long: `Manage googlehealth resources via the googlehealth API.
...
Run 'googlehealth-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("googlehealth-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'googlehealth-pp-cli profile list')")
	...
	rootCmd.AddCommand(newStreaksCmd(flags))
