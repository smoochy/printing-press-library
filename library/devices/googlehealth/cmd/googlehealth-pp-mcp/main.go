...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/devices/googlehealth/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "googlehealth-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
