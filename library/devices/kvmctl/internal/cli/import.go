...
but do not stop the import.`,
  ...
  kvmctl-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  kvmctl-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | kvmctl-pp-cli import <resource> --input -`,
