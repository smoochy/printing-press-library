...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/devices/averusa/internal/cli"
	mcptools "github.com/mvanhorn/printing-press-library/library/devices/averusa/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("AVERUSA_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "averusa-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
