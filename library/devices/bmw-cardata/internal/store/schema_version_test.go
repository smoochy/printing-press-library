...
func TestMigrate_AddsColumnsOnUpgrade_Customers(t *testing.T) {
	...
	for _, want := range []string{
		...
		"displayed_start_soc",
		"end_time",
		"energy_consumed_from_power_grid_kwh",
		"energy_decrease_hvb_kwh",
		"energy_discharged_kwh",
		"is_preconditioning_activated",
		"mileage",
		"mileage_units",
		"start_time",
		"time_zone",
		"total_charging_duration_sec",
		"ac_current_limit",
		"ac_current_limit_flag",
		"acoustic_limit",
		"charging_mode",
		"charging_plug",
		"cluster_location_id",
		...
		"latitude",
		"longitude",
		"optimized_charging_preference",
		"start_charging_time_period_hour",
		"start_charging_time_period_minute",
		"stop_charging_time_period_hour",
		"stop_charging_time_period_minute",
		"vehicle_id_with_gcid",
		"visits",
		"mapped_since",
		"mapping_type",
		"vin",
