...
Resource scoping:
  ...
  bmw-cardata-pp-cli sync

  # Sync specific resources only
  bmw-cardata-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  bmw-cardata-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  bmw-cardata-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  bmw-cardata-pp-cli sync --concurrency 8
  ...
  bmw-cardata-pp-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/bmw-cardata-pp-cli/data.db)")
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"customers": "/customers/containers",
	}
