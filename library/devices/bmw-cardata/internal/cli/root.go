...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "bmw-cardata-pp-cli",
		Short: `Bmw Cardata CLI — Your BMW's telemetry, on the command line — device-code login, live telematic snapshots, charging history, and a local …`,
		Long: `Bmw Cardata CLI — Your BMW's telemetry, on the command line — device-code login, live telematic snapshots, charging history, and a local …
...
See README.md or the bundled SKILL.md for recipes.`,
	...
	rootCmd.SetVersionTemplate("bmw-cardata-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'bmw-cardata-pp-cli profile list')")
	...
	rootCmd.AddCommand(newNovelBatteryHealthCmd(flags))
	rootCmd.AddCommand(newNovelChargingCostCmd(flags))
	rootCmd.AddCommand(newNovelDescriptorsCmd(flags))
	rootCmd.AddCommand(newNovelFleetCmd(flags))
	rootCmd.AddCommand(newNovelQuotaCmd(flags))
	rootCmd.AddCommand(newNovelSocTrendsCmd(flags))
	rootCmd.AddCommand(newNovelTripsCmd(flags))
	rootCmd.AddCommand(newNovelVehiclesCmd(flags))
	rootCmd.AddCommand(newArchiveCmd(flags))
	rootCmd.AddCommand(newStreamCmd(flags))
