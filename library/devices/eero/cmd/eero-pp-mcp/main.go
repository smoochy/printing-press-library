...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/devices/eero/internal/cli"
	mcptools "github.com/mvanhorn/printing-press-library/library/devices/eero/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("EERO_LEARN_SURFACE", "mcp")
