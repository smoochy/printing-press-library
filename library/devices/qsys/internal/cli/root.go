...
type rootFlags struct {
	...
	// invocation. Mirrors the QSYS_NO_LEARN env var.
	noLearn                 bool
	selectFields            string
	configPath              string
	homePath                string
...
See README.md or the bundled SKILL.md for recipes.`,
	...
	rootCmd.SetVersionTemplate("qsys-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.runProfileName, "profile", "", "Apply values from a saved run profile; this does not select a client (see 'qsys-pp-cli profile list')")
	...
	rootCmd.AddCommand(newNetworkingPromotedCmd(flags))
