...
func newPageGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get <topic>",
		Short:       "Fetch a Q-SYS Help documentation page as clean text",
		Example:     "  qsys-pp-cli page get Networking/Dante_Audio.htm",
		Annotations: map[string]string{"pp:method": "GET", "pp:path": "/Content/{topic}", "mcp:read-only": "true", "pp:happy-args": "topic=Networking/Dante_Audio.htm"},
