...
func buildAgentDiscoveryContext() *agentContextDiscovery {
	return &agentContextDiscovery{
		...
		TargetURL:     "https://www.nccpl.com.pk/",
		EntryCount:    204,
		APIEntryCount: 51,
		...
		CandidateCommands: []string{
			"create_data_by_date_range — Derived from observed POST /api/graph-data/data-by-date-range traffic.",
			"create_rum — Derived from observed POST /cdn-cgi/rum traffic.",
			"list_latest_data — Derived from observed GET /api/graph-data/latest-data traffic.",
			"list_latest_date — Derived from observed GET /api/financiers-financees/latest-date traffic.",
		},
	}
}
