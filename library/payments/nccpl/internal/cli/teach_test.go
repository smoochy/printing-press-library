...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"nccpl-pp-cli auth login",
		"nccpl-pp-cli doctor",
		"nccpl-pp-cli help items",
		"nccpl-pp-cli sync",
		"nccpl-pp-cli profile list",
		"nccpl-pp-cli feedback list",
		"nccpl-pp-cli which",
		"nccpl-pp-cli agent-context",
		"nccpl-pp-cli completion bash",
		"nccpl-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"nccpl-pp-cli teach",
		"nccpl-pp-cli recall",
		"nccpl-pp-cli learnings",
		"nccpl-pp-cli teach-pattern",
		"nccpl-pp-cli teach-lookup",
		"nccpl-pp-cli items list",
	}
