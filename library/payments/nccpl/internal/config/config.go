...
func Load(configPath string) (*Config, error) {
	cfg := &Config{
		BaseURL: "https://www.nccpl.com.pk",
	}
	...
	// Env var overrides
	if v := strings.ToLower(strings.TrimSpace(os.Getenv("NCCPL_SKIP_TLS_VERIFY"))); v == "1" || v == "true" || v == "yes" || v == "on" {
	...
	if v := os.Getenv("NCCPL_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("NCCPL_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "nccpl-pp-cli", "config.toml"), nil
}
