...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/payments/psx/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("PSX_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "psx-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
