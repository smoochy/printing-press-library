...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"mufap-pp-cli auth login",
		"mufap-pp-cli doctor",
		"mufap-pp-cli help items",
		"mufap-pp-cli sync",
		"mufap-pp-cli profile list",
		"mufap-pp-cli feedback list",
		"mufap-pp-cli which",
		"mufap-pp-cli agent-context",
		"mufap-pp-cli completion bash",
		"mufap-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"mufap-pp-cli teach",
		"mufap-pp-cli recall",
		"mufap-pp-cli learnings",
		"mufap-pp-cli teach-pattern",
		"mufap-pp-cli teach-lookup",
		"mufap-pp-cli items list",
	}
