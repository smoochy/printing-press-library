...
func newNetsalesInvestorCmd(flags *rootFlags) *cobra.Command {
	var flagMonth string
	var flagYear string

	cmd := &cobra.Command{
		Use:         "investor",
		Short:       "The same month split across NINE investor classes -- Individuals, Banking & Financial Institutions, Provident fund",
		Example:     "  mufap-pp-cli netsales investor --month 5 --year 2026 --json",
		Annotations: map[string]string{"pp:endpoint": "netsales.investor", "pp:method": "GET", "pp:path": "/Industry/WebMonthlyNetAssetsInvestor", "mcp:read-only": "true", "pp:requires-input": "true", "pp:happy-args": "--month=5;--year=2026"},
