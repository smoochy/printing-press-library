...
func Load(configPath string) (*Config, error) {
	cfg := &Config{
		BaseURL: "https://www.mufap.com.pk",
	}
	...
	if v := os.Getenv("MUFAP_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("MUFAP_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "mufap-pp-cli", "config.toml"), nil
}
