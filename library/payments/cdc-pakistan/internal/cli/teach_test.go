...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/payments/cdc-pakistan/internal/cliutil/testenv"
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"cdc-pakistan-pp-cli auth login",
		"cdc-pakistan-pp-cli doctor",
		"cdc-pakistan-pp-cli help items",
		"cdc-pakistan-pp-cli sync",
		"cdc-pakistan-pp-cli profile list",
		"cdc-pakistan-pp-cli feedback list",
		"cdc-pakistan-pp-cli which",
		"cdc-pakistan-pp-cli agent-context",
		"cdc-pakistan-pp-cli completion bash",
		"cdc-pakistan-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"cdc-pakistan-pp-cli recall",
		"cdc-pakistan-pp-cli learnings",
		"cdc-pakistan-pp-cli teach-pattern",
		"cdc-pakistan-pp-cli teach-lookup",
		"cdc-pakistan-pp-cli items list",
	}
