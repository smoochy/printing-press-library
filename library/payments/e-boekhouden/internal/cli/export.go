...
large datasets as it has no memory pressure.`,
  ...
  e-boekhouden-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  e-boekhouden-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  e-boekhouden-pp-cli export <resource> --format jsonl | jq '.id'`,
