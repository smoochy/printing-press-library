...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "e-boekhouden-pp-cli",
		Short: `E Boekhouden CLI — Balance, profit & loss, and journal entries from your terminal — with local financial reports and write-safety guards t…`,
		Long: `E Boekhouden CLI — Balance, profit & loss, and journal entries from your terminal — with local financial reports and write-safety guards t…
...
Health check: run 'e-boekhouden-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("e-boekhouden-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'e-boekhouden-pp-cli profile list')")
	...
	rootCmd.AddCommand(newInvoicetemplatePromotedCmd(flags))
	rootCmd.AddCommand(newUnitPromotedCmd(flags))
