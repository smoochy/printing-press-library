...
but do not stop the import.`,
  ...
  e-boekhouden-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  e-boekhouden-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | e-boekhouden-pp-cli import <resource> --input -`,
