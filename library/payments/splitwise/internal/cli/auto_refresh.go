...
var readCommandResources = map[string][]string{
	"splitwise-pp-cli get-categories":           {"get-categories"},
	"splitwise-pp-cli get-categories list":      {"get-categories"},
	"splitwise-pp-cli get-categories get":       {"get-categories"},
	"splitwise-pp-cli get-categories search":    {"get-categories"},
	"splitwise-pp-cli get-comments":             {"get-comments"},
	"splitwise-pp-cli get-comments list":        {"get-comments"},
	"splitwise-pp-cli get-comments get":         {"get-comments"},
	"splitwise-pp-cli get-comments search":      {"get-comments"},
	"splitwise-pp-cli get-currencies":           {"get-currencies"},
	"splitwise-pp-cli get-currencies list":      {"get-currencies"},
	"splitwise-pp-cli get-currencies get":       {"get-currencies"},
	"splitwise-pp-cli get-currencies search":    {"get-currencies"},
	"splitwise-pp-cli get-current-user":         {"get-current-user"},
	"splitwise-pp-cli get-current-user list":    {"get-current-user"},
	"splitwise-pp-cli get-current-user get":     {"get-current-user"},
	"splitwise-pp-cli get-current-user search":  {"get-current-user"},
	"splitwise-pp-cli get-expenses":             {"get-expenses"},
	"splitwise-pp-cli get-expenses list":        {"get-expenses"},
	"splitwise-pp-cli get-expenses get":         {"get-expenses"},
	"splitwise-pp-cli get-expenses search":      {"get-expenses"},
	"splitwise-pp-cli get-friends":              {"get-friends"},
	"splitwise-pp-cli get-friends list":         {"get-friends"},
	"splitwise-pp-cli get-friends get":          {"get-friends"},
	"splitwise-pp-cli get-friends search":       {"get-friends"},
	"splitwise-pp-cli get-groups":               {"get-groups"},
	"splitwise-pp-cli get-groups list":          {"get-groups"},
	"splitwise-pp-cli get-groups get":           {"get-groups"},
	"splitwise-pp-cli get-groups search":        {"get-groups"},
	"splitwise-pp-cli get-notifications":        {"get-notifications"},
	"splitwise-pp-cli get-notifications list":   {"get-notifications"},
	"splitwise-pp-cli get-notifications get":    {"get-notifications"},
	"splitwise-pp-cli get-notifications search": {"get-notifications"},
}
...
func cachePolicy() cliutil.Policy {
	...
	envOptOut := "SPLITWISE_NO_AUTO_REFRESH"
...
func autoRefreshIfStale(ctx context.Context, flags *rootFlags, resources []string) (meta cliutil.FreshnessMeta) {
	...
	if err := runAutoRefresh(refreshCtx, flags, db, resources); err != nil {
		fmt.Fprintf(os.Stderr, "warning: using stale splitwise-pp-cli cache (refresh failed: %v)\n", err)
