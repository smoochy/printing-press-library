...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/payments/splitwise/internal/cliutil/testenv"
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"splitwise-pp-cli auth login",
		"splitwise-pp-cli doctor",
		"splitwise-pp-cli help items",
		"splitwise-pp-cli sync",
		"splitwise-pp-cli profile list",
		"splitwise-pp-cli feedback list",
		"splitwise-pp-cli which",
		"splitwise-pp-cli agent-context",
		"splitwise-pp-cli completion bash",
		"splitwise-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"splitwise-pp-cli recall",
		"splitwise-pp-cli learnings",
		"splitwise-pp-cli teach-pattern",
		"splitwise-pp-cli teach-lookup",
		"splitwise-pp-cli items list",
	}
