...
Resource scoping:
  ...
  mcpmarket-pp-cli sync --resources category,server

  # Full resync (ignore previous checkpoint)
  mcpmarket-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  mcpmarket-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  mcpmarket-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  mcpmarket-pp-cli sync --latest-only`,
