...
var whichIndex = []whichEntry{
	{Command: "trending", Description: "See which MCP servers/skills are rising fastest vs. holding steady, computed from your own browse history.", Group: "Local state that compounds", WhyItMatters: "Use this before picking a tool when momentum matters more than raw popularity."},
	{Command: "diff", Description: "See exactly which servers, clients, or skills were added, removed, or changed between two snapshots.", Group: "Local state that compounds", WhyItMatters: "Use this to audit what changed in the catalog over a release cycle."},
	{Command: "author", Description: "See everything one GitHub org has published across servers, skills, and clients in one view.", Group: "Local state that compounds", WhyItMatters: "Use this to evaluate an author's full footprint before trusting one of their servers."},
	{Command: "leaderboard", Description: "See what the top-100 leaderboard looked like on a past date, not just right now.", Group: "Local state that compounds", WhyItMatters: "Use this to answer 'what was trending three weeks ago' without external archives."},
	{Command: "stack", Description: "Chain the similar-tools recommendation graph multiple hops to build a ranked shortlist around a server you already use.", Group: "Agent-native plumbing", WhyItMatters: "Use this to discover a full toolchain, not just one related item at a time."},
	{Command: "watch category", Description: "Flag newly-appeared listings in a category since your last check.", Group: "Local state that compounds", WhyItMatters: "Use this to stay current on a category you track without re-browsing it manually."},
	{Command: "dedupe", Description: "Surface near-identical listings from different authors within a category.", Group: "Local state that compounds", WhyItMatters: "Use this to avoid installing three servers that all do the same thing."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  mcpmarket-pp-cli which "stale tickets"
  mcpmarket-pp-cli which "bottleneck"
  mcpmarket-pp-cli which --limit 1 "send message"
  mcpmarket-pp-cli which                                # list the full capability index`,
