...
large datasets as it has no memory pressure.`,
  ...
  mcpmarket-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  mcpmarket-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  mcpmarket-pp-cli export <resource> --format jsonl | jq '.id'`,
