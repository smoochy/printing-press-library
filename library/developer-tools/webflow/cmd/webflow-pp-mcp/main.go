...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/developer-tools/webflow/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("WEBFLOW_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "webflow-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
