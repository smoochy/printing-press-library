...
func Load(configPath string) (*Config, error) {
	...
	if v := os.Getenv("IS_AGENTIC_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("IS_AGENTIC_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "is-agentic-pp-cli", "config.toml"), nil
}
