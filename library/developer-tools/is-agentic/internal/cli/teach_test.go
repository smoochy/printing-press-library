...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/developer-tools/is-agentic/internal/cliutil/testenv"
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"is-agentic-pp-cli auth login",
		"is-agentic-pp-cli doctor",
		"is-agentic-pp-cli help items",
		"is-agentic-pp-cli sync",
		"is-agentic-pp-cli profile list",
		"is-agentic-pp-cli feedback list",
		"is-agentic-pp-cli which",
		"is-agentic-pp-cli agent-context",
		"is-agentic-pp-cli completion bash",
		"is-agentic-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"is-agentic-pp-cli recall",
		"is-agentic-pp-cli learnings",
		"is-agentic-pp-cli teach-pattern",
		"is-agentic-pp-cli teach-lookup",
		"is-agentic-pp-cli items list",
	}
