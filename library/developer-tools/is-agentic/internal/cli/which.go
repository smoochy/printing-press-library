...
var whichIndex = []whichEntry{
	{Command: "history", Description: "Keep a local, timestamped ledger of readiness reports and their provenance.", Group: "Local evidence that compounds", WhyItMatters: "Choose this when you need an auditable local timeline instead of one ephemeral API response."},
	{Command: "diff", Description: "See which readiness scores and findings changed between two retained audits.", Group: "Local evidence that compounds", WhyItMatters: "Choose this after a deployment to verify whether agent-readiness regressions were introduced or fixed."},
	{Command: "check", Description: "Fail CI with an explicit, machine-readable readiness policy decision.", Group: "Release and fleet controls", WhyItMatters: "Choose this when a release pipeline must enforce readiness instead of merely displaying it."},
	{Command: "portfolio", Description: "Compare a fleet of public sites in one sortable score and issue matrix.", Group: "Release and fleet controls", WhyItMatters: "Choose this for platform or agency work spanning multiple public targets."},
	{Command: "issues", Description: "Track when readiness findings first appeared, last appeared, were fixed, or regressed.", Group: "Local evidence that compounds", WhyItMatters: "Choose this to turn recurring findings into a remediation queue with honest history."},
	{Command: "portfolio", Description: "Refresh many targets with bounded concurrency, deduplication, and Retry-After-aware pacing.", Group: "Release and fleet controls", WhyItMatters: "Choose this for repeatable fleet refreshes that must respect the public 120-per-minute quota."},
	{Command: "evidence", Description: "Package a report and its provenance into a portable evidence artifact.", Group: "Portable audit artifacts", WhyItMatters: "Choose this when an audit must travel with a review, ticket, or release artifact."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  is-agentic-pp-cli which "stale tickets"
  is-agentic-pp-cli which "bottleneck"
  is-agentic-pp-cli which --limit 1 "send message"
  is-agentic-pp-cli which                                # list the full capability index`,
