...
large datasets as it has no memory pressure.`,
  ...
  is-agentic-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  is-agentic-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  is-agentic-pp-cli export <resource> --format jsonl | jq '.id'`,
