...
const (
	journalSessionEnvVar   = "ONEWORD_DOMAINS_LEARN_SESSION"
	journalNoLearnEnvVar   = "ONEWORD_DOMAINS_NO_LEARN"
	journalNoCaptureEnvVar = "ONEWORD_DOMAINS_LEARN_NO_CAPTURE"
)
