...
func Load(configPath string) (*Config, error) {
	...
	if v := cliutil.EnvOverride("ONEWORD_DOMAINS_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("ONEWORD_DOMAINS_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "oneword-domains-pp-cli", "config.toml"), nil
}
