...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"oneword-domains-pp-cli auth login",
		"oneword-domains-pp-cli doctor",
		"oneword-domains-pp-cli help items",
		"oneword-domains-pp-cli sync",
		"oneword-domains-pp-cli profile list",
		"oneword-domains-pp-cli feedback list",
		"oneword-domains-pp-cli which",
		"oneword-domains-pp-cli agent-context",
		"oneword-domains-pp-cli completion bash",
		"oneword-domains-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"oneword-domains-pp-cli recall",
		"oneword-domains-pp-cli learnings",
		"oneword-domains-pp-cli teach-pattern",
		"oneword-domains-pp-cli teach-lookup",
		"oneword-domains-pp-cli items list",
	}
