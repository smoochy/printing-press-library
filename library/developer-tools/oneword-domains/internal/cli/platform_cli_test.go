...
func TestPlatformMigrationAdoptsOnlyVerifiedTenantDatabase(t *testing.T) {
	...
	paths, err := platform.PathsFor("tenant-adopt", "oneword-domains-pp-cli", "test-source")
	if err != nil {
		t.Fatal(err)
	}
...
func TestPlatformMigrationWrongTenantCannotCreateProfile(t *testing.T) {
	...
	paths, err := platform.PathsFor("tenant-rejected", "oneword-domains-pp-cli", "test-source")
	if err != nil {
		t.Fatal(err)
	}
