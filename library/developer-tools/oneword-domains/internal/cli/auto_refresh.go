...
var readCommandResources = map[string][]string{
	"oneword-domains-pp-cli domains":                 {"domains"},
	"oneword-domains-pp-cli domains list":            {"domains"},
	"oneword-domains-pp-cli domains get":             {"domains"},
	"oneword-domains-pp-cli domains search":          {"domains"},
	"oneword-domains-pp-cli gpt":                     {"gpt"},
	"oneword-domains-pp-cli gpt list":                {"gpt"},
	"oneword-domains-pp-cli gpt get":                 {"gpt"},
	"oneword-domains-pp-cli gpt search":              {"gpt"},
	"oneword-domains-pp-cli listings":                {"listings"},
	"oneword-domains-pp-cli listings list":           {"listings"},
	"oneword-domains-pp-cli listings get":            {"listings"},
	"oneword-domains-pp-cli listings search":         {"listings"},
	"oneword-domains-pp-cli listings-filters":        {"listings-filters"},
	"oneword-domains-pp-cli listings-filters list":   {"listings-filters"},
	"oneword-domains-pp-cli listings-filters get":    {"listings-filters"},
	"oneword-domains-pp-cli listings-filters search": {"listings-filters"},
	"oneword-domains-pp-cli tlds":                    {"tlds"},
	"oneword-domains-pp-cli tlds list":               {"tlds"},
	"oneword-domains-pp-cli tlds get":                {"tlds"},
	"oneword-domains-pp-cli tlds search":             {"tlds"},
	"oneword-domains-pp-cli words":                   {"words"},
	"oneword-domains-pp-cli words list":              {"words"},
	"oneword-domains-pp-cli words get":               {"words"},
	"oneword-domains-pp-cli words search":            {"words"},
}
...
func cachePolicy() cliutil.Policy {
	...
	envOptOut := "ONEWORD_DOMAINS_NO_AUTO_REFRESH"
...
func autoRefreshIfStale(ctx context.Context, flags *rootFlags, resources []string) (meta cliutil.FreshnessMeta) {
	...
	if err := runAutoRefresh(refreshCtx, flags, db, resources); err != nil {
		fmt.Fprintf(os.Stderr, "warning: using stale oneword-domains-pp-cli cache (refresh failed: %v)\n", err)
