# GitHub Printed CLI Agent Guide

This directory is a generated `github-pp-cli` printed CLI. It was produced by [CLI Printing Press](https://github.com/mvanhorn/cli-printing-press), so treat systemic fixes as upstream Printing Press fixes first. Keep local edits narrow and document why a generated-tree patch belongs here.
...
```bash
github-pp-cli doctor --json
github-pp-cli agent-context --pretty
```

Use runtime discovery instead of relying on a copied command list:

```bash
github-pp-cli which "<capability>" --json
github-pp-cli <command> --help
```
...
```bash
github-pp-cli <command> --help
github-pp-cli <command> --dry-run --agent
```
