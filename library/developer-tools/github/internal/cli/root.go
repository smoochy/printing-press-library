...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "github-pp-cli",
		Short: `Github CLI — Every gh issue, PR, repo, and code-search workflow, plus a local SQLite mirror, offline full-text search, and cross-ent…`,
		Long: `Github CLI — Every gh issue, PR, repo, and code-search workflow, plus a local SQLite mirror, offline full-text search, and cross-ent…
...
Health check: run 'github-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("github-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'github-pp-cli profile list')")
	...
	rootCmd.AddCommand(newAssigneesCmd(flags))
	...
	rootCmd.AddCommand(newCommitsCmd(flags))
	rootCmd.AddCommand(newContentsCmd(flags))
	rootCmd.AddCommand(newGithubSearchCmd(flags))
	rootCmd.AddCommand(newIssuesCmd(flags))
	rootCmd.AddCommand(newLabelsCmd(flags))
	rootCmd.AddCommand(newMilestonesCmd(flags))
	rootCmd.AddCommand(newPullsCmd(flags))
