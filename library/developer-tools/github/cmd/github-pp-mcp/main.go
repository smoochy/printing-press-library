...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/developer-tools/github/internal/mcp"
)
...
// streamable HTTP when hosted in a container or remote sandbox.
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "github-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
