...
func Load(configPath string) (*Config, error) {
	...
	if v := os.Getenv("BING_WEBMASTER_API_KEY"); v != "" {
		...
		cfg.markEnvOverride("BingWebmasterApiKey")
...
func (c *Config) SaveCredential(token string) error {
	...
	delete(c.envOverrides, "BingWebmasterApiKey")
	c.updateFileConfigField("BingWebmasterApiKey")
	if err := c.saveCredentialsFirst(); err != nil {
		return err
	}
	return c.save()
...
func (c *Config) configForSave() Config {
	out := *c
	if c.fileConfig != nil {
		if c.envOverrides["BingWebmasterApiKey"] {
			out.BingWebmasterApiKey = c.fileConfig.BingWebmasterApiKey
		}
	}
...
func (c *Config) updateFileConfigField(field string) {
	...
	case "BingWebmasterApiKey":
		c.fileConfig.BingWebmasterApiKey = c.BingWebmasterApiKey
	}
}
