...
func runCLI(t *testing.T, args ...string) error {
	t.Helper()
	oldArgs := os.Args
	os.Args = append([]string{"bing-webmaster-pp-cli"}, args...)
...
func TestJournal_DisableSwitchesWriteNothing(t *testing.T) {
	cases := []struct {
		...
		{name: "master no-learn env", env: map[string]string{"BING_WEBMASTER_NO_LEARN": "1"}},
		{name: "capture-only env", env: map[string]string{"BING_WEBMASTER_LEARN_NO_CAPTURE": "1"}},
