...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/developer-tools/bing-webmaster/internal/learn/lookups"
...
Resource scoping:
  ...
  bing-webmaster-pp-cli sync --resources blocked,blocked-get-active-page-preview-blocks
...
func knownSyncResourceNames() []string {
	names := []string{
		"blocked",
		"blocked-get-active-page-preview-blocks",
		"crawl",
		"crawl-get-crawl-issues",
		"crawl-get-crawl-stats",
		"deeplinks-get-deep-link-blocks",
		"feeds",
		"feeds-get-feed-details",
		"geo",
		"keywords",
		"keywords-get-keyword-stats",
		"links",
		"params",
		"sites",
		"submission",
		"traffic",
		"traffic-get-page-query-stats",
		"traffic-get-page-stats",
		"traffic-get-query-page-detail-stats",
		"traffic-get-query-page-stats",
		"traffic-get-query-stats",
		"traffic-get-query-traffic-stats",
		"traffic-get-rank-and-traffic-stats",
	}
	return names
}
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{ // #nosec G101 -- endpoint paths, not credentials.
		...
		"blocked-get-active-page-preview-blocks": "/json/GetActivePagePreviewBlocks",
		"crawl":                                  "/json/GetChildrenUrlInfo",
		"crawl-get-crawl-issues":                 "/json/GetCrawlIssues",
		"crawl-get-crawl-stats":                  "/json/GetCrawlStats",
		"deeplinks-get-deep-link-blocks":         "/json/GetDeepLinkBlocks",
		"feeds":                                  "/json/GetFeeds",
		"feeds-get-feed-details":                 "/json/GetFeedDetails",
		"geo":                                    "/json/GetCountryRegionSettings",
		"keywords":                               "/json/GetRelatedKeywords",
		"keywords-get-keyword-stats":             "/json/GetKeywordStats",
		...
		"traffic-get-page-query-stats":           "/json/GetPageQueryStats",
		"traffic-get-page-stats":                 "/json/GetPageStats",
		"traffic-get-query-page-detail-stats":    "/json/GetQueryPageDetailStats",
		"traffic-get-query-page-stats":           "/json/GetQueryPageStats",
		"traffic-get-query-stats":                "/json/GetQueryStats",
		"traffic-get-query-traffic-stats":        "/json/GetQueryTrafficStats",
		"traffic-get-rank-and-traffic-stats":     "/json/GetRankAndTrafficStats",
	}
