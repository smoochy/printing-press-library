...
Run sync first to populate the local search index.`,
  ...
  bing-webmaster-pp-cli search "status"

  # Force local search explicitly
  bing-webmaster-pp-cli search "status" --data-source local
  # Search a specific resource type locally
  bing-webmaster-pp-cli search "status" --type blocked --data-source local
  # JSON output for piping
  bing-webmaster-pp-cli search "status" --json --limit 20`,
