...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/developer-tools/bing-webmaster/internal/cliutil/testenv"
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"bing-webmaster-pp-cli auth login",
		"bing-webmaster-pp-cli doctor",
		"bing-webmaster-pp-cli help items",
		"bing-webmaster-pp-cli sync",
		"bing-webmaster-pp-cli profile list",
		"bing-webmaster-pp-cli feedback list",
		"bing-webmaster-pp-cli which",
		"bing-webmaster-pp-cli agent-context",
		"bing-webmaster-pp-cli completion bash",
		"bing-webmaster-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"bing-webmaster-pp-cli teach",
		"bing-webmaster-pp-cli recall",
		"bing-webmaster-pp-cli learnings",
		"bing-webmaster-pp-cli teach-pattern",
		"bing-webmaster-pp-cli teach-lookup",
		"bing-webmaster-pp-cli items list",
	}
