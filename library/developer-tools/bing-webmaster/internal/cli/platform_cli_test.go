...
func TestPlatformMigrationAdoptsOnlyVerifiedTenantDatabase(t *testing.T) {
	...
	paths, err := platform.PathsFor("tenant-adopt", "bing-webmaster-pp-cli", "test-source")
	if err != nil {
		t.Fatal(err)
	}
...
func TestPlatformMigrationWrongTenantCannotCreateProfile(t *testing.T) {
	...
	paths, err := platform.PathsFor("tenant-rejected", "bing-webmaster-pp-cli", "test-source")
	if err != nil {
		t.Fatal(err)
	}
