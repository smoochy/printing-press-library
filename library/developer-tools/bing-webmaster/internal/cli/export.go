...
large datasets as it has no memory pressure.`,
  ...
  bing-webmaster-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  bing-webmaster-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  bing-webmaster-pp-cli export <resource> --format jsonl | jq '.id'`,
