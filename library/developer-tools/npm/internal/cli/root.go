...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "npm-pp-cli",
		Short: "Manage npm resources via the npm API",
		Long: `Manage npm resources via the npm API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'npm-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("npm-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'npm-pp-cli profile list')")
	...
	rootCmd.AddCommand(newDownloadsCmd(flags))
