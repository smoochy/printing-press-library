...
Resource scoping:
  ...
  apple-search-ads-pp-cli sync

  # Sync specific resources only
  apple-search-ads-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  apple-search-ads-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  apple-search-ads-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  apple-search-ads-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  apple-search-ads-pp-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/apple-search-ads-pp-cli/data.db)")
...
func defaultSyncResources() []string {
	return []string{
		"attribution",
		"attribution-device-send-attribute",
		"attribution-device-tracking-consent",
		"budgetorders",
		"campaigns",
		...
		"custom-reports",
		"deferred-deep-link",
		"deferred-deep-link-resolve",
		"me",
		"search_resource",
		"search_resource-apps",
	}
}
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"attribution":                         "/attribution/device/identify",
		"attribution-device-send-attribute":   "/attribution/device/send-attribute",
		"attribution-device-tracking-consent": "/attribution/device/tracking-consent",
		"budgetorders":                        "/budgetorders",
		"campaigns":                           "/campaigns",
		"countries-or-regions":                "/countries-or-regions",
		"creativeappmappings":                 "/creativeappmappings/devices",
		"creatives":                           "/creatives",
		"custom-reports":                      "/custom-reports",
		"deferred-deep-link":                  "/deferred-deep-link/store",
		"deferred-deep-link-resolve":          "/deferred-deep-link/resolve",
		"me":                                  "/me",
		"search_resource":                     "/search/geo",
		"search_resource-apps":                "/search/apps",
	}
