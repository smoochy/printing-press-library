...
but do not stop the import.`,
  ...
  rapidapi-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  rapidapi-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | rapidapi-pp-cli import <resource> --input -`,
