...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/developer-tools/rapidapi/internal/cliutil/testenv"
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"rapidapi-pp-cli auth login",
		"rapidapi-pp-cli doctor",
		"rapidapi-pp-cli help items",
		"rapidapi-pp-cli sync",
		"rapidapi-pp-cli profile list",
		"rapidapi-pp-cli feedback list",
		"rapidapi-pp-cli which",
		"rapidapi-pp-cli agent-context",
		"rapidapi-pp-cli completion bash",
		"rapidapi-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"rapidapi-pp-cli recall",
		"rapidapi-pp-cli learnings",
		"rapidapi-pp-cli teach-pattern",
		"rapidapi-pp-cli teach-lookup",
		"rapidapi-pp-cli items list",
	}
