...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  rapidapi-pp-cli which "stale tickets"
  rapidapi-pp-cli which "bottleneck"
  rapidapi-pp-cli which --limit 1 "send message"
  rapidapi-pp-cli which                                # list the full capability index`,
