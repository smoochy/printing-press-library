...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/developer-tools/asc/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("ASC_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "asc-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
