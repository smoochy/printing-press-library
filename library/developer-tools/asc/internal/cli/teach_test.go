...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"asc-pp-cli auth login",
		"asc-pp-cli doctor",
		"asc-pp-cli help items",
		"asc-pp-cli sync",
		"asc-pp-cli profile list",
		"asc-pp-cli feedback list",
		"asc-pp-cli which",
		"asc-pp-cli agent-context",
		"asc-pp-cli completion bash",
		"asc-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"asc-pp-cli teach",
		"asc-pp-cli recall",
		"asc-pp-cli learnings",
		"asc-pp-cli teach-pattern",
		"asc-pp-cli teach-lookup",
		"asc-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("asc-pp-cli")); err == nil {
