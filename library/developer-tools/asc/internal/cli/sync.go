...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/developer-tools/asc/internal/learn/lookups"
...
Resource scoping:
  ...
  asc-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  asc-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  asc-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  asc-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  asc-pp-cli sync --latest-only`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if dbPath == "" {
				dbPath = defaultDBPath("asc-pp-cli")
			}
...
func determinePaginationDefaults(resource string) paginationDefaults {
	...
	case "apps/apps_app_store_versions":
		return paginationDefaults{
			cursorParam: "after",
			cursorType:  "offset",
			limitParam:  "limit",
	...
	case "apps/apps_customer_reviews":
		return paginationDefaults{
			cursorParam: "after",
			cursorType:  "offset",
			limitParam:  "limit",
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "app-store-review-details":
		return db.UpsertAppStoreReviewDetails(data)
	case "app-store-versions":
		return db.UpsertAppStoreVersions(data)
	case "app_store_version_submission":
		return db.UpsertAppStoreVersionSubmission(data)
	case "apps":
		return db.UpsertApps(data)
	case "apps_app_store_versions":
		return db.UpsertAppsAppStoreVersions(data)
	case "apps_beta_groups":
		return db.UpsertAppsBetaGroups(data)
	case "apps_builds":
		return db.UpsertAppsBuilds(data)
	case "apps_customer_reviews":
		return db.UpsertAppsCustomerReviews(data)
	case "beta-groups":
		return db.UpsertBetaGroups(data)
	case "beta-testers":
		return db.UpsertBetaTesters(data)
	case "builds":
		return db.UpsertBuilds(data)
	case "customer-reviews":
		return db.UpsertCustomerReviews(data)
	default:
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "apps_app_store_versions", ParentTable: "apps", ParentIDParam: "id", PathTemplate: "/v1/apps/{id}/appStoreVersions", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.app", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "apps_beta_groups", ParentTable: "apps", ParentIDParam: "id", PathTemplate: "/v1/apps/{id}/betaGroups", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.app", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "apps_builds", ParentTable: "apps", ParentIDParam: "id", PathTemplate: "/v1/apps/{id}/builds", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.app", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "apps_customer_reviews", ParentTable: "apps", ParentIDParam: "id", PathTemplate: "/v1/apps/{id}/customerReviews", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.app", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
	}
}
...
func responsePathForResource(resource, path string) []string {
	...
	case "app-store-review-details\x00/v1/appStoreReviewDetails/{id}":
		return []string{"included"}
	case "app-store-versions\x00/v1/appStoreVersions/{id}":
		return []string{"included"}
	case "apps\x00/v1/apps":
		return []string{"data"}
	case "apps\x00/v1/apps/{id}":
		return []string{"included"}
	case "beta-groups\x00/v1/betaGroups":
		return []string{"data"}
	case "beta-groups\x00/v1/betaGroups/{id}":
		return []string{"included"}
	case "beta-testers\x00/v1/betaTesters":
		return []string{"data"}
	case "beta-testers\x00/v1/betaTesters/{id}":
		return []string{"included"}
	case "builds\x00/v1/builds":
		return []string{"data"}
	case "builds\x00/v1/builds/{id}":
		return []string{"included"}
	case "customer-reviews\x00/v1/customerReviews/{id}":
		return []string{"included"}
	}
	return nil
}
