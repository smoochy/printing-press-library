...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/developer-tools/dndbeyond/internal/cliutil/testenv"
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"dndbeyond-pp-cli auth login",
		"dndbeyond-pp-cli doctor",
		"dndbeyond-pp-cli help items",
		"dndbeyond-pp-cli sync",
		"dndbeyond-pp-cli profile list",
		"dndbeyond-pp-cli feedback list",
		"dndbeyond-pp-cli which",
		"dndbeyond-pp-cli agent-context",
		"dndbeyond-pp-cli completion bash",
		"dndbeyond-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"dndbeyond-pp-cli recall",
		"dndbeyond-pp-cli learnings",
		"dndbeyond-pp-cli teach-pattern",
		"dndbeyond-pp-cli teach-lookup",
		"dndbeyond-pp-cli items list",
	}
