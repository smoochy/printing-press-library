...
var whichIndex = []whichEntry{
	{Command: "characters inspect", Description: "Normalize a user-supplied D&D Beyond or Beyond20 character snapshot or exported PDF.", Group: "Local character sharing", WhyItMatters: "Agents can read a user's authorized character artifact while keeping account access and mutations out of the CLI."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  dndbeyond-pp-cli which "stale tickets"
  dndbeyond-pp-cli which "bottleneck"
  dndbeyond-pp-cli which --limit 1 "send message"
  dndbeyond-pp-cli which                                # list the full capability index`,
