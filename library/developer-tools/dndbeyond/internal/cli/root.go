...
type rootFlags struct {
	...
	// invocation. Mirrors the DNDBEYOND_NO_LEARN env var.
	noLearn                 bool
	selectFields            string
	configPath              string
	homePath                string
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "dndbeyond-pp-cli",
		Short: `Read public D&D Beyond rules pages from the terminal.`,
		Long: `Read public D&D Beyond rules pages from the terminal.
...
Run 'dndbeyond-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("dndbeyond-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.runProfileName, "profile", "", "Apply values from a saved run profile; this does not select a client (see 'dndbeyond-pp-cli profile list')")
