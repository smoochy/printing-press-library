...
var whichIndex = []whichEntry{
	...
	{Command: "sql", Description: "Ask the archive anything in SQL: one read-only SELECT across every series `history` has filled.", Group: "Local state that compounds", WhyItMatters: "Reach for this when the question is neither the sleep nor the training recipe: one SELECT joins any two series on the id they share, and a single-statement gate over a mode=ro, query_only handle means no query can write, whatever it says."},
