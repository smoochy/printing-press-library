...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/health/catapult-openfield-connect/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("CATAPULT_OPENFIELD_CONNECT_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "catapult-openfield-connect-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
