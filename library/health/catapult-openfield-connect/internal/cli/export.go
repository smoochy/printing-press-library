...
large datasets as it has no memory pressure.`,
  ...
  catapult-openfield-connect-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  catapult-openfield-connect-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  catapult-openfield-connect-pp-cli export <resource> --format jsonl | jq '.id'`,
