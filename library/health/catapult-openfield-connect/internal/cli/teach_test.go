...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/health/catapult-openfield-connect/internal/cliutil/testenv"
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"catapult-openfield-connect-pp-cli auth login",
		"catapult-openfield-connect-pp-cli doctor",
		"catapult-openfield-connect-pp-cli help items",
		"catapult-openfield-connect-pp-cli sync",
		"catapult-openfield-connect-pp-cli profile list",
		"catapult-openfield-connect-pp-cli feedback list",
		"catapult-openfield-connect-pp-cli which",
		"catapult-openfield-connect-pp-cli agent-context",
		"catapult-openfield-connect-pp-cli completion bash",
		"catapult-openfield-connect-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"catapult-openfield-connect-pp-cli recall",
		"catapult-openfield-connect-pp-cli learnings",
		"catapult-openfield-connect-pp-cli teach-pattern",
		"catapult-openfield-connect-pp-cli teach-lookup",
		"catapult-openfield-connect-pp-cli items list",
	}
