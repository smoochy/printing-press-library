...
but do not stop the import.`,
  ...
  catapult-openfield-connect-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  catapult-openfield-connect-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | catapult-openfield-connect-pp-cli import <resource> --input -`,
