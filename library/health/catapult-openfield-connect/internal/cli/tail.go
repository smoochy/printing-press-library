...
native streaming instead of polling.`,
  ...
  catapult-openfield-connect-pp-cli tail --interval 10s

  # Tail a specific resource
  catapult-openfield-connect-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  catapult-openfield-connect-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
