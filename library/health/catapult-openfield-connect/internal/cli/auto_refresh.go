...
var readCommandResources = map[string][]string{
	"catapult-openfield-connect-pp-cli activities":         {"activities"},
	"catapult-openfield-connect-pp-cli activities list":    {"activities"},
	"catapult-openfield-connect-pp-cli activities get":     {"activities"},
	"catapult-openfield-connect-pp-cli activities search":  {"activities"},
	"catapult-openfield-connect-pp-cli annotations":        {"annotations"},
	"catapult-openfield-connect-pp-cli annotations list":   {"annotations"},
	"catapult-openfield-connect-pp-cli annotations get":    {"annotations"},
	"catapult-openfield-connect-pp-cli annotations search": {"annotations"},
	"catapult-openfield-connect-pp-cli athletes":           {"athletes"},
	"catapult-openfield-connect-pp-cli athletes list":      {"athletes"},
	"catapult-openfield-connect-pp-cli athletes get":       {"athletes"},
	"catapult-openfield-connect-pp-cli athletes search":    {"athletes"},
	"catapult-openfield-connect-pp-cli parameters":         {"parameters"},
	"catapult-openfield-connect-pp-cli parameters list":    {"parameters"},
	"catapult-openfield-connect-pp-cli parameters get":     {"parameters"},
	"catapult-openfield-connect-pp-cli parameters search":  {"parameters"},
	"catapult-openfield-connect-pp-cli teams":              {"teams"},
	"catapult-openfield-connect-pp-cli teams list":         {"teams"},
	"catapult-openfield-connect-pp-cli teams get":          {"teams"},
	"catapult-openfield-connect-pp-cli teams search":       {"teams"},
	"catapult-openfield-connect-pp-cli venues":             {"venues"},
	"catapult-openfield-connect-pp-cli venues list":        {"venues"},
	"catapult-openfield-connect-pp-cli venues get":         {"venues"},
	"catapult-openfield-connect-pp-cli venues search":      {"venues"},
}
...
func cachePolicy() cliutil.Policy {
	...
	envOptOut := "CATAPULT_OPENFIELD_CONNECT_NO_AUTO_REFRESH"
...
func autoRefreshIfStale(ctx context.Context, flags *rootFlags, resources []string) (meta cliutil.FreshnessMeta) {
	...
	dbPath := defaultDBPath("catapult-openfield-connect-pp-cli")
	...
	if err := runAutoRefresh(refreshCtx, flags, db, resources); err != nil {
		fmt.Fprintf(os.Stderr, "warning: using stale catapult-openfield-connect-pp-cli cache (refresh failed: %v)\n", err)
