...
var whichIndex = []whichEntry{
	{Command: "acwr", Description: "Instant acute:chronic workload ratios for any athlete or the full squad, color-coded into safe (0.8-1.3), caution, and danger (>1.5) zones.", Group: "Load intelligence that compounds", WhyItMatters: "Reach for this when asked who is at injury risk or for the morning workload check."},
	{Command: "report", Description: "One-command weekly summary — total Player Load, session count, ACWR, max velocity vs PB, monotony, strain, and risk flags — exportable as markdown or CSV.", Group: "Load intelligence that compounds", WhyItMatters: "Reach for this when a coach briefing or weekly load summary is requested."},
	{Command: "pb", Description: "Compares recent session values against each athlete's all-time or rolling personal best, with readiness % and 3-session trend arrows.", Group: "Load intelligence that compounds", WhyItMatters: "Use before deciding who trains at full intensity today."},
	{Command: "diff", Description: "Side-by-side comparison of two sessions (by ID, date, or last/prev) showing absolute and percentage change per metric and per athlete.", Group: "Session analysis", WhyItMatters: "Use to diagnose travel fatigue and fixture congestion between consecutive matches."},
	{Command: "benchmark", Description: "Ranks any athlete against positional peers for a metric: percentile rank, squad median, and position median with outlier flags.", Group: "Load intelligence that compounds", WhyItMatters: "Use after match debriefs to answer how an athlete compares to peers."},
	{Command: "rtp", Description: "Tracks an injured athlete's load progression session-by-session as a percentage of squad average or a pre-injury baseline window.", Group: "Session analysis", WhyItMatters: "Use when managing return-to-play decisions to give medical staff quantitative progression data."},
	{Command: "heatmap", Description: "Renders an athlete-by-period intensity matrix for a session — ANSI heatmap on a terminal, JSON matrix for agents — surfacing where fatigue compounded.", Group: "Session analysis", WhyItMatters: "Use after matches to diagnose second-half performance drops."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  catapult-openfield-connect-pp-cli which "stale tickets"
  catapult-openfield-connect-pp-cli which "bottleneck"
  catapult-openfield-connect-pp-cli which --limit 1 "send message"
  catapult-openfield-connect-pp-cli which                                # list the full capability index`,
