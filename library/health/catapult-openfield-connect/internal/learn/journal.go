...
const (
	journalSessionEnvVar   = "CATAPULT_OPENFIELD_CONNECT_LEARN_SESSION"
	journalNoLearnEnvVar   = "CATAPULT_OPENFIELD_CONNECT_NO_LEARN"
	journalNoCaptureEnvVar = "CATAPULT_OPENFIELD_CONNECT_LEARN_NO_CAPTURE"
)
