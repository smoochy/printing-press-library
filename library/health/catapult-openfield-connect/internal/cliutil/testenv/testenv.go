...
var clearedVars = []string{
	"CATAPULT_OPENFIELD_CONNECT_CONFIG",
	"CATAPULT_OPENFIELD_CONNECT_CONFIG_DIR",
	"CATAPULT_OPENFIELD_CONNECT_DATA_DIR",
	"CATAPULT_OPENFIELD_CONNECT_STATE_DIR",
	"CATAPULT_OPENFIELD_CONNECT_CACHE_DIR",
	"CATAPULT_OPENFIELD_CONNECT_HOME",
	"XDG_CONFIG_HOME",
	"XDG_DATA_HOME",
	"XDG_STATE_HOME",
	"XDG_CACHE_HOME",
