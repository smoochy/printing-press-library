...
var whichIndex = []whichEntry{
	{Command: "sync", Description: "Mirror personal CAROL ride history into local SQLite for dependable offline search and analysis.", Group: "Local data", WhyItMatters: "Agents can query a durable personal ride history without keeping a browser running."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  carol-bike-pp-cli which "stale tickets"
  carol-bike-pp-cli which "bottleneck"
  carol-bike-pp-cli which --limit 1 "send message"
  carol-bike-pp-cli which                                # list the full capability index`,
