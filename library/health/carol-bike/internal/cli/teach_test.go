...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/health/carol-bike/internal/cliutil/testenv"
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"carol-bike-pp-cli auth login",
		"carol-bike-pp-cli doctor",
		"carol-bike-pp-cli help items",
		"carol-bike-pp-cli sync",
		"carol-bike-pp-cli profile list",
		"carol-bike-pp-cli feedback list",
		"carol-bike-pp-cli which",
		"carol-bike-pp-cli agent-context",
		"carol-bike-pp-cli completion bash",
		"carol-bike-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"carol-bike-pp-cli recall",
		"carol-bike-pp-cli learnings",
		"carol-bike-pp-cli teach-pattern",
		"carol-bike-pp-cli teach-lookup",
		"carol-bike-pp-cli items list",
	}
