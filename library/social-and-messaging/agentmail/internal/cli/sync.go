...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/social-and-messaging/agentmail/internal/learn/lookups"
...
Resource scoping:
  ...
  agentmail-pp-cli sync
  # Sync specific resources only
  agentmail-pp-cli sync --resources inboxes,api-keys

  # Full resync (ignore previous checkpoint)
  agentmail-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  agentmail-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  agentmail-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  agentmail-pp-cli sync --latest-only`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if dbPath == "" {
				dbPath = defaultDBPath("agentmail-pp-cli")
			}
...
func determinePaginationDefaults(resource string) paginationDefaults {
	...
	case "api-keys":
		return paginationDefaults{
			...
			nextCursorPath: "next_page_token",
			limitParam:     "limit",
			limit:          100,
		}
	case "api-keys-public-keys":
		return paginationDefaults{
			cursorParam:    "page_token",
			cursorType:     "page_token",
			nextCursorPath: "next_page_token",
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "zone_file":
		return db.UpsertZoneFile(data)
	case "drafts_attachments":
		return db.UpsertDraftsAttachments(data)
	case "inboxes_api_keys":
		return db.UpsertInboxesApiKeys(data)
	case "inboxes_drafts":
		return db.UpsertInboxesDrafts(data)
	case "events":
		return db.UpsertEvents(data)
	case "inboxes_lists":
		return db.UpsertInboxesLists(data)
	case "messages":
		return db.UpsertMessages(data)
	case "inboxes_metrics":
		return db.UpsertInboxesMetrics(data)
	case "inboxes_threads":
		return db.UpsertInboxesThreads(data)
	case "inboxes_webhooks":
		return db.UpsertInboxesWebhooks(data)
	case "pods_api_keys":
		return db.UpsertPodsApiKeys(data)
	case "pods_domains":
		return db.UpsertPodsDomains(data)
	case "pods_drafts":
		return db.UpsertPodsDrafts(data)
	case "pods_inboxes":
		return db.UpsertPodsInboxes(data)
	case "pods_lists":
		return db.UpsertPodsLists(data)
	case "pods_metrics":
		return db.UpsertPodsMetrics(data)
	case "pods_threads":
		return db.UpsertPodsThreads(data)
	case "pods_webhooks":
		return db.UpsertPodsWebhooks(data)
	case "threads_attachments":
		return db.UpsertThreadsAttachments(data)
	case "headers":
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{ // #nosec G101 -- endpoint paths, not credentials.
		"api-keys":             "/v0/api-keys",
		"api-keys-public-keys": "/v0/api-keys/public-keys",
		"domains":              "/v0/domains",
		"drafts":               "/v0/drafts",
		"inboxes":              "/v0/inboxes",
		"metrics":              "/v0/metrics/usage",
		"pods":                 "/v0/pods",
		"threads":              "/v0/threads",
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "inboxes_api_keys", ParentTable: "inboxes", ParentIDParam: "inbox_id", PathTemplate: "/v0/inboxes/{inbox_id}/api-keys", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.inboxe", PathParams: []dependentPathParamDef{
			{Param: "inbox_id", Field: "inbox_id"},
		}},
		{Name: "inboxes_drafts", ParentTable: "inboxes", ParentIDParam: "inbox_id", PathTemplate: "/v0/inboxes/{inbox_id}/drafts", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.inboxe", PathParams: []dependentPathParamDef{
			{Param: "inbox_id", Field: "inbox_id"},
		}},
		{Name: "inboxes_metrics", ParentTable: "inboxes", ParentIDParam: "inbox_id", PathTemplate: "/v0/inboxes/{inbox_id}/metrics/usage", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "inbox_id", Field: "inbox_id"},
		}},
		{Name: "inboxes_threads", ParentTable: "inboxes", ParentIDParam: "inbox_id", PathTemplate: "/v0/inboxes/{inbox_id}/threads", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.inboxe", PathParams: []dependentPathParamDef{
			{Param: "inbox_id", Field: "inbox_id"},
		}},
		{Name: "inboxes_webhooks", ParentTable: "inboxes", ParentIDParam: "inbox_id", PathTemplate: "/v0/inboxes/{inbox_id}/webhooks", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.inboxe", PathParams: []dependentPathParamDef{
			{Param: "inbox_id", Field: "inbox_id"},
		}},
		{Name: "messages", ParentTable: "inboxes", ParentIDParam: "inbox_id", PathTemplate: "/v0/inboxes/{inbox_id}/messages", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.inboxe", PathParams: []dependentPathParamDef{
			{Param: "inbox_id", Field: "inbox_id"},
		}},
		{Name: "pods_api_keys", ParentTable: "pods", ParentIDParam: "pod_id", PathTemplate: "/v0/pods/{pod_id}/api-keys", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.pod", PathParams: []dependentPathParamDef{
			{Param: "pod_id", Field: "pod_id"},
		}},
		{Name: "pods_domains", ParentTable: "pods", ParentIDParam: "pod_id", PathTemplate: "/v0/pods/{pod_id}/domains", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.pod", PathParams: []dependentPathParamDef{
			{Param: "pod_id", Field: "pod_id"},
		}},
		{Name: "pods_drafts", ParentTable: "pods", ParentIDParam: "pod_id", PathTemplate: "/v0/pods/{pod_id}/drafts", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.pod", PathParams: []dependentPathParamDef{
			{Param: "pod_id", Field: "pod_id"},
		}},
		{Name: "pods_inboxes", ParentTable: "pods", ParentIDParam: "pod_id", PathTemplate: "/v0/pods/{pod_id}/inboxes", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.pod", PathParams: []dependentPathParamDef{
			{Param: "pod_id", Field: "pod_id"},
		}},
		{Name: "pods_metrics", ParentTable: "pods", ParentIDParam: "pod_id", PathTemplate: "/v0/pods/{pod_id}/metrics/usage", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "pod_id", Field: "pod_id"},
		}},
		{Name: "pods_threads", ParentTable: "pods", ParentIDParam: "pod_id", PathTemplate: "/v0/pods/{pod_id}/threads", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.pod", PathParams: []dependentPathParamDef{
			{Param: "pod_id", Field: "pod_id"},
		}},
		{Name: "pods_webhooks", ParentTable: "pods", ParentIDParam: "pod_id", PathTemplate: "/v0/pods/{pod_id}/webhooks", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.pod", PathParams: []dependentPathParamDef{
			{Param: "pod_id", Field: "pod_id"},
		}},
	}
}
...
var flatReconcileModes = map[string]string{
	"api-keys":             "flat_global",
	"api-keys-public-keys": "flat_global",
	"domains":              "flat_global",
	"drafts":               "flat_global",
	"inboxes":              "flat_global",
	"pods":                 "flat_global",
...
var reconcileTypedTables = map[string]string{
	"drafts_attachments":  "drafts_attachments",
	"events":              "events",
	"headers":             "headers",
	"inboxes_api_keys":    "inboxes_api_keys",
	"inboxes_drafts":      "inboxes_drafts",
	"inboxes_lists":       "inboxes_lists",
	"inboxes_metrics":     "inboxes_metrics",
	"inboxes_threads":     "inboxes_threads",
	"inboxes_webhooks":    "inboxes_webhooks",
	"messages":            "messages",
	"pods_api_keys":       "pods_api_keys",
	"pods_domains":        "pods_domains",
	"pods_drafts":         "pods_drafts",
	"pods_inboxes":        "pods_inboxes",
	"pods_lists":          "pods_lists",
	"pods_metrics":        "pods_metrics",
	"pods_threads":        "pods_threads",
	"pods_webhooks":       "pods_webhooks",
	"threads_attachments": "threads_attachments",
	"verify":              "verify",
	"zone_file":           "zone_file",
}
...
func responsePathForResource(resource, path string) []string {
	...
	case "api-keys\x00/v0/api-keys":
		return []string{"api_keys"}
	case "api-keys\x00/v0/api-keys/public-keys":
		return []string{"public_keys"}
	case "domains\x00/v0/domains":
		return []string{"records"}
	case "domains\x00/v0/domains/{domain_id}":
		return []string{"records"}
	case "drafts\x00/v0/drafts":
		return []string{"drafts"}
	case "inboxes\x00/v0/inboxes":
		return []string{"inboxes"}
	case "lists\x00/v0/lists/{direction}/{type}":
		return []string{"entries"}
	case "pods\x00/v0/pods":
		return []string{"pods"}
	case "threads\x00/v0/threads":
		return []string{"threads"}
	case "threads\x00/v0/threads/search":
		return []string{"threads"}
	case "threads\x00/v0/threads/{thread_id}":
