...
var whichIndex = []whichEntry{
	{Command: "triage queue", Description: "Rank unresolved inbound conversations across inboxes with age, direction, labels, and pending drafts.", Group: "Local operational memory", WhyItMatters: "Choose this when an agent needs an actionable unresolved-mail queue instead of raw paginated messages."},
	{Command: "send check", Description: "Review a draft for deterministic recipient, attachment, schedule, duplicate, and idempotency risks before sending.", Group: "Safe automation", WhyItMatters: "Choose this before releasing a draft when a safe, auditable send decision matters more than simply calling send."},
	{Command: "thread rollup", Description: "Render compact conversation handoff context with participants, counts, latest direction, age, labels, and extracted reply content.", Group: "Local operational memory", WhyItMatters: "Choose this when an agent or human needs conversation context without repeated thread and message fetches."},
	{Command: "fleet health", Description: "Report inbox, domain, webhook, list, metrics, API-key, pod, and organization readiness findings.", Group: "Fleet operations", WhyItMatters: "Choose this for a preflight fleet review before agents depend on multiple inboxes or tenants."},
	{Command: "schedule audit", Description: "Find scheduled drafts that are overdue, orphaned, duplicated, or missing review state.", Group: "Safe automation", WhyItMatters: "Choose this before a scheduled send window when stale or duplicate drafts need deterministic review."},
	{Command: "delivery reconcile", Description: "Reconcile outbound messages with status, thread placement, timestamps, and later inbound activity.", Group: "Safe automation", WhyItMatters: "Choose this after a send batch when an agent must identify stale, failed, or unthreaded outcomes."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  agentmail-pp-cli which "stale tickets"
  agentmail-pp-cli which "bottleneck"
  agentmail-pp-cli which --limit 1 "send message"
  agentmail-pp-cli which                                # list the full capability index`,
