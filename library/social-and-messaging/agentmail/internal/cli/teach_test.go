...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"agentmail-pp-cli auth login",
		"agentmail-pp-cli doctor",
		"agentmail-pp-cli help items",
		"agentmail-pp-cli sync",
		"agentmail-pp-cli profile list",
		"agentmail-pp-cli feedback list",
		"agentmail-pp-cli which",
		"agentmail-pp-cli agent-context",
		"agentmail-pp-cli completion bash",
		"agentmail-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"agentmail-pp-cli recall",
		"agentmail-pp-cli learnings",
		"agentmail-pp-cli teach-pattern",
		"agentmail-pp-cli teach-lookup",
		"agentmail-pp-cli items list",
	}
