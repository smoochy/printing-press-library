...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/social-and-messaging/unipile/internal/cliutil/testenv"
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"unipile-pp-cli auth login",
		"unipile-pp-cli doctor",
		"unipile-pp-cli help items",
		"unipile-pp-cli sync",
		"unipile-pp-cli profile list",
		"unipile-pp-cli feedback list",
		"unipile-pp-cli which",
		"unipile-pp-cli agent-context",
		"unipile-pp-cli completion bash",
		"unipile-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"unipile-pp-cli recall",
		"unipile-pp-cli learnings",
		"unipile-pp-cli teach-pattern",
		"unipile-pp-cli teach-lookup",
		"unipile-pp-cli items list",
	}
