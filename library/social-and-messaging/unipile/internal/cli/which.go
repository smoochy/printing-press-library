...
var whichIndex = []whichEntry{
	{Command: "budget", Description: "See how many LinkedIn invitations you have left today and this week, counted from your synced invitation history.", Group: "Account safety", WhyItMatters: "Check this before any bulk invitation run so you do not get the underlying LinkedIn account restricted."},
	{Command: "search", Description: "Full-text search every message, email, attendee, and relation across all connected providers at once, offline.", Group: "Local state that compounds", WhyItMatters: "Use this instead of N per-provider list calls when you need to find where something was said."},
	{Command: "contact", Description: "Everything the local mirror knows about one person: connection state, invitation history, and every conversation with per-direction message counts.", Group: "Cross-provider views", WhyItMatters: "Reach for this before writing to someone, so the message is informed by every prior touch across every provider."},
	{Command: "inbox", Description: "One table of everything unread across LinkedIn, WhatsApp, Telegram, Instagram, Messenger, and email.", Group: "Cross-provider views", WhyItMatters: "This is the daily triage view; use it to decide what to answer before opening any provider UI."},
	{Command: "silent", Description: "Find conversations where you sent the last message and got no reply for N days.", Group: "Outreach loop", WhyItMatters: "Use this to build a follow-up list without re-reading every thread."},
	{Command: "accepted", Description: "New LinkedIn connections since your last sync that you have not messaged yet.", Group: "Outreach loop", WhyItMatters: "This is the highest-conversion follow-up queue in outreach; use it right after a sync."},
	{Command: "funnel", Description: "Sent, accepted, and replied counts with conversion rates over a time window.", Group: "Outreach loop", WhyItMatters: "Use this to judge whether outreach copy is working before scaling send volume."},
	{Command: "digest", Description: "What changed across every connected provider since the last sync.", Group: "Local state that compounds", WhyItMatters: "Run this after sync to get a single catch-up summary instead of polling nine surfaces."},
	{Command: "thread", Description: "Read one conversation end to end with attendee IDs resolved to real names.", Group: "Cross-provider views", WhyItMatters: "Use this when you need the full context of a conversation in one readable payload."},
	{Command: "engagement", Description: "Who reacted to or commented on your posts, flagged by whether they are already a connection.", Group: "Outreach loop", WhyItMatters: "Use this to turn warm post engagement into a targeted invitation list."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  unipile-pp-cli which "stale tickets"
  unipile-pp-cli which "bottleneck"
  unipile-pp-cli which --limit 1 "send message"
  unipile-pp-cli which                                # list the full capability index`,
