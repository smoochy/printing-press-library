...
but do not stop the import.`,
  ...
  unipile-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  unipile-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | unipile-pp-cli import <resource> --input -`,
