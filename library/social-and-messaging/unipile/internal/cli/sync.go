...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/social-and-messaging/unipile/internal/learn"
...
Resource scoping:
  ...
  unipile-pp-cli sync --resources accounts,calendars

  # Full resync (ignore previous checkpoint)
  unipile-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  unipile-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  unipile-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  unipile-pp-cli sync --latest-only`,
...
func determinePaginationDefaults(resource string) paginationDefaults {
	...
	case "chat-attendees/chat_attendees_chats":
		return paginationDefaults{
			cursorParam:    "cursor",
			cursorType:     "cursor",
			nextCursorPath: "cursor",
	...
	case "chat-attendees/chat_attendees_messages":
		return paginationDefaults{
			cursorParam:    "cursor",
			cursorType:     "cursor",
			nextCursorPath: "cursor",
	...
	case "linkedin-search-parameters":
		return paginationDefaults{
			cursorParam:    "",
			cursorType:     "offset",
			nextCursorPath: "",
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "accounts_sync":
		return db.UpsertAccountsSync(data)
	case "calendars":
		return db.UpsertCalendars(data)
	case "events":
		return db.UpsertEvents(data)
	case "chat-attendees":
		return db.UpsertChatAttendees(data)
	case "chat_attendees_chats":
		return db.UpsertChatAttendeesChats(data)
	case "chat_attendees_messages":
		return db.UpsertChatAttendeesMessages(data)
	case "picture":
		return db.UpsertPicture(data)
	case "chat_attendees_sync":
		return db.UpsertChatAttendeesSync(data)
	case "chats":
	...
	case "messages_attachments":
		return db.UpsertMessagesAttachments(data)
	case "forward":
		return db.UpsertForward(data)
	case "reaction":
		return db.UpsertReaction(data)
	case "posts":
		return db.UpsertPosts(data)
	case "posts_comments":
		return db.UpsertPostsComments(data)
	case "posts_reactions":
		return db.UpsertPostsReactions(data)
	case "users":
		return db.UpsertUsers(data)
	case "users_comments":
		return db.UpsertUsersComments(data)
	case "users_posts":
		return db.UpsertUsersPosts(data)
	case "users_reactions":
		return db.UpsertUsersReactions(data)
	case "webhooks":
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{ // #nosec G101 -- endpoint paths, not credentials.
		...
		"emails-contacts":            "/api/v1/emails/contacts",
		"folders":                    "/api/v1/folders",
		"linkedin":                   "/api/v1/linkedin/contracts",
		"linkedin-jobs":              "/api/v1/linkedin/jobs",
		"linkedin-projects":          "/api/v1/linkedin/projects",
		"linkedin-search-parameters": "/api/v1/linkedin/search/parameters",
		"messages":                   "/api/v1/messages",
		"reactions":                  "/api/v1/posts/{post_id}/reactions",
		"users":                      "/api/v1/users/followers",
		"users-following":            "/api/v1/users/following",
		"users-invite-received":      "/api/v1/users/invite/received",
		"users-invite-sent":          "/api/v1/users/invite/sent",
		"users-relations":            "/api/v1/users/relations",
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "accounts_sync", ParentTable: "accounts", ParentIDParam: "account_id", PathTemplate: "/api/v1/accounts/{account_id}/sync", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "account_id", Field: "id"},
		}},
		{Name: "chat_attendees_chats", ParentTable: "chat-attendees", ParentIDParam: "attendee_id", PathTemplate: "/api/v1/chat_attendees/{attendee_id}/chats", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.chat-attendee", PathParams: []dependentPathParamDef{
			{Param: "attendee_id", Field: "id"},
		}},
		{Name: "chat_attendees_messages", ParentTable: "chat-attendees", ParentIDParam: "sender_id", PathTemplate: "/api/v1/chat_attendees/{sender_id}/messages", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.chat-attendee", PathParams: []dependentPathParamDef{
			{Param: "sender_id", Field: "id"},
		}},
		{Name: "chats_messages", ParentTable: "chats", ParentIDParam: "chat_id", PathTemplate: "/api/v1/chats/{chat_id}/messages", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.chat", PathParams: []dependentPathParamDef{
			{Param: "chat_id", Field: "id"},
		}},
		{Name: "users_comments", ParentTable: "users", ParentIDParam: "identifier", PathTemplate: "/api/v1/users/{identifier}/comments", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.user", PathParams: []dependentPathParamDef{
			{Param: "identifier", Field: "id"},
		}},
		{Name: "users_posts", ParentTable: "users", ParentIDParam: "identifier", PathTemplate: "/api/v1/users/{identifier}/posts", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.user", PathParams: []dependentPathParamDef{
			{Param: "identifier", Field: "id"},
		}},
		{Name: "users_reactions", ParentTable: "users", ParentIDParam: "identifier", PathTemplate: "/api/v1/users/{identifier}/reactions", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.user", PathParams: []dependentPathParamDef{
			{Param: "identifier", Field: "id"},
		}},
	}
}
...
func syncOneParent(
	...
	parentFKKey := strings.ReplaceAll(dep.ParentTable, "-", "_") + "_id"
...
var flatReconcileModes = map[string]string{
	"accounts":                   "flat_global",
	"calendars":                  "flat_global",
	"chat-attendees":             "flat_global",
	"chats":                      "flat_global",
	"comments":                   "flat_global",
	"emails":                     "flat_global",
	"emails-contacts":            "flat_global",
	"folders":                    "flat_global",
	"linkedin":                   "flat_global",
	"linkedin-jobs":              "flat_global",
	"linkedin-projects":          "flat_global",
	"linkedin-search-parameters": "flat_global",
	"messages":                   "flat_global",
	"reactions":                  "flat_global",
	"users":                      "flat_global",
	"users-following":            "flat_global",
	"users-invite-received":      "flat_global",
	"users-invite-sent":          "flat_global",
	"users-relations":            "flat_global",
...
var reconcileTypedTables = map[string]string{
	...
	"attendees":               "attendees",
	"calendars":               "calendars",
	"chat-attendees":          "chat_attendees",
	"chat_attendees_chats":    "chat_attendees_chats",
	"chat_attendees_messages": "chat_attendees_messages",
	"chat_attendees_sync":     "chat_attendees_sync",
	"chats":                   "chats",
	...
	"linkedin":                "linkedin",
	"messages":                "messages",
	"messages_attachments":    "messages_attachments",
	"picture":                 "picture",
	"posts":                   "posts",
...
func responsePathForResource(resource, path string) []string {
	...
	case "accounts\x00/api/v1/accounts":
		return []string{"items"}
	case "calendars\x00/api/v1/calendars":
		return []string{"data"}
	case "chat-attendees\x00/api/v1/chat_attendees":
		return []string{"items"}
	case "chats\x00/api/v1/chats":
		return []string{"items"}
	case "emails\x00/api/v1/emails":
		return []string{"items"}
	case "emails\x00/api/v1/emails/contacts":
		return []string{"items"}
	case "folders\x00/api/v1/folders":
		return []string{"items"}
	case "linkedin\x00/api/v1/linkedin/jobs/{id}/applicants":
		return []string{"items"}
	case "linkedin\x00/api/v1/linkedin/contracts":
		return []string{"items"}
	case "linkedin\x00/api/v1/linkedin/jobs":
		return []string{"items"}
	case "linkedin\x00/api/v1/linkedin/projects":
		return []string{"items"}
	case "linkedin\x00/api/v1/linkedin/search/parameters":
		return []string{"items"}
	case "linkedin\x00/api/v1/linkedin/search":
		return []string{"items"}
	case "messages\x00/api/v1/messages":
		return []string{"items"}
	case "users\x00/api/v1/users/followers":
		return []string{"items"}
	case "users\x00/api/v1/users/following":
		return []string{"items"}
	case "users\x00/api/v1/users/invite/received":
		return []string{"items"}
	case "users\x00/api/v1/users/invite/sent":
		return []string{"items"}
	case "users\x00/api/v1/users/relations":
		return []string{"items"}
	case "webhooks\x00/api/v1/webhooks":
		return []string{"items"}
	}
	return nil
}
