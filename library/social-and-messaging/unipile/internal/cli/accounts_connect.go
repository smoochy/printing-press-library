...
func newAccountsConnectCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "Link to Uniple an account of the given type and provider.",
		Example:     "  unipile-pp-cli accounts connect",
		Annotations: map[string]string{"pp:endpoint": "accounts.connect", "pp:method": "POST", "pp:path": "/api/v1/accounts"},
