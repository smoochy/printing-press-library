...
large datasets as it has no memory pressure.`,
  ...
  unipile-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  unipile-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  unipile-pp-cli export <resource> --format jsonl | jq '.id'`,
