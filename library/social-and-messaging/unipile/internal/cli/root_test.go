...
func TestDeclaredAPISurfaceReachable(t *testing.T) {
	expected := []string{
		...
		"accounts list",
		"accounts reconnect",
		"accounts resend-checkpoint",
		"accounts restart",
		"accounts restart account",
		"accounts solve-checkpoint",
		"accounts sync",
		"accounts sync resync-account",
		"accounts update",
		"calendars",
		"calendars events",
		"calendars events create",
		...
		"calendars list",
		"chat-attendees",
		"chat-attendees chats",
		"chat-attendees chats list",
		"chat-attendees get",
		"chat-attendees list",
		"chat-attendees messages",
		"chat-attendees messages list",
		"chat-attendees picture",
		"chat-attendees picture chat-attendees",
		"chat-attendees sync",
		"chat-attendees sync chat-attendees",
		"chats",
		"chats attendees",
		"chats attendees list",
		"chats delete",
		"chats get",
		"chats list",
		"chats messages",
		...
		"hosted",
		"linkedin",
		"linkedin action-user",
		"linkedin close-jobs",
		"linkedin company",
		"linkedin create-jobs",
		"linkedin endorse-profile",
		"linkedin get-applicants",
		"linkedin get-jobs",
		"linkedin get-projects",
		"linkedin inmail-balance",
		"linkedin list-applicants",
		"linkedin list-contracts",
		"linkedin list-jobs",
		"linkedin list-projects",
		"linkedin parameters-search",
		"linkedin publish-jobs",
		"linkedin raw",
		"linkedin resume-applicants",
		"linkedin search",
		"linkedin select-contracts",
		"linkedin solve-checkpoint-jobs",
		"linkedin update-jobs",
		"messages",
		...
		"messages list",
		"messages reaction",
		"messages reaction react-messages",
		"messages update",
		"posts",
		"posts comments",
		...
		"users posts list",
		"users reactions",
		"users reactions list",
		"users relations",
		"users respond-received",
		"webhooks",
		"webhooks create",
		"webhooks delete",
		"webhooks list",
