...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "creativefabrica-pp-cli",
		Short: `Creativefabrica CLI — Search Creative Fabrica's 20-million-plus fonts, graphics, crafts, and POD designs from your terminal — with a local ca…`,
		Long: `Creativefabrica CLI — Search Creative Fabrica's 20-million-plus fonts, graphics, crafts, and POD designs from your terminal — with a local ca…
...
Health check: run 'creativefabrica-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("creativefabrica-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'creativefabrica-pp-cli profile list')")
	...
	rootCmd.AddCommand(newNovelDesignerCompareCmd(flags))
	rootCmd.AddCommand(newNovelDesignerStatsCmd(flags))
	...
	rootCmd.AddCommand(newPodCmd(flags))
	rootCmd.AddCommand(newDesignerCmd(flags))
