...
large datasets as it has no memory pressure.`,
  ...
  quickcommerce-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  quickcommerce-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  quickcommerce-pp-cli export <resource> --format jsonl | jq '.id'`,
