...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"teslatracker-pp-cli auth login",
		"teslatracker-pp-cli doctor",
		"teslatracker-pp-cli help items",
		"teslatracker-pp-cli sync",
		"teslatracker-pp-cli profile list",
		"teslatracker-pp-cli feedback list",
		"teslatracker-pp-cli which",
		"teslatracker-pp-cli agent-context",
		"teslatracker-pp-cli completion bash",
		"teslatracker-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"teslatracker-pp-cli recall",
		"teslatracker-pp-cli learnings",
		"teslatracker-pp-cli teach-pattern",
		"teslatracker-pp-cli teach-lookup",
		"teslatracker-pp-cli items list",
	}
