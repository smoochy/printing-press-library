...
func Load(configPath string) (*Config, error) {
	cfg := &Config{
		BaseURL: "https://teslatracker.com",
	}
	...
	if v := os.Getenv("TESLATRACKER_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("TESLATRACKER_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "teslatracker-pp-cli", "config.json"), nil
}
