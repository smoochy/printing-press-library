...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/commerce/teslatracker/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "teslatracker-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
