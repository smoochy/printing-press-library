...
func TestRecipeIntentHandlerBuildsRecipeArgs(t *testing.T) {
	...
	result, err := handleCostThisWeekSListAgainstLastWeekS(context.Background(), req)
	if err != nil {
...
func TestRecipeIntentHandlerOverridesParams(t *testing.T) {
	...
	if !strings.Contains(got, "--record") || !strings.Contains(got, "override-value") {
		t.Fatalf("string override for --record missing from %q", got)
	}
}
