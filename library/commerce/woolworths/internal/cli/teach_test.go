...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"woolworths-pp-cli auth login",
		"woolworths-pp-cli doctor",
		"woolworths-pp-cli help items",
		"woolworths-pp-cli sync",
		"woolworths-pp-cli profile list",
		"woolworths-pp-cli feedback list",
		"woolworths-pp-cli which",
		"woolworths-pp-cli agent-context",
		"woolworths-pp-cli completion bash",
		"woolworths-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"woolworths-pp-cli recall",
		"woolworths-pp-cli learnings",
		"woolworths-pp-cli teach-pattern",
		"woolworths-pp-cli teach-lookup",
		"woolworths-pp-cli items list",
	}
