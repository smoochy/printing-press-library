...
var whichIndex = []whichEntry{
	{Command: "real-special", Description: "Tells you whether an advertised special is genuinely cheap or just a lower number next to an inflated was-price.", Group: "Local history that compounds", WhyItMatters: "Reach for this instead of reading the SAVE badge: it returns one decided verdict per product rather than raw prices you have to judge yourself."},
	{Command: "cycle", Description: "Estimates when a product's next half-price window is likely to open, from its own recorded discount episodes.", Group: "Local history that compounds", WhyItMatters: "Use this to decide buy-one-or-buy-six on a stockpile item, instead of guessing whether the deal returns next month."},
	{Command: "swap", Description: "Ranks in-stock alternatives by unit price normalised across different measure bases, so per-100g and per-1kg tiles compare correctly.", Group: "Unit-price intelligence", WhyItMatters: "Pick this when the question is which product is genuinely cheaper per unit, not which has the lowest shelf price."},
	{Command: "basket", Description: "Prices a whole shopping list, showing which lines moved since the last time you ran it and what it did to the total.", Group: "Agent-native plumbing", WhyItMatters: "Use this to turn a plain-text list into a costed, decided answer in one call instead of dozens of searches."},
	{Command: "specials-diff", Description: "Shows what entered and left each specials group since your last sync, with how long since each entrant was last discounted.", Group: "Local history that compounds", WhyItMatters: "Reach for this on catalogue-rollover day to see only what actually changed rather than re-reading the whole specials list."},
	{Command: "multibuy", Description: "Works out what a multi-buy offer actually costs per unit at the quantity it demands, versus buying singly or buying a larger pack.", Group: "Unit-price intelligence", WhyItMatters: "Use this before accepting a 2-for-$9 style offer, since a bigger single pack is often cheaper per unit."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  woolworths-pp-cli which "stale tickets"
  woolworths-pp-cli which "bottleneck"
  woolworths-pp-cli which --limit 1 "send message"
  woolworths-pp-cli which                                # list the full capability index`,
