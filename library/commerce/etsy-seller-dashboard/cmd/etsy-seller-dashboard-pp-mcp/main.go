...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/commerce/etsy-seller-dashboard/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("ETSY_SELLER_DASHBOARD_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "etsy-seller-dashboard-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
