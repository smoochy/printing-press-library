...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/commerce/square/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("SQUARE_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "square-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
