...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/travel/flight-goat/internal/learn"
...
type rootFlags struct {
	...
	// invocation. Mirrors the FLIGHT_GOAT_NO_LEARN env var.
	noLearn bool
...
Run 'flight-goat-pp-cli doctor' to verify auth and connectivity.`,
	...
	// Hand-authored multi-source flight-search commands (Google Flights, Kayak,
	// Soar) and the derived analytics commands. registerPrimaryCommands installs
	// the hand `flights` command (Google Flights search), which replaces the
	// generated AeroAPI flights command — so newFlightsCmd is intentionally not
	// registered here.
