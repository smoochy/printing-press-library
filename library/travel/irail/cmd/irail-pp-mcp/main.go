...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/travel/irail/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("IRAIL_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "irail-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
