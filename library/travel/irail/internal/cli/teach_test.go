...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"irail-pp-cli auth login",
		"irail-pp-cli doctor",
		"irail-pp-cli help items",
		"irail-pp-cli sync",
		"irail-pp-cli profile list",
		"irail-pp-cli feedback list",
		"irail-pp-cli which",
		"irail-pp-cli agent-context",
		"irail-pp-cli completion bash",
		"irail-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"irail-pp-cli teach",
		"irail-pp-cli recall",
		"irail-pp-cli learnings",
		"irail-pp-cli teach-pattern",
		"irail-pp-cli teach-lookup",
		"irail-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("irail-pp-cli")); err == nil {
