...
var whichIndex = []whichEntry{
	{Command: "hotels search", Description: "Shows what you will actually pay, not the teaser rate, with the hidden tax-and-fee delta broken out per property.", Group: "Honest pricing", WhyItMatters: "Reach for this instead of any scraped Agoda price. Quote the inclusive figure to a user; the advertised rate is not what they will be charged."},
	{Command: "hotels rank", Description: "Re-sorts a destination's results by true all-in price instead of Agoda's teaser-price ranking.", Group: "Honest pricing", WhyItMatters: "Use this whenever the decision is about price. Ordinary search ordering inherits Agoda's advertised-price ranking and will mislead."},
	{Command: "hotels fees", Description: "Flags properties whose tax-and-fee ratio is an outlier against the destination median.", Group: "Honest pricing", WhyItMatters: "Use before recommending a property. A hotel with a below-median advertised price and an above-median fee ratio is the classic bait pattern."},
	{Command: "prices cheapest", Description: "Returns the cheapest check-in dates across a flexible window for a destination.", Group: "Local state that compounds", WhyItMatters: "Use for flexible-date travelers. Returns the price floor across a window rather than a single-date quote."},
	{Command: "vip delta", Description: "Runs the same search signed-in and anonymous, then diffs per property to show what your VIP tier is actually worth.", Group: "Local state that compounds", WhyItMatters: "Use when a user asks whether signing in or chasing a VIP tier is worth it. Reports the measured discount on a real search instead of marketing copy."},
	{Command: "watch run", Description: "Surfaces only watched properties whose latest true all-in price dropped meaningfully below their trailing median.", Group: "Local state that compounds", WhyItMatters: "Schedule it. Returns empty most days and returns something worth acting on when a watched property actually drops."},
	{Command: "compare", Description: "Puts finalist properties side by side on true all-in price, hidden fee share, review score, star rating, and free-cancellation deadline.", Group: "Agent-native plumbing", WhyItMatters: "Use once the choice is narrowed to finalists, instead of re-reading two detail pages and eyeballing the difference."},
	{Command: "search", Description: "Full-text search over every property this CLI has already seen, with no network call.", Group: "Local state that compounds", WhyItMatters: "Use after a few live searches to answer property questions without spending a request or waiting on the network."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  agoda-pp-cli which "stale tickets"
  agoda-pp-cli which "bottleneck"
  agoda-pp-cli which --limit 1 "send message"
  agoda-pp-cli which                                # list the full capability index`,
