...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"agoda-pp-cli auth login",
		"agoda-pp-cli doctor",
		"agoda-pp-cli help items",
		"agoda-pp-cli sync",
		"agoda-pp-cli profile list",
		"agoda-pp-cli feedback list",
		"agoda-pp-cli which",
		"agoda-pp-cli agent-context",
		"agoda-pp-cli completion bash",
		"agoda-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"agoda-pp-cli teach",
		"agoda-pp-cli recall",
		"agoda-pp-cli learnings",
		"agoda-pp-cli teach-pattern",
		"agoda-pp-cli teach-lookup",
		"agoda-pp-cli items list",
	}
