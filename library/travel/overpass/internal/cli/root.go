...
type rootFlags struct {
	...
	// invocation. Mirrors the OVERPASS_NO_LEARN env var.
	noLearn       bool
	selectFields  string
	configPath    string
	homePath      string
...
Health check: run 'overpass-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("overpass-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'overpass-pp-cli profile list')")
	...
	rootCmd.AddCommand(newOverpassCmd(flags))
	...
	rootCmd.AddCommand(newNovelMirrorsCmd(flags))
	rootCmd.AddCommand(newNovelNearCmd(flags))
	rootCmd.AddCommand(newNovelGeojsonCmd(flags))
	rootCmd.AddCommand(newNovelRouteCmd(flags))
	rootCmd.AddCommand(newNovelTypesCmd(flags))
