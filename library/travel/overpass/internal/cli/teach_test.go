...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("OVERPASS_STATE_DIR", "")
	t.Setenv("OVERPASS_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"overpass-pp-cli auth login",
		"overpass-pp-cli doctor",
		"overpass-pp-cli help items",
		"overpass-pp-cli sync",
		"overpass-pp-cli profile list",
		"overpass-pp-cli feedback list",
		"overpass-pp-cli which",
		"overpass-pp-cli agent-context",
		"overpass-pp-cli completion bash",
		"overpass-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"overpass-pp-cli recall",
		"overpass-pp-cli learnings",
		"overpass-pp-cli teach-pattern",
		"overpass-pp-cli teach-lookup",
		"overpass-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("overpass-pp-cli")); err == nil {
