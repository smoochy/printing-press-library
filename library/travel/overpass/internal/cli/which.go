...
var whichIndex = []whichEntry{
	{Command: "near", Description: "Finds things worth photographing near a place — water towers, lighthouses, brutalist buildings, piers, viewpoints — by name rather than by OpenStreetMap tag.", Group: "Subjects without the query language", WhyItMatters: "Reach for this whenever someone wants to know what is worth shooting around a place, without needing to know OpenStreetMap tagging."},
	{Command: "types", Description: "Lists every subject type the CLI knows how to find, with the OpenStreetMap tags behind each one.", Group: "Subjects without the query language", WhyItMatters: "Reach for this to see what can be searched before running near, or to check what tags a subject type actually resolves to."},
	{Command: "route", Description: "Finds subjects inside a corridor between two places, so a drive can be planned around what is worth stopping for.", Group: "Subjects without the query language", WhyItMatters: "Reach for this when planning a drive or day trip and the question is what to stop for on the way."},
	{Command: "geojson", Description: "Writes results as GeoJSON for opening in a map, a Leaflet page, or any GIS tool.", Group: "Subjects without the query language", WhyItMatters: "Reach for this when the result needs to end up on a map rather than in a terminal."},
	{Command: "mirrors", Description: "Shows which Overpass mirrors are currently answering and how many rate-limit slots each has free.", Group: "Surviving a flaky public API", WhyItMatters: "Reach for this when queries are failing or slow, before assuming the query itself is wrong."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  overpass-pp-cli which "stale tickets"
  overpass-pp-cli which "bottleneck"
  overpass-pp-cli which --limit 1 "send message"
  overpass-pp-cli which                                # list the full capability index`,
