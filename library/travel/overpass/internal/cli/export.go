...
large datasets as it has no memory pressure.`,
  ...
  overpass-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  overpass-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  overpass-pp-cli export <resource> --format jsonl | jq '.id'`,
