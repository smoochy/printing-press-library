...
func Load(configPath string) (*Config, error) {
	...
	if v := os.Getenv("FLIGHTY_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("FLIGHTY_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "flighty-pp-cli", "config.toml"), nil
}
