...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/travel/flighty/internal/cliutil/testenv"
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"flighty-pp-cli auth login",
		"flighty-pp-cli doctor",
		"flighty-pp-cli help items",
		"flighty-pp-cli sync",
		"flighty-pp-cli profile list",
		"flighty-pp-cli feedback list",
		"flighty-pp-cli which",
		"flighty-pp-cli agent-context",
		"flighty-pp-cli completion bash",
		"flighty-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"flighty-pp-cli recall",
		"flighty-pp-cli learnings",
		"flighty-pp-cli teach-pattern",
		"flighty-pp-cli teach-lookup",
		"flighty-pp-cli items list",
	}
