...
large datasets as it has no memory pressure.`,
  ...
  flighty-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  flighty-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  flighty-pp-cli export <resource> --format jsonl | jq '.id'`,
