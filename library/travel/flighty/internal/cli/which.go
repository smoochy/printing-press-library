...
var whichIndex = []whichEntry{
	{Command: "airports worst", Description: "Rank the network's airports right now by cumulative delay and cancellations — the web map color-codes but never ranks.", Group: "Cross-airport intelligence", WhyItMatters: "When an agent needs 'which airports are worst right now', this answers in one command instead of scraping the map."},
	{Command: "airports find-flight", Description: "Find one flight by number across arrivals and departures boards — status, original vs actual time, gate, belt, terminal.", Group: "Flight board intelligence", WhyItMatters: "The 'when is my flight actually leaving' question answered in one deterministic command."},
	{Command: "airports airline", Description: "One airline's delay/cancel/divert footprint aggregated across every synced airport — impossible per-airport on the site.", Group: "Cross-airport intelligence", WhyItMatters: "Travel agents and ops folks ask 'which airline is the worst offender across my hubs today' — this answers it network-wide."},
	{Command: "airports compare", Description: "Side-by-side status, delays, warnings, and flight rules for two airports.", Group: "Cross-airport intelligence", WhyItMatters: "Choosing between alternates (SFO vs OAK) is a two-entity question the site cannot express."},
	{Command: "airports route", Description: "Both directions of one origin-destination pair's delay/cancel/divert stats, joined from each side's disrupted routes.", Group: "Cross-airport intelligence", WhyItMatters: "Route data exists only from one airport's perspective; this shows both ends of the same route."},
	{Command: "airports nearby", Description: "Distance-ranked nearby airports, flagging which have normal operations right now.", Group: "Cross-airport intelligence", WhyItMatters: "When your airport is melting down, 'where else can I fly from' is the immediate follow-up."},
	{Command: "airports diff", Description: "What changed since the last sync: status transitions, new/cleared warnings, delay deltas.", Group: "Local state that compounds", WhyItMatters: "Monitors and writers need 'what changed since this morning' — the numbers reset upstream, local history persists."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  flighty-pp-cli which "stale tickets"
  flighty-pp-cli which "bottleneck"
  flighty-pp-cli which --limit 1 "send message"
  flighty-pp-cli which                                # list the full capability index`,
