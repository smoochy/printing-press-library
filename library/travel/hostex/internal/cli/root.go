...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "hostex-pp-cli",
		Short: `Hostex CLI — Every Hostex v3 operation, plus a local SQLite mirror that answers cross-property questions no single Hostex call can —…`,
		Long: `Hostex CLI — Every Hostex v3 operation, plus a local SQLite mirror that answers cross-property questions no single Hostex call can —…
...
Health check: run 'hostex-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("hostex-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'hostex-pp-cli profile list')")
	...
	rootCmd.AddCommand(newAvailabilitiesCmd(flags))
	rootCmd.AddCommand(newCalendarShareLinksCmd(flags))
	...
	rootCmd.AddCommand(newReservationTagsCmd(flags))
	rootCmd.AddCommand(newReservationsCmd(flags))
	rootCmd.AddCommand(newReviewsCmd(flags))
	rootCmd.AddCommand(newRoomTypesCmd(flags))
	rootCmd.AddCommand(newStaffsCmd(flags))
	...
	rootCmd.AddCommand(newNovelAutomationPreviewCmd(flags))
	rootCmd.AddCommand(newNovelInboxSlaCmd(flags))
	rootCmd.AddCommand(newNovelOpsGapsCmd(flags))
	rootCmd.AddCommand(newNovelOversellWatchCmd(flags))
	rootCmd.AddCommand(newNovelPriceParityCmd(flags))
	rootCmd.AddCommand(newNovelRevenueRollupCmd(flags))
	rootCmd.AddCommand(newNovelStayBriefCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newChannelAccountsPromotedCmd(flags))
	rootCmd.AddCommand(newCustomChannelsPromotedCmd(flags))
	rootCmd.AddCommand(newExpenseItemsPromotedCmd(flags))
	rootCmd.AddCommand(newExpenseMethodsPromotedCmd(flags))
	rootCmd.AddCommand(newIncomeItemsPromotedCmd(flags))
	rootCmd.AddCommand(newIncomeMethodsPromotedCmd(flags))
	rootCmd.AddCommand(newPricingRatiosPromotedCmd(flags))
