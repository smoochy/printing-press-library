...
var whichIndex = []whichEntry{
	...
	{Command: "inbox-sla", Description: "Rank open guest conversations by age since the last guest message and flag threads past your SLA.", Group: "Inbox and automation SLA", WhyItMatters: "OTAs penalize slow replies; use this to triage which threads are about to breach SLA."},
	{Command: "automation-preview", Description: "List pending automated messages and reviews and flag any whose thread a human has already handled.", Group: "Inbox and automation SLA", WhyItMatters: "Use to vet queued bot actions before they fire on a human-handled thread; for slow human threads use inbox-sla."},
...
Exit codes:
  ...
  hostex-pp-cli which                                # list the full capability index`,
