...
Resource scoping:
  ...
  hostex-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  hostex-pp-cli sync --full
  ...
  hostex-pp-cli sync --latest-only`,
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "availabilities":
		return db.UpsertAvailabilities(data)
	case "calendar-share-links":
		return db.UpsertCalendarShareLinks(data)
	case "channel-accounts":
		return db.UpsertChannelAccounts(data)
	case "conversations":
		return db.UpsertConversations(data)
	case "note":
		return db.UpsertNote(data)
	case "preapprovals":
		return db.UpsertPreapprovals(data)
	case "special_offers":
		return db.UpsertSpecialOffers(data)
	case "custom-channels":
		return db.UpsertCustomChannels(data)
	case "expense-items":
		return db.UpsertExpenseItems(data)
	case "expense-methods":
		return db.UpsertExpenseMethods(data)
	case "groups":
		return db.UpsertGroups(data)
	case "income-items":
		return db.UpsertIncomeItems(data)
	case "income-methods":
		return db.UpsertIncomeMethods(data)
	case "knowledge-bases":
		return db.UpsertKnowledgeBases(data)
	case "listings":
		return db.UpsertListings(data)
	case "oauth":
		return db.UpsertOauth(data)
	case "pricing-ratios":
		return db.UpsertPricingRatios(data)
	case "properties":
		return db.UpsertProperties(data)
	case "reservation-tags":
		return db.UpsertReservationTags(data)
	case "reservations":
		return db.UpsertReservations(data)
	case "allocate":
		return db.UpsertAllocate(data)
	case "approve":
		return db.UpsertApprove(data)
	case "check_in_details":
		return db.UpsertCheckInDetails(data)
	case "custom_fields":
		return db.UpsertCustomFields(data)
	case "decline":
		return db.UpsertDecline(data)
	case "move_to_box":
		return db.UpsertMoveToBox(data)
	case "stay_status":
		return db.UpsertStayStatus(data)
	case "reservations_tags":
		return db.UpsertReservationsTags(data)
	case "reviews":
		return db.UpsertReviews(data)
	case "room-types":
		return db.UpsertRoomTypes(data)
	case "staffs":
		return db.UpsertStaffs(data)
	case "tags":
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		...
		"listings":             "/listings",
		"message":              "/automation/actions?type=message",
		"pricing-ratios":       "/pricing_ratios",
		"properties":           "/properties",
		"reservation-tags":     "/reservation_tags",
		"reservations":         "/reservations",
		"review":               "/automation/actions?type=review",
		"reviews":              "/reviews",
