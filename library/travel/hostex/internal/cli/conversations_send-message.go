...
func newConversationsSendMessageCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&bodyMessage, "message", "", "The text content of the message. Max length depends on the limit of different channels.")
