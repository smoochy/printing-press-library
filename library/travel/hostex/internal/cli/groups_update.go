...
func newGroupsUpdateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&bodyPropertyIds, "property-ids", "", "Replaces the group's property list with the given ids (each must belong to the operator). Empty array detaches all.")
