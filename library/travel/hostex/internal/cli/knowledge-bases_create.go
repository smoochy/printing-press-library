...
func newKnowledgeBasesCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "create",
		Short:       "Create a new knowledge base entry for the HostGPT automation assistant.",
		Example:     "  hostex-pp-cli knowledge-bases create",
		Annotations: map[string]string{"pp:endpoint": "knowledge-bases.create", "pp:method": "POST", "pp:path": "/knowledge_bases"},
