...
func newGroupsQueryCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "query",
		Aliases:     []string{"list"},
		Short:       "You can query property groups by making a request to this endpoint.",
		Example:     "  hostex-pp-cli groups query",
		Annotations: map[string]string{"pp:endpoint": "groups.query", "pp:method": "GET", "pp:path": "/groups", "mcp:read-only": "true"},
