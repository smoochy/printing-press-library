...
func newListingsUpdateRestrictionsCmd(flags *rootFlags) *cobra.Command {
	var bodyChannelType string
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !stdinBody {
				...
				if !cmd.Flags().Changed("restrictions") && !flags.dryRun {
					return fmt.Errorf("required flag \"%s\" not set", "restrictions")
				}
			}
