...
func newListingsQueryCalendarsCmd(flags *rootFlags) *cobra.Command {
	var bodyEndDate string
	var bodyListings string
	...
	cmd.Flags().StringVar(&bodyListings, "listings", "", "A list of listing object. The listing object contains the listing id and channel type.")
	cmd.Flags().StringVar(&bodyStartDate, "start-date", "", "The start date for records. The date format is YYYY-MM-DD, and must be within 1 years from now.")
