...
func newTagsQueryCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "query",
		Aliases:     []string{"list"},
		Short:       "You can query tags by making a request to this endpoint.",
		Example:     "  hostex-pp-cli tags query",
		Annotations: map[string]string{"pp:endpoint": "tags.query", "pp:method": "GET", "pp:path": "/tags", "mcp:read-only": "true"},
	...
	cmd.Flags().StringVar(&flagId, "id", "", "The id of the tag.")
