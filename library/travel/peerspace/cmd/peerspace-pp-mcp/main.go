...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/travel/peerspace/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("PEERSPACE_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "peerspace-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
