...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/travel/sea-airport-parking/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("SEA_AIRPORT_PARKING_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "sea-airport-parking-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
