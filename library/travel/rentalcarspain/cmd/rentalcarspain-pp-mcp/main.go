...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/travel/rentalcarspain/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("RENTALCARSPAIN_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "rentalcarspain-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
