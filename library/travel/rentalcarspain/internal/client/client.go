...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/travel/rentalcarspain/internal/config"
	"io"
	"math"
	"net/http"
	"net/url"
...
func (c *Client) doInternal(ctx context.Context, method, path string, params map[string]string, body any, headerOverrides map[string]string, readOnlyIntent bool) (json.RawMessage, int, error) {
	...
	for attempt := 0; attempt <= maxRetries; attempt++ {
		...
		req.Header.Set("User-Agent", "rentalcarspain-pp-cli/0.1 (+https://github.com/mvanhorn/printing-press-library)")
		if c.Config != nil {
		...
		if req.Header.Get("User-Agent") == "" {
			req.Header.Set("User-Agent", "rentalcarspain-pp-cli/0.1.0")
		}
