...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/travel/opensky/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("OPENSKY_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "opensky-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
