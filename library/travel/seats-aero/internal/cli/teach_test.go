...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"seats-aero-pp-cli auth login",
		"seats-aero-pp-cli doctor",
		"seats-aero-pp-cli help items",
		"seats-aero-pp-cli sync",
		"seats-aero-pp-cli profile list",
		"seats-aero-pp-cli feedback list",
		"seats-aero-pp-cli which",
		"seats-aero-pp-cli agent-context",
		"seats-aero-pp-cli completion bash",
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"seats-aero-pp-cli recall",
		"seats-aero-pp-cli learnings",
		"seats-aero-pp-cli teach-pattern",
		"seats-aero-pp-cli teach-lookup",
		"seats-aero-pp-cli items list",
	}
