...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/project-management/redmine/internal/learn/lookups"
...
Resource scoping:
  ...
  redmine-pp-cli sync --resources custom-fields-json,enumerations

  # Full resync (ignore previous checkpoint)
  redmine-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  redmine-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  redmine-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  redmine-pp-cli sync --latest-only`,
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "groups_users_json":
		return db.UpsertGroupsUsersJson(data)
	case "relations_json":
		return db.UpsertRelationsJson(data)
	case "issues_time_entries_json":
		return db.UpsertIssuesTimeEntriesJson(data)
	case "watchers":
		return db.UpsertWatchers(data)
	case "watchers_json":
		return db.UpsertWatchersJson(data)
	case "archive_json":
		return db.UpsertArchiveJson(data)
	case "close_json":
		return db.UpsertCloseJson(data)
	case "files_json":
		return db.UpsertFilesJson(data)
	case "issue_categories_json":
		return db.UpsertIssueCategoriesJson(data)
	case "projects_issues_json":
		return db.UpsertProjectsIssuesJson(data)
	case "memberships_json":
		return db.UpsertMembershipsJson(data)
	case "projects_news_json":
		return db.UpsertProjectsNewsJson(data)
	case "reopen_json":
		return db.UpsertReopenJson(data)
	case "repository":
		return db.UpsertRepository(data)
	case "projects_search_json":
		return db.UpsertProjectsSearchJson(data)
	case "projects_time_entries_json":
		return db.UpsertProjectsTimeEntriesJson(data)
	case "unarchive_json":
		return db.UpsertUnarchiveJson(data)
	case "versions_json":
		return db.UpsertVersionsJson(data)
	case "wiki":
...
func defaultSyncResources() []string {
	return []string{
		"custom-fields-json",
		"enumerations",
		"enumerations-issue-priorities-json",
		"enumerations-time-entry-activities-json",
		"groups-json",
		"issue-statuses-json",
		"issues-json",
		"news-json",
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{ // #nosec G101 -- endpoint paths, not credentials.
		...
		"enumerations-issue-priorities-json":      "/enumerations/issue_priorities.json",
		"enumerations-time-entry-activities-json": "/enumerations/time_entry_activities.json",
		"groups-json":                             "/groups.json",
		"issue-statuses-json":                     "/issue_statuses.json",
		"issues-json":                             "/issues.json",
		"memberships-json":                        "/projects/{project_id}/memberships.json",
		"news-json":                               "/news.json",
...
var flatReconcileModes = map[string]string{
	"custom-fields-json":                      "flat_global",
	"enumerations":                            "flat_global",
	"enumerations-issue-priorities-json":      "flat_global",
	"enumerations-time-entry-activities-json": "flat_global",
	"groups-json":                             "flat_global",
	"issue-statuses-json":                     "flat_global",
	"issues-json":                             "flat_global",
	"memberships-json":                        "flat_global",
	"news-json":                               "flat_global",
	"projects-json":                           "flat_global",
	"queries-json":                            "flat_global",
	"roles-json":                              "flat_global",
	"search-json":                             "flat_global",
	"time-entries-json":                       "flat_global",
	"trackers-json":                           "flat_global",
	"users-json":                              "flat_global",
}
...
var reconcileTypedTables = map[string]string{
	...
	"groups_users_json":          "groups_users_json",
	"issue_categories_json":      "issue_categories_json",
	"issues_time_entries_json":   "issues_time_entries_json",
	"memberships_json":           "memberships_json",
	"projects_issues_json":       "projects_issues_json",
	"projects_news_json":         "projects_news_json",
	"projects_search_json":       "projects_search_json",
	"projects_time_entries_json": "projects_time_entries_json",
	"relations_json":             "relations_json",
	"reopen_json":                "reopen_json",
	"repository":                 "repository",
	"unarchive_json":             "unarchive_json",
	"versions_json":              "versions_json",
	"watchers":                   "watchers",
	"watchers_json":              "watchers_json",
	"wiki":                       "wiki",
}
...
func responsePathForResource(resource, path string) []string {
	...
	case "custom-fields-json\x00/custom_fields.json":
		return []string{"custom_fields"}
	case "enumerations\x00/enumerations/document_categories.json":
		return []string{"document_categories"}
	case "enumerations\x00/enumerations/issue_priorities.json":
		return []string{"issue_priorities"}
	case "enumerations\x00/enumerations/time_entry_activities.json":
		return []string{"time_entry_activities"}
	case "groups-json\x00/groups.json":
		return []string{"groups"}
	case "issue-statuses-json\x00/issue_statuses.json":
		return []string{"issue_statuses"}
	case "issues-json\x00/issues.json":
		return []string{"issues"}
	case "news-json\x00/news.json":
		return []string{"news"}
	case "projects-json\x00/projects.json":
		return []string{"projects"}
	case "queries-json\x00/queries.json":
		return []string{"queries"}
	case "roles-json\x00/roles.json":
		return []string{"roles"}
	case "search-json\x00/search.json":
		return []string{"results"}
	case "time-entries-json\x00/time_entries.json":
		return []string{"time_entries"}
	case "trackers-json\x00/trackers.json":
		return []string{"trackers"}
	case "users-json\x00/users.json":
		return []string{"users"}
	}
	return nil
}
