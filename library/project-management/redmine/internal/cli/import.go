...
but do not stop the import.`,
  ...
  redmine-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  redmine-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | redmine-pp-cli import <resource> --input -`,
