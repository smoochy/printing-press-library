...
var whichIndex = []whichEntry{
	{Command: "roadmap burndown", Description: "See open/closed issue counts, average completion, and logged-vs-estimated hours for a release version — the Roadmap page Redmine never exposed as an API.", Group: "Local state that compounds", WhyItMatters: "Reach for this before a release-readiness call instead of hand-counting issues in the web UI."},
	{Command: "workload", Description: "See every assignee's open-issue count and estimated hours in one aggregate view, with a flag for anyone over threshold.", Group: "Local state that compounds", WhyItMatters: "Use this before sprint planning to catch overload without opening every engineer's issue list one by one."},
	{Command: "issues stale", Description: "Find open issues nobody has touched in N days — Redmine has no built-in staleness concept.", Group: "Local state that compounds", WhyItMatters: "Use this for triage sweeps to surface issues that fell through the cracks, not recently active ones."},
	{Command: "digest", Description: "A personal activity report of what was created, updated, or closed in a time window, optionally scoped to issues assigned to or watched by you.", Group: "Local state that compounds", WhyItMatters: "Use this for a 'what did I miss' catch-up instead of paging through each project's activity feed by hand."},
	{Command: "issues cycle-time", Description: "Average days from creation to close, grouped by tracker or project — real duration math the API can't do.", Group: "Local state that compounds", WhyItMatters: "Use this to spot which issue types are taking longer than they should to resolve."},
	{Command: "issues blockers", Description: "Walk the full multi-hop 'blocks'/'blocked by' dependency chain for an issue, not just its direct relations.", Group: "Local state that compounds", WhyItMatters: "Use this before starting work on an issue to confirm it isn't blocked three hops away by something you haven't seen yet."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  redmine-pp-cli which "stale tickets"
  redmine-pp-cli which "bottleneck"
  redmine-pp-cli which --limit 1 "send message"
  redmine-pp-cli which                                # list the full capability index`,
