...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/project-management/redmine/internal/cliutil/testenv"
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"redmine-pp-cli auth login",
		"redmine-pp-cli doctor",
		"redmine-pp-cli help items",
		"redmine-pp-cli sync",
		"redmine-pp-cli profile list",
		"redmine-pp-cli feedback list",
		"redmine-pp-cli which",
		"redmine-pp-cli agent-context",
		"redmine-pp-cli completion bash",
		"redmine-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"redmine-pp-cli recall",
		"redmine-pp-cli learnings",
		"redmine-pp-cli teach-pattern",
		"redmine-pp-cli teach-lookup",
		"redmine-pp-cli items list",
	}
