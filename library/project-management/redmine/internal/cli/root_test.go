...
func TestDeclaredAPISurfaceReachable(t *testing.T) {
	expected := []string{
		...
		"custom-fields-json",
		"enumerations",
		"enumerations get-document-categories",
		"enumerations get-issue-priorities",
		"enumerations get-time-entry-activities",
		"groups",
		"groups delete",
		"groups get",
		"groups update",
		"groups users",
		"groups users remove-from-group",
		"groups users-json",
		"groups users-json add-user-to-group",
		"groups-json",
		"groups-json create-group",
		"groups-json get-groups",
		"issue-categories",
		"issue-categories delete-issue-category",
		"issue-categories get-issue-category",
		"issue-categories update-issue-category",
		"issue-statuses-json",
		"issues",
		"issues delete",
		"issues get",
		"issues relations-json",
		"issues relations-json create-issue-relation",
		"issues relations-json get-issue-relations",
		"issues time-entries-json",
		"issues time-entries-json create-time-entry-under-issue",
		"issues update",
		"issues watchers",
		"issues watchers remove",
		"issues watchers-json",
		"issues watchers-json add-watcher",
		"issues-json",
		...
		"projects archive-json archive-project",
		"projects close-json",
		"projects close-json close-project",
		"projects delete",
		"projects files-json",
		"projects files-json create-file",
		"projects files-json get-files",
		"projects get",
		"projects issue-categories-json",
		"projects issue-categories-json create-issue-category",
		"projects issue-categories-json get-issue-categories",
		"projects issues-json",
		"projects issues-json create-issue-under-project",
		"projects issues-json get-issues-by-project",
		"projects memberships-json",
		"projects memberships-json create-membership",
		"projects memberships-json get-memberships",
		"projects news-json",
		"projects news-json create-news",
		"projects news-json get-news-list-by-project",
		"projects reopen-json",
		"projects reopen-json reopen-project",
		"projects repository",
		"projects repository add-related-issue",
		"projects repository remove-related-issue",
		"projects search-json",
		"projects search-json get-search-by-project",
		"projects time-entries-json",
		"projects time-entries-json create-time-entry-under-project",
		"projects time-entries-json get-time-entries-by-project",
		"projects unarchive-json",
		"projects unarchive-json unarchive-project",
		"projects update",
		"projects versions-json",
		"projects versions-json create-version",
		"projects versions-json get-versions-by-project",
		"projects wiki",
		"projects wiki delete-page",
		"projects wiki get-page",
		"projects wiki get-page-by-version",
		"projects wiki get-pages",
		"projects wiki update-page",
		"projects-json",
		"projects-json create-project",
		"projects-json get-projects",
		"queries-json",
		"relations",
		"relations delete-issue",
		"relations get-issue",
		"roles",
		"roles-json",
		"search-json",
		...
		"time-entries-json",
		"time-entries-json create-time-entry",
		"time-entries-json get-time-entries",
		"trackers-json",
		"uploads-json",
		"users",
		"users delete",
