...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/project-management/redmine/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("REDMINE_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "redmine-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
