...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/media-and-entertainment/immich/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("IMMICH_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "immich-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
