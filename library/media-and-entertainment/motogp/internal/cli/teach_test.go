...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("MOTOGP_STATE_DIR", "")
	t.Setenv("MOTOGP_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"motogp-pp-cli auth login",
		"motogp-pp-cli doctor",
		"motogp-pp-cli help items",
		"motogp-pp-cli sync",
		"motogp-pp-cli profile list",
		"motogp-pp-cli feedback list",
		"motogp-pp-cli which",
		"motogp-pp-cli agent-context",
		"motogp-pp-cli completion bash",
		"motogp-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"motogp-pp-cli teach",
		"motogp-pp-cli recall",
		"motogp-pp-cli learnings",
		"motogp-pp-cli teach-pattern",
		"motogp-pp-cli teach-lookup",
		"motogp-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("motogp-pp-cli")); err == nil {
