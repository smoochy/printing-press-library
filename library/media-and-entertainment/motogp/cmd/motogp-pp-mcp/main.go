...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/media-and-entertainment/motogp/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("MOTOGP_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "motogp-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
