...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/media-and-entertainment/snipd/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("SNIPD_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "snipd-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
