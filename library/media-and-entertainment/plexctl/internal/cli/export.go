...
large datasets as it has no memory pressure.`,
  ...
  plexctl-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  plexctl-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  plexctl-pp-cli export <resource> --format jsonl | jq '.id'`,
