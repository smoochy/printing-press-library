...
but do not stop the import.`,
  ...
  plexctl-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  plexctl-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | plexctl-pp-cli import <resource> --input -`,
