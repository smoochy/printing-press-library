...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/media-and-entertainment/plexctl/internal/cliutil/testenv"
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"plexctl-pp-cli auth login",
		"plexctl-pp-cli doctor",
		"plexctl-pp-cli help items",
		"plexctl-pp-cli sync",
		"plexctl-pp-cli profile list",
		"plexctl-pp-cli feedback list",
		"plexctl-pp-cli which",
		"plexctl-pp-cli agent-context",
		"plexctl-pp-cli completion bash",
		"plexctl-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"plexctl-pp-cli recall",
		"plexctl-pp-cli learnings",
		"plexctl-pp-cli teach-pattern",
		"plexctl-pp-cli teach-lookup",
		"plexctl-pp-cli items list",
	}
