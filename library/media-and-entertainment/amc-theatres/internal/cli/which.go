...
var whichIndex = []whichEntry{
	{Command: "movie-plan", Description: "Find, filter, and rank AMC showtimes by theatre or current location without purchasing tickets.", Group: "Movie planning", WhyItMatters: "Agents can return a short ranked set of relevant screenings without inventing purchase capabilities."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  amc-theatres-pp-cli which "stale tickets"
  amc-theatres-pp-cli which "bottleneck"
  amc-theatres-pp-cli which --limit 1 "send message"
  amc-theatres-pp-cli which                                # list the full capability index`,
