...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/media-and-entertainment/amc-theatres/internal/cliutil/testenv"
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"amc-theatres-pp-cli auth login",
		"amc-theatres-pp-cli doctor",
		"amc-theatres-pp-cli help items",
		"amc-theatres-pp-cli sync",
		"amc-theatres-pp-cli profile list",
		"amc-theatres-pp-cli feedback list",
		"amc-theatres-pp-cli which",
		"amc-theatres-pp-cli agent-context",
		"amc-theatres-pp-cli completion bash",
		"amc-theatres-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"amc-theatres-pp-cli recall",
		"amc-theatres-pp-cli learnings",
		"amc-theatres-pp-cli teach-pattern",
		"amc-theatres-pp-cli teach-lookup",
		"amc-theatres-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("amc-theatres-pp-cli")); err == nil {
