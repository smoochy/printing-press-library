...
type rootFlags struct {
	...
	// invocation. Mirrors the AMC_THEATRES_NO_LEARN env var.
	noLearn                 bool
	selectFields            string
	configPath              string
	homePath                string
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "amc-theatres-pp-cli",
		Short: "Manage amc-theatres resources via the amc-theatres API",
		Long: `Manage amc-theatres resources via the amc-theatres API.
...
Run 'amc-theatres-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("amc-theatres-pp-cli {{ .Version }}\n")
