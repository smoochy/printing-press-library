...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/media-and-entertainment/printgoat/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("PRINTGOAT_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "printgoat-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
