...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/media-and-entertainment/bookmakersreview/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("BOOKMAKERSREVIEW_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "bookmakersreview-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
