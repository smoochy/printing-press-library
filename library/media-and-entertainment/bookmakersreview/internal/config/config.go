...
func Load(configPath string) (*Config, error) {
	cfg := &Config{
		BaseURL: "https://ms.virginia.us-east-1.bookmakersreview.com/ms-odds-v2/odds-v2-service",
	}
	...
	if v := os.Getenv("BOOKMAKERSREVIEW_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("BOOKMAKERSREVIEW_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "bookmakersreview-pp-cli", "config.json"), nil
}
