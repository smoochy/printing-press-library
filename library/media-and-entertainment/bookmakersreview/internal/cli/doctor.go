...
func newDoctorCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  bookmakersreview-pp-cli doctor
  bookmakersreview-pp-cli doctor --json
  bookmakersreview-pp-cli doctor --fail-on warn
  bookmakersreview-pp-cli doctor --fail-on stale`,
			...
			if cfg != nil && cfg.BaseURL != "" {
				...
				if clientErr != nil {
					...
					if authHeader == "" {
						...
						if suggestion != "" {
							report["credentials"] = fmt.Sprintf("present, not verified. Run `%s %s` to confirm the token works end-to-end.", "bookmakersreview-pp-cli", suggestion)
						} else {
