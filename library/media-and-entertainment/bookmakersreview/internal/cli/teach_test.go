...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("BOOKMAKERSREVIEW_STATE_DIR", "")
	t.Setenv("BOOKMAKERSREVIEW_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"bookmakersreview-pp-cli auth login",
		"bookmakersreview-pp-cli doctor",
		"bookmakersreview-pp-cli help items",
		"bookmakersreview-pp-cli sync",
		"bookmakersreview-pp-cli profile list",
		"bookmakersreview-pp-cli feedback list",
		"bookmakersreview-pp-cli which",
		"bookmakersreview-pp-cli agent-context",
		"bookmakersreview-pp-cli completion bash",
		"bookmakersreview-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"bookmakersreview-pp-cli recall",
		"bookmakersreview-pp-cli learnings",
		"bookmakersreview-pp-cli teach-pattern",
		"bookmakersreview-pp-cli teach-lookup",
		"bookmakersreview-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("bookmakersreview-pp-cli")); err == nil {
