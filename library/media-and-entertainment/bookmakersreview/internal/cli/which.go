...
var whichIndex = []whichEntry{
	{Command: "odds value", Description: "See which sportsbook's current price beats the vig-free fair line before you bet.", Group: "Line shopping", WhyItMatters: "Reach for this before placing a bet to confirm you are not just getting the highest number, but a genuinely positive-EV price."},
	{Command: "steam scan", Description: "Scan today's whole slate for fast, coordinated line moves that signal sharp money before the market fully reacts.", Group: "Line shopping", WhyItMatters: "Use this when you want to catch sharp action across an entire day's games rather than watching one event."},
	{Command: "bets record", Description: "Log your own wager (event, market, price, book, timestamp) to a local ledger.", Group: "Closing line value", WhyItMatters: "Use this immediately after placing a real bet so it can later be graded against the closing line."},
	{Command: "bets grade", Description: "Compare one recorded bet's price to the market's closing line to compute its CLV.", Group: "Closing line value", WhyItMatters: "Use this after a game closes to see whether you beat the closing number, the standard measure of betting skill."},
	{Command: "bets report", Description: "See your running closing-line-value percentage and win rate across every recorded bet.", Group: "Closing line value", WhyItMatters: "Use this weekly/monthly to track betting performance over time instead of grading bets one at a time."},
	{Command: "arb scan", Description: "Find risk-free two-sided price mismatches across sportsbooks for one event.", Group: "Line shopping", WhyItMatters: "Use this to find guaranteed-profit spreads across books; do not use it to judge single-side value, use odds value for that."},
	{Command: "odds movement", Description: "See the full open-to-current price timeline for one event and market, across books.", Group: "Closing line value", WhyItMatters: "Use this to see how a specific line moved over time; use steam scan instead to find movement across the whole day's slate."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  bookmakersreview-pp-cli which "stale tickets"
  bookmakersreview-pp-cli which "bottleneck"
  bookmakersreview-pp-cli which --limit 1 "send message"
  bookmakersreview-pp-cli which                                # list the full capability index`,
