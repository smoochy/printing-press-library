...
but do not stop the import.`,
  ...
  bookmakersreview-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  bookmakersreview-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | bookmakersreview-pp-cli import <resource> --input -`,
