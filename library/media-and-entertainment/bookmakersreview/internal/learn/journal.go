...
const (
	journalSessionEnvVar   = "BOOKMAKERSREVIEW_LEARN_SESSION"
	journalNoLearnEnvVar   = "BOOKMAKERSREVIEW_NO_LEARN"
	journalNoCaptureEnvVar = "BOOKMAKERSREVIEW_LEARN_NO_CAPTURE"
)
