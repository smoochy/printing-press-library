...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"flow-pp-cli auth login",
		"flow-pp-cli doctor",
		"flow-pp-cli help items",
		"flow-pp-cli sync",
		"flow-pp-cli profile list",
		"flow-pp-cli feedback list",
		"flow-pp-cli which",
		"flow-pp-cli agent-context",
		"flow-pp-cli completion bash",
		"flow-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"flow-pp-cli teach",
		"flow-pp-cli recall",
		"flow-pp-cli learnings",
		"flow-pp-cli teach-pattern",
		"flow-pp-cli teach-lookup",
		"flow-pp-cli items list",
	}
