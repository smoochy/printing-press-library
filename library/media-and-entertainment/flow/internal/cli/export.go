...
large datasets as it has no memory pressure.`,
  ...
  flow-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  flow-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  flow-pp-cli export <resource> --format jsonl | jq '.id'`,
