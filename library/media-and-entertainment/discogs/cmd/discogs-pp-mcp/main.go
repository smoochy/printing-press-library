...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/media-and-entertainment/discogs/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("DISCOGS_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "discogs-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
