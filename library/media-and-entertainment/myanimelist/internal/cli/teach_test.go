...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"myanimelist-pp-cli auth login",
		"myanimelist-pp-cli doctor",
		"myanimelist-pp-cli help items",
		"myanimelist-pp-cli sync",
		"myanimelist-pp-cli profile list",
		"myanimelist-pp-cli feedback list",
		"myanimelist-pp-cli which",
		"myanimelist-pp-cli agent-context",
		"myanimelist-pp-cli completion bash",
		"myanimelist-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"myanimelist-pp-cli recall",
		"myanimelist-pp-cli learnings",
		"myanimelist-pp-cli teach-pattern",
		"myanimelist-pp-cli teach-lookup",
		"myanimelist-pp-cli items list",
	}
