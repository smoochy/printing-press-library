...
func newNewsGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get <id>",
		Short:       "A single news article, body included",
		Example:     "  myanimelist-pp-cli news get 74696633",
		Annotations: map[string]string{"pp:endpoint": "news.get", "pp:method": "GET", "pp:path": "/news/{id}", "mcp:read-only": "true", "pp:happy-args": "id=74696633"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveReadWithStrategyResponsePathAndJSONGuard(cmd.Context(), c, flags, "auto", "news", false, path, params, headerOverrides, "", false, cmd.ErrOrStderr())
			if err != nil {
