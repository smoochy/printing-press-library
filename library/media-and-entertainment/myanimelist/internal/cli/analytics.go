...
Null or missing --group-by values are JSON null. Table output labels them (none); a literal (none) value is quoted.`,
  ...
  myanimelist-pp-cli analytics --type messages

  # Group by a field
  myanimelist-pp-cli analytics --type messages --group-by author_id

  # Top 10 most frequent values
  myanimelist-pp-cli analytics --type messages --group-by channel_id --limit 10 --json`,
