...
func newCharacterPromotedCmd(flags *rootFlags) *cobra.Command {

	cmd := &cobra.Command{
		Use:         "character <id>",
		Short:       "A character's profile with appearances and voice actors",
		Long:        "A character's profile with appearances and voice actors",
		Example:     "  myanimelist-pp-cli character 184947",
		Annotations: map[string]string{"pp:endpoint": "character.get", "pp:method": "GET", "pp:path": "/character/{id}", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveReadWithStrategyResponsePathAndJSONGuard(cmd.Context(), c, flags, "auto", "character", false, path, params, headerOverrides, "", false, cmd.ErrOrStderr())
			if err != nil {
