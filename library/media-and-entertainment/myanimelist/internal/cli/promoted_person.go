...
func newPersonPromotedCmd(flags *rootFlags) *cobra.Command {

	cmd := &cobra.Command{
		Use:         "person <id>",
		Short:       "A person's page: animeography, voice roles, and staff credits",
		Long:        "A person's page: animeography, voice roles, and staff credits",
		Example:     "  myanimelist-pp-cli person 81",
		Annotations: map[string]string{"pp:endpoint": "person.get", "pp:method": "GET", "pp:path": "/people/{id}", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveReadWithStrategyResponsePathAndJSONGuard(cmd.Context(), c, flags, "auto", "person", false, path, params, headerOverrides, "", false, cmd.ErrOrStderr())
			if err != nil {
