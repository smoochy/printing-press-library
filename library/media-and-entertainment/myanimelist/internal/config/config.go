...
func Load(configPath string) (*Config, error) {
	...
	if v := cliutil.EnvOverride("MYANIMELIST_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("MYANIMELIST_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "myanimelist-pp-cli", "config.toml"), nil
}
