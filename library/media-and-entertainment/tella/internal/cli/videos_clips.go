...
func newVideosClipsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.AddCommand(newVideosClipsGetTranscriptCmd(flags))
	...
	cmd.AddCommand(newVideosClipsRemoveSilencesCmd(flags))
	...
	cmd.AddCommand(newVideosClipsUpdateTranscriptWordsCmd(flags))
