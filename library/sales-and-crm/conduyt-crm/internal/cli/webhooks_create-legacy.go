...
func newWebhooksCreateLegacyCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "webhooks.create-legacy", "pp:method": "POST", "pp:path": "/webhooks", "pp:requires-input": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !stdinBody {
				if !cmd.Flags().Changed("events") && bodyEvents == "" && !flags.dryRun {
