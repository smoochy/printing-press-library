...
Resource scoping:
  ...
  conduyt-crm-pp-cli sync --resources automations,activities
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "account_exports_files":
		return db.UpsertAccountExportsFiles(data)
	case "recover":
	...
	case "automations_publish":
		return db.UpsertAutomationsPublish(data)
	case "step_logs":
	...
	case "call_flows_publish":
		return db.UpsertCallFlowsPublish(data)
	case "simulate":
	...
	case "suggestion":
		return db.UpsertSuggestion(data)
...
func defaultSyncResources() []string {
	// The resources the local (store-backed) commands read: send-check, imports blame and
	// contacts verify-line-type --estimate walk contacts; automations hours-audit walks automations.
	return []string{"contacts", "automations"}
}
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{ // #nosec G101 -- endpoint paths, not credentials.
		...
		"invoices":                      "/invoices",
		"lead-routing":                  "/lead-routing/assignment-log",
		"messages":                      "/messages",
		"notes":                         "/notes",
		...
		"pipelines":                     "/pipelines",
		"products":                      "/products",
		"reports":                       "/reports/dialer/list-performance",
