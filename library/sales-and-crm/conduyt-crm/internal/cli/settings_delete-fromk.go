...
func newSettingsDeleteFromkCmd(flags *rootFlags) *cobra.Command {

	cmd := &cobra.Command{
		Use:         "delete-fromk",
		Short:       "Delete settings fromk",
		Example:     "  conduyt-crm-pp-cli settings delete-fromk",
		Annotations: map[string]string{"pp:endpoint": "settings.delete-fromk", "pp:method": "DELETE", "pp:path": "/settings/fromk"},
