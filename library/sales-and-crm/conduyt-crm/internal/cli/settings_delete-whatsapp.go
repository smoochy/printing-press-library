...
func newSettingsDeleteWhatsappCmd(flags *rootFlags) *cobra.Command {

	cmd := &cobra.Command{
		Use:         "delete-whatsapp",
		Short:       "Delete settings whatsapp",
		Example:     "  conduyt-crm-pp-cli settings delete-whatsapp",
		Annotations: map[string]string{"pp:endpoint": "settings.delete-whatsapp", "pp:method": "DELETE", "pp:path": "/settings/whatsapp"},
