...
func newSettingsDeleteProjectBlueCmd(flags *rootFlags) *cobra.Command {

	cmd := &cobra.Command{
		Use:         "delete-project-blue",
		Short:       "Delete settings project-blue",
		Example:     "  conduyt-crm-pp-cli settings delete-project-blue",
		Annotations: map[string]string{"pp:endpoint": "settings.delete-project-blue", "pp:method": "DELETE", "pp:path": "/settings/project-blue"},
