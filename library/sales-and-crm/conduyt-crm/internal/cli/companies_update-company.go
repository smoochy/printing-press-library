...
func newCompaniesUpdateCompanyCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "companies.update-company", "pp:method": "PATCH", "pp:path": "/companies/{id}", "pp:requires-input": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if stdinBody {
				...
				if cmd.Flags().Changed("industry") || bodyIndustry != "" {
				...
				if cmd.Flags().Changed("website") || bodyWebsite != "" {
