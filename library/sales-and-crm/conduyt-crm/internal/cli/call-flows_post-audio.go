...
func newCallFlowsPostAudioCmd(flags *rootFlags) *cobra.Command {
	var bodyFile string

	cmd := &cobra.Command{
		Use:   "post-audio",
		Short: "Create / invoke call-flows audio",
		// TODO: replace placeholder example values before relying on this for live dogfood.
		Example:     "  conduyt-crm-pp-cli call-flows post-audio --file example-value",
		Annotations: map[string]string{"pp:endpoint": "call-flows.post-audio", "pp:method": "POST", "pp:path": "/call-flows/audio", "pp:requires-input": "true"},
	...
	cmd.Flags().StringVar(&bodyFile, "file", "", "Audio file (mp3, wav, ogg)")
