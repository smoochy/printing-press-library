...
func newContactsTagsAddContactCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "tags.add-contact", "pp:method": "POST", "pp:path": "/contacts/{id}/tags", "pp:requires-input": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !stdinBody {
				if !cmd.Flags().Changed("tag-id") && bodyTagId == "" && !flags.dryRun {
			...
			if stdinBody {
				...
				body = bodyMap
				if cmd.Flags().Changed("tag-id") || bodyTagId != "" {
