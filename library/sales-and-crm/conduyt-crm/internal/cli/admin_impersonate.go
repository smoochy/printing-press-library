...
func newAdminImpersonateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "admin.impersonate", "pp:method": "POST", "pp:path": "/admin/impersonate", "pp:requires-input": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !stdinBody {
				if !cmd.Flags().Changed("account-id") && bodyAccountId == "" && !flags.dryRun {
