...
func newCustomFieldsUpdateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "custom-fields.update", "pp:method": "PATCH", "pp:path": "/custom-fields/{id}", "pp:requires-input": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !stdinBody {
				...
				if !cmd.Flags().Changed("field-key") && bodyFieldKey == "" && !flags.dryRun {
			...
			if stdinBody {
				...
				if cmd.Flags().Changed("field-key") || bodyFieldKey != "" {
