...
func newSettingsPostOperationsCmd(flags *rootFlags) *cobra.Command {
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "post-operations",
		Aliases:     []string{"create"},
		Short:       "Create / invoke settings operations",
		Example:     "  conduyt-crm-pp-cli settings post-operations",
		Annotations: map[string]string{"pp:endpoint": "settings.post-operations", "pp:method": "POST", "pp:path": "/settings/operations"},
