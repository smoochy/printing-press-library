...
func newChatAddMemberCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "chat.add-member", "pp:method": "POST", "pp:path": "/chat/channels/{id}/members", "pp:requires-input": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !stdinBody {
				if !cmd.Flags().Changed("user-id") && bodyUserId == "" && !flags.dryRun {
