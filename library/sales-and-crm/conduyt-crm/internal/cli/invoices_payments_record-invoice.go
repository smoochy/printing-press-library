...
func newInvoicesPaymentsRecordInvoiceCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "payments.record-invoice", "pp:method": "POST", "pp:path": "/invoices/{id}/payments", "pp:requires-input": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if stdinBody {
				...
				if cmd.Flags().Changed("reference") || bodyReference != "" {
