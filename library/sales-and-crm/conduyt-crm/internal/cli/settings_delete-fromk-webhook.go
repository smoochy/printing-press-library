...
func newSettingsDeleteFromkWebhookCmd(flags *rootFlags) *cobra.Command {

	cmd := &cobra.Command{
		Use:         "delete-fromk-webhook",
		Short:       "Delete settings fromk webhook",
		Example:     "  conduyt-crm-pp-cli settings delete-fromk-webhook",
		Annotations: map[string]string{"pp:endpoint": "settings.delete-fromk-webhook", "pp:method": "DELETE", "pp:path": "/settings/fromk/webhook"},
