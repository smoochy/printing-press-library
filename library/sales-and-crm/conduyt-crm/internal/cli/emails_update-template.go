...
func newEmailsUpdateTemplateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "emails.update-template", "pp:method": "PATCH", "pp:path": "/emails/templates/{id}", "pp:requires-input": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if stdinBody {
				...
				if cmd.Flags().Changed("body-html") || bodyBodyHtml != "" {
