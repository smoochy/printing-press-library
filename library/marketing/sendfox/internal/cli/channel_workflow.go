...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  sendfox-pp-cli workflow archive --timeout 0`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"automations", "campaigns", "contact_fields", "contact_tags", "contacts", "contacts-unsubscribed", "domains", "forms", "lists"}
			if cliutil.IsDogfoodEnv() {
				if len(resources) > 3 {
