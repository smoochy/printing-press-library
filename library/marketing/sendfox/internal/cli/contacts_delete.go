...
func newContactsDeleteCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "delete <id>",
		Example:     "  sendfox-pp-cli contacts delete 12 --dry-run",
		Short:       "Soft-deletes a contact and cancels any scheduled deliverables",
		Annotations: map[string]string{"pp:happy-args": "id=12", "pp:endpoint": "contacts.delete", "pp:method": "DELETE", "pp:path": "/contacts/{id}"},
