...
func newDomainsDeleteCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "delete <id>",
		Example:     "  sendfox-pp-cli domains delete 12 --dry-run",
		Short:       "Removes the domain from SendGrid and soft-deletes locally",
		Annotations: map[string]string{"pp:happy-args": "id=12", "pp:endpoint": "domains.delete", "pp:method": "DELETE", "pp:path": "/domains/{id}"},
