...
func newContactFieldsDeleteCmd(flags *rootFlags) *cobra.Command {

	cmd := &cobra.Command{
		Use:         "delete <id>",
		Example:     "  sendfox-pp-cli contact-fields delete 12 --dry-run",
		Short:       "Permanently deletes the contact field",
		Annotations: map[string]string{"pp:happy-args": "id=12", "pp:endpoint": "contact_fields.delete", "pp:method": "DELETE", "pp:path": "/contact-fields/{id}"},
