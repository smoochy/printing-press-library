...
func newFormsDeleteCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "delete <id>",
		Example:     "  sendfox-pp-cli forms delete 12 --dry-run",
		Short:       "Soft-deletes the form",
		Annotations: map[string]string{"pp:happy-args": "id=12", "pp:endpoint": "forms.delete", "pp:method": "DELETE", "pp:path": "/forms/{id}"},
