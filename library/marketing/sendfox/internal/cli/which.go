...
var whichIndex = []whichEntry{
	{Command: "workflow audience-health", Description: "Find duplicate, invalid, suppressed and unassigned contacts from local evidence.", Group: "SendFox operations", WhyItMatters: "Find duplicate, invalid, suppressed and unassigned contacts from local evidence."},
	{Command: "workflow campaign-preflight", Description: "Check draft content, targeting, suppression evidence and sender readiness before any send.", Group: "SendFox operations", WhyItMatters: "Check draft content, targeting, suppression evidence and sender readiness before any send."},
	{Command: "workflow campaign-review", Description: "Combine campaign metrics, link performance and engagement cohorts into an auditable resend plan.", Group: "SendFox operations", WhyItMatters: "Combine campaign metrics, link performance and engagement cohorts into an auditable resend plan."},
	{Command: "workflow contact-dossier", Description: "Join contact details, memberships, tags and available engagement into one support packet.", Group: "SendFox operations", WhyItMatters: "Join contact details, memberships, tags and available engagement into one support packet."},
	{Command: "workflow automation-plan", Description: "Validate a versioned automation definition and produce inactive creation steps.", Group: "SendFox operations", WhyItMatters: "Validate a versioned automation definition and produce inactive creation steps."},
	{Command: "workflow export-bundle", Description: "Produce a local inventory bundle with per-resource completeness and provenance.", Group: "SendFox operations", WhyItMatters: "Produce a local inventory bundle with per-resource completeness and provenance."},
	{Command: "workflow migration-readiness", Description: "Compare local platform snapshots with suppression, mapping, delta and cutover gates.", Group: "Migration evidence", WhyItMatters: "Compare local platform snapshots with suppression, mapping, delta and cutover gates."},
	{Command: "me", Description: "Get current user information", Group: "me", WhyItMatters: "Get current user information"},                       // pp:which-promoted
	{Command: "unsubscribe", Description: "Unsubscribe a contact by email", Group: "unsubscribe", WhyItMatters: "Unsubscribe a contact by email"}, // pp:which-promoted
}
