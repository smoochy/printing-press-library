...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/marketing/sendfox/internal/learn/entities"
	"github.com/mvanhorn/printing-press-library/library/marketing/sendfox/internal/learn/lookups"
...
func initLearn(ctx context.Context, db *sql.DB) error {
	...
	seeds := map[string][]lookups.SeedConfig{
		"custom_field_type": {
			{Canonical: "text", Values: []string{"text field"}},
			{Canonical: "number", Values: []string{"numeric field"}},
			{Canonical: "date", Values: []string{"date field"}},
		},
		"engagement": {
			{Canonical: "non_openers", Values: []string{"non-openers", "unopened recipients"}},
			{Canonical: "openers", Values: []string{"opened recipients"}},
			{Canonical: "clickers", Values: []string{"clicked recipients"}},
		},
	}
...
func runLearnInitOnce(ctx context.Context) {
	learnInitOnce.Do(func() {
		...
		if err != nil {
			fmt.Fprintf(os.Stderr, "warning: sendfox-pp-cli: learn init: open store: %v\n", err)
			return
		}
		defer s.Close()
		if err := initLearn(ctx, s.DB()); err != nil {
			fmt.Fprintf(os.Stderr, "warning: sendfox-pp-cli: learn init: %v\n", err)
		}
	})
}
...
func learnResourceTypeFields() map[string][]string {
	return map[string][]string{
		"automation_emails":     {"id", "name", "title", "display_name", "full_name", "short_name", "label", "slug", "key", "code", "address"},
		"automations":           {"id", "name", "title", "display_name", "full_name", "short_name", "label", "slug", "key", "code", "address"},
		"campaigns":             {"id", "name", "title", "display_name", "full_name", "short_name", "label", "slug", "key", "code", "address"},
		"contact_fields":        {"id", "name", "title", "display_name", "full_name", "short_name", "label", "slug", "key", "code", "address"},
		"contact_tags":          {"id", "name", "title", "display_name", "full_name", "short_name", "label", "slug", "key", "code", "address"},
		"contacts":              {"id", "name", "title", "display_name", "full_name", "short_name", "label", "slug", "key", "code", "address"},
		"contacts-unsubscribed": {"id", "name", "title", "display_name", "full_name", "short_name", "label", "slug", "key", "code", "address"},
		"domains":               {"id", "name", "title", "display_name", "full_name", "short_name", "label", "slug", "key", "code", "address"},
		"forms":                 {"id", "name", "title", "display_name", "full_name", "short_name", "label", "slug", "key", "code", "address"},
		"lists":                 {"id", "name", "title", "display_name", "full_name", "short_name", "label", "slug", "key", "code", "address"},
		"me":                    {"id", "name", "title", "display_name", "full_name", "short_name", "label", "slug", "key", "code", "address"},
		"unsubscribe":           {"id", "name", "title", "display_name", "full_name", "short_name", "label", "slug", "key", "code", "address"},
	}
}
