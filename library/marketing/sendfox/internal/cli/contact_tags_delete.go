...
func newContactTagsDeleteCmd(flags *rootFlags) *cobra.Command {

	cmd := &cobra.Command{
		Use:         "delete <id>",
		Example:     "  sendfox-pp-cli contact-tags delete 12 --dry-run",
		Short:       "Deletes the tag.",
		Annotations: map[string]string{"pp:happy-args": "id=12", "pp:endpoint": "contact_tags.delete", "pp:method": "DELETE", "pp:path": "/contact-tags/{id}"},
