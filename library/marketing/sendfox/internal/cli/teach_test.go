...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"sendfox-pp-cli auth login",
		"sendfox-pp-cli doctor",
		"sendfox-pp-cli help items",
		"sendfox-pp-cli sync",
		"sendfox-pp-cli profile list",
		"sendfox-pp-cli feedback list",
		"sendfox-pp-cli which",
		"sendfox-pp-cli agent-context",
		"sendfox-pp-cli completion bash",
		"sendfox-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"sendfox-pp-cli recall",
		"sendfox-pp-cli learnings",
		"sendfox-pp-cli teach-pattern",
		"sendfox-pp-cli teach-lookup",
		"sendfox-pp-cli items list",
	}
