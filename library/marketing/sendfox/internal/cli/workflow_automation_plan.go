...
func newNovelWorkflowAutomationPlanCmd(flags *rootFlags) *cobra.Command {
	o := &sendfoxEvidenceOptions{}
	cmd := &cobra.Command{Use: "automation-plan", Short: "Validate a versioned automation definition and produce inactive creation steps.", Example: "  sendfox-pp-cli workflow automation-plan --input examples/snapshot.json --agent"}
