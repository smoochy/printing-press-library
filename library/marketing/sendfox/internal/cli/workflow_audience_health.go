...
func newNovelWorkflowAudienceHealthCmd(flags *rootFlags) *cobra.Command {
	o := &sendfoxEvidenceOptions{}
	cmd := &cobra.Command{Use: "audience-health", Short: "Audit audience structure and evidence-graded engagement recency cohorts.", Example: "  sendfox-pp-cli workflow audience-health --input examples/snapshot.json --agent"}
