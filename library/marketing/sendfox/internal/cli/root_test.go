...
func TestDeclaredAPISurfaceReachable(t *testing.T) {
	expected := []string{
		"automation-emails",
		"automation-emails delete",
		"automation-emails update",
		"automations",
		"automations create",
		"automations create-email",
		"automations delete",
		"automations get",
		"automations list",
		"automations update",
		...
		"contacts create",
		"contacts create-bulk-action",
		"contacts delete",
		"contacts detach-tag",
		"contacts get",
		"contacts get-activity",
		"contacts get-bulk-action",
		"contacts list",
		"contacts list-tags-for",
		"contacts list-unsubscribed",
		"contacts update",
		"domains",
		"domains create",
		"domains delete",
		...
		"forms update",
		"lists",
		"lists add-contact-to",
		"lists contacts-in",
		"lists create",
		"lists delete",
		"lists get",
		"lists list-lists",
		"lists remove-contact-from",
		"lists update",
		"me",
		"unsubscribe",
	}
