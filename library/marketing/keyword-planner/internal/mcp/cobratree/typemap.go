...
func toolOptionForFlag(flag *pflag.Flag) mcplib.ToolOption {
	...
	case "stringSlice", "stringArray":
		// Both pflag collection types are represented as JSON string arrays.
		// StringArray preserves each item verbatim; StringSlice retains its
		// normal comma-splitting behavior when the companion CLI parses the
		// repeated values.
