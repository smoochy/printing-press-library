...
const (
	journalSessionEnvVar   = "KEYWORD_PLANNER_LEARN_SESSION"
	journalNoLearnEnvVar   = "KEYWORD_PLANNER_NO_LEARN"
	journalNoCaptureEnvVar = "KEYWORD_PLANNER_LEARN_NO_CAPTURE"
)
