...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"keyword-planner-pp-cli auth login",
		"keyword-planner-pp-cli doctor",
		"keyword-planner-pp-cli help items",
		"keyword-planner-pp-cli sync",
		"keyword-planner-pp-cli profile list",
		"keyword-planner-pp-cli feedback list",
		"keyword-planner-pp-cli which",
		"keyword-planner-pp-cli agent-context",
		"keyword-planner-pp-cli completion bash",
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"keyword-planner-pp-cli teach",
		"keyword-planner-pp-cli recall",
		"keyword-planner-pp-cli learnings",
		"keyword-planner-pp-cli teach-pattern",
		"keyword-planner-pp-cli teach-lookup",
		"keyword-planner-pp-cli items list",
	}
