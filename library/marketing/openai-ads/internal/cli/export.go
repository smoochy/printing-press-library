...
large datasets as it has no memory pressure.`,
  ...
  openai-ads-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  openai-ads-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  openai-ads-pp-cli export <resource> --format jsonl | jq '.id'`,
