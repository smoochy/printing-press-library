...
but do not stop the import.`,
  ...
  openai-ads-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  openai-ads-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | openai-ads-pp-cli import <resource> --input -`,
