...
var whichIndex = []whichEntry{
	{Command: "pace", Description: "See whether a campaign will underspend or blow through its cap before the period ends.", Group: "Local history the API does not keep", WhyItMatters: "Reach for this instead of raw insights when the question is about trajectory rather than a current number."},
	{Command: "drift", Description: "Show what changed across campaigns, ad groups, and ads between two syncs.", Group: "Local history the API does not keep", WhyItMatters: "Use this to answer 'what changed and when', which no single API call can report."},
	{Command: "fatigue", Description: "Rank ads by click-through decay so tired creative is obvious before spend is wasted.", Group: "Local history the API does not keep", WhyItMatters: "Pick this over ad insights when the question is whether performance is declining, not what it is today."},
	{Command: "review-watch", Description: "Track approval and review status transitions across the account and every ad.", Group: "Local history the API does not keep", WhyItMatters: "Use this to catch a flip to rejected or in_review that a status read would not reveal as a change."},
	{Command: "bid-check", Description: "Flag ad groups whose maximum bid is irrational against the parent campaign budget.", Group: "Cross-entity joins the API cannot do", WhyItMatters: "Catches configurations that permit only a handful of clicks per day before any spend happens."},
	{Command: "orphans", Description: "Find ad groups with no ads, campaigns with no delivery, and audiences nothing references.", Group: "Cross-entity joins the API cannot do", WhyItMatters: "Use this for structural dead weight rather than performance questions."},
	{Command: "tree", Description: "Render the whole campaign, ad group, and ad hierarchy with status, budget, and review state.", Group: "Cross-entity joins the API cannot do", WhyItMatters: "Start here to orient in an unfamiliar account before drilling into any single resource."},
	{Command: "geo resolve", Description: "Turn the bare location IDs in campaign targeting into readable place names.", Group: "Readability", WhyItMatters: "Use this whenever targeting output shows numeric IDs you cannot interpret."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  openai-ads-pp-cli which "stale tickets"
  openai-ads-pp-cli which "bottleneck"
  openai-ads-pp-cli which --limit 1 "send message"
  openai-ads-pp-cli which                                # list the full capability index`,
