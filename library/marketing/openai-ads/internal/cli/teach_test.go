...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"openai-ads-pp-cli auth login",
		"openai-ads-pp-cli doctor",
		"openai-ads-pp-cli help items",
		"openai-ads-pp-cli sync",
		"openai-ads-pp-cli profile list",
		"openai-ads-pp-cli feedback list",
		"openai-ads-pp-cli which",
		"openai-ads-pp-cli agent-context",
		"openai-ads-pp-cli completion bash",
		"openai-ads-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"openai-ads-pp-cli recall",
		"openai-ads-pp-cli learnings",
		"openai-ads-pp-cli teach-pattern",
		"openai-ads-pp-cli teach-lookup",
		"openai-ads-pp-cli items list",
	}
