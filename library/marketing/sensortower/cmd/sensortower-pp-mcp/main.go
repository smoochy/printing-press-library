...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/marketing/sensortower/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("SENSORTOWER_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "sensortower-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
