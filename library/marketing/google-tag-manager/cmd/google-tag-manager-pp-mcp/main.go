...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/marketing/google-tag-manager/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "google-tag-manager-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
