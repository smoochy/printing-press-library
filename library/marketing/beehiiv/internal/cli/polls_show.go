...
func newPollsShowCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "Retrieve detailed information about a specific poll belonging to a publication.",
		Example:     "  beehiiv-pp-cli polls show pub_00000000-0000-0000-0000-000000000000 poll_00000000-0000-0000-0000-000000000000",
