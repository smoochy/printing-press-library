...
func newBulkSubscriptionUpdatesShowCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  beehiiv-pp-cli bulk-subscription-updates show publicationId id",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveReadWithStrategyAndResponsePath(cmd.Context(), c, flags, "live", "bulk-subscription-updates", false, path, params, nil, "", cmd.ErrOrStderr())
			if err != nil {
