...
func TestDeclaredAPISurfaceReachable(t *testing.T) {
	expected := []string{
		...
		"automations",
		"automations emails",
		"automations emails automations-list",
		"automations index",
		"automations journeys",
		"automations journeys automation-create",
		"automations journeys automation-index",
		"automations journeys automation-show",
		"automations show",
		"bulk-subscription-updates",
		"bulk-subscription-updates index",
		"bulk-subscription-updates show",
		"bulk-subscriptions",
		"complimentary-access",
		"complimentary-access index",
		"complimentary-access show",
		"condition-sets",
		"condition-sets index",
		"condition-sets show",
		"custom-fields",
		...
		"custom-fields show",
		"data-privacy",
		"data-privacy data-deletion-create",
		"data-privacy data-deletion-index",
		"data-privacy data-deletion-show",
		"email-blasts",
		"email-blasts index",
		"email-blasts show",
		"engagements",
		"exports",
		"exports subscription-create",
		"exports subscription-index",
		"exports subscription-show",
		"newsletter-lists",
		"newsletter-lists index",
		"newsletter-lists show",
		"newsletter-lists subscriptions",
		"newsletter-lists subscriptions newsletter-list-create",
		"newsletter-lists subscriptions newsletter-list-index",
		"newsletter-lists subscriptions newsletter-list-show",
		"newsletter-lists subscriptions newsletter-list-update",
		"newsletter-lists subscriptions newsletter-list-update-by-id",
		"podcasts",
		"podcasts episodes",
		"podcasts episodes podcast-index",
		"podcasts episodes podcast-show",
		"podcasts index",
		"podcasts private-feeds",
		"podcasts private-feeds podcast-send-email",
		"podcasts private-feeds podcast-send-email-by-email",
		"podcasts private-feeds podcast-show",
		"podcasts private-feeds podcast-show-by-email",
		"podcasts show",
		"polls",
		"polls index",
		"polls responses",
		"polls responses polls-list",
		"polls show",
		"post-templates",
		"posts",
		...
		"segments index",
		"segments members",
		"segments members segments-list",
		"segments recalculate",
		"segments recalculate segments",
		"segments results",
		"segments results segments-expand",
		"segments show",
		"subscriptions",
		"subscriptions bulk-updates-patch",
		"subscriptions bulk-updates-patch-status",
		"subscriptions bulk-updates-put",
		"subscriptions bulk-updates-put-status",
		"subscriptions create",
		"subscriptions delete",
		"subscriptions get-by-email",
		"subscriptions get-by-id",
		"subscriptions get-by-subscriber-id",
		"subscriptions index",
		"subscriptions jwt-token",
		"subscriptions jwt-token subscriptions-get",
		"subscriptions patch",
		"subscriptions put",
		"subscriptions tags",
		"subscriptions tags subscription-create",
		"subscriptions update-by-email",
		"tiers",
		"tiers create",
		"tiers index",
		"tiers patch",
		...
		"workspaces",
		"workspaces identify",
		"workspaces permissions-show",
		"workspaces publications-by-subscription-email",
	}
