...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/marketing/beehiiv/internal/learn/lookups"
...
Resource scoping:
  ...
  beehiiv-pp-cli sync --resources publications
...
func determinePaginationDefaults(resource string) paginationDefaults {
	switch resource {
	case "automations/automations_emails":
	...
	case "automations/automations_journeys":
		return paginationDefaults{
			cursorParam:    "page",
			cursorType:     "page",
			nextCursorPath: "",
	...
	case "newsletter_lists/newsletter_lists_subscriptions":
		return paginationDefaults{
			cursorParam:    "cursor",
			cursorType:     "cursor",
			nextCursorPath: "next_cursor",
	...
	case "podcasts/podcasts_episodes":
		return paginationDefaults{
			cursorParam:    "cursor",
			cursorType:     "cursor",
			nextCursorPath: "next_cursor",
	...
	case "publications/complimentary_access":
		return paginationDefaults{
			cursorParam:    "cursor",
			cursorType:     "cursor",
			nextCursorPath: "next_cursor",
	...
	case "publications/condition_sets":
		return paginationDefaults{
			cursorParam:    "cursor",
			cursorType:     "cursor",
			nextCursorPath: "next_cursor",
	...
	case "publications/email_blasts":
		return paginationDefaults{
			cursorParam:    "page",
			cursorType:     "page",
			nextCursorPath: "",
	...
	case "publications/newsletter_lists":
		return paginationDefaults{
			cursorParam:    "page",
			cursorType:     "page",
			nextCursorPath: "",
	...
	case "publications/post_templates":
		return paginationDefaults{
			cursorParam:    "page",
			cursorType:     "page",
			nextCursorPath: "",
	...
	case "publications/publications_subscriptions":
		return paginationDefaults{
			cursorParam:    "cursor",
			cursorType:     "cursor",
			nextCursorPath: "next_cursor",
	...
	case "publications/referral_program":
		return paginationDefaults{
			cursorParam:    "page",
			cursorType:     "page",
			nextCursorPath: "",
	...
	case "segments/segments_members":
		return paginationDefaults{
			cursorParam:    "page",
			cursorType:     "page",
			nextCursorPath: "",
...
func resourceSupportsPagination(resource string) bool {
	...
	case "automations":
		return true
	case "automations_emails":
		return true
	case "automations_journeys":
		return true
	...
	case "publications":
		return true
	case "publications_subscriptions":
		return true
	case "referral_program":
		return true
	case "segments":
		return true
	case "segments_members":
		return true
	case "tiers":
		return true
	case "webhooks":
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "complimentary-access":
		return db.UpsertComplimentaryAccess(data)
	case "condition-sets":
	...
	case "private_feeds":
		return db.UpsertPrivateFeeds(data)
	case "polls":
	...
	case "test_sends":
		return db.UpsertTestSends(data)
	case "publications":
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "authors", ParentTable: "publications", ParentIDParam: "publicationId", PathTemplate: "/publications/{publicationId}/authors", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.publication", PathParams: []dependentPathParamDef{
			{Param: "publicationId", Field: "id"},
		}},
		{Name: "automations", ParentTable: "publications", ParentIDParam: "publicationId", PathTemplate: "/publications/{publicationId}/automations", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.publication", PathParams: []dependentPathParamDef{
			{Param: "publicationId", Field: "id"},
		}},
		{Name: "complimentary_access", ParentTable: "publications", ParentIDParam: "publicationId", PathTemplate: "/publications/{publicationId}/complimentary_access", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.publication", PathParams: []dependentPathParamDef{
			{Param: "publicationId", Field: "id"},
		}},
		{Name: "condition_sets", ParentTable: "publications", ParentIDParam: "publicationId", PathTemplate: "/publications/{publicationId}/condition_sets", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.publication", PathParams: []dependentPathParamDef{
			{Param: "publicationId", Field: "id"},
		}},
		{Name: "email_blasts", ParentTable: "publications", ParentIDParam: "publicationId", PathTemplate: "/publications/{publicationId}/email_blasts", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.publication", PathParams: []dependentPathParamDef{
			{Param: "publicationId", Field: "id"},
		}},
		{Name: "exports", ParentTable: "publications", ParentIDParam: "publicationId", PathTemplate: "/publications/{publicationId}/exports/subscriptions", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.publication", PathParams: []dependentPathParamDef{
			{Param: "publicationId", Field: "id"},
		}},
		{Name: "newsletter_lists", ParentTable: "publications", ParentIDParam: "publicationId", PathTemplate: "/publications/{publicationId}/newsletter_lists", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.publication", PathParams: []dependentPathParamDef{
			{Param: "publicationId", Field: "id"},
		}},
		{Name: "podcasts", ParentTable: "publications", ParentIDParam: "publicationId", PathTemplate: "/publications/{publicationId}/podcasts", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.publication", PathParams: []dependentPathParamDef{
			{Param: "publicationId", Field: "id"},
		}},
		{Name: "polls", ParentTable: "publications", ParentIDParam: "publicationId", PathTemplate: "/publications/{publicationId}/polls", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.publication", PathParams: []dependentPathParamDef{
			{Param: "publicationId", Field: "id"},
		}},
		{Name: "post_templates", ParentTable: "publications", ParentIDParam: "publicationId", PathTemplate: "/publications/{publicationId}/post_templates", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.publication", PathParams: []dependentPathParamDef{
			{Param: "publicationId", Field: "id"},
		}},
		{Name: "posts", ParentTable: "publications", ParentIDParam: "publicationId", PathTemplate: "/publications/{publicationId}/posts", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.publication", PathParams: []dependentPathParamDef{
			{Param: "publicationId", Field: "id"},
		}},
		{Name: "publications_subscriptions", ParentTable: "publications", ParentIDParam: "publicationId", PathTemplate: "/publications/{publicationId}/subscriptions", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.publication", PathParams: []dependentPathParamDef{
			{Param: "publicationId", Field: "id"},
		}},
		{Name: "referral_program", ParentTable: "publications", ParentIDParam: "publicationId", PathTemplate: "/publications/{publicationId}/referral_program", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.publication", PathParams: []dependentPathParamDef{
			{Param: "publicationId", Field: "id"},
		}},
		{Name: "segments", ParentTable: "publications", ParentIDParam: "publicationId", PathTemplate: "/publications/{publicationId}/segments", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.publication", PathParams: []dependentPathParamDef{
			{Param: "publicationId", Field: "id"},
		}},
		{Name: "tiers", ParentTable: "publications", ParentIDParam: "publicationId", PathTemplate: "/publications/{publicationId}/tiers", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.publication", PathParams: []dependentPathParamDef{
			{Param: "publicationId", Field: "id"},
		}},
		{Name: "webhooks", ParentTable: "publications", ParentIDParam: "publicationId", PathTemplate: "/publications/{publicationId}/webhooks", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.publication", PathParams: []dependentPathParamDef{
			{Param: "publicationId", Field: "id"},
		}},
		{Name: "automations_emails", ParentTable: "automations", ParentIDParam: "automationId", PathTemplate: "/publications/{publicationId}/automations/{automationId}/emails", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "publicationId", Field: "publications_id"},
			{Param: "automationId", Field: "id"},
		}},
		{Name: "automations_journeys", ParentTable: "automations", ParentIDParam: "automationId", PathTemplate: "/publications/{publicationId}/automations/{automationId}/journeys", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "publicationId", Field: "publications_id"},
			{Param: "automationId", Field: "id"},
		}},
		{Name: "newsletter_lists_subscriptions", ParentTable: "newsletter_lists", ParentIDParam: "newsletterListId", PathTemplate: "/publications/{publicationId}/newsletter_lists/{newsletterListId}/subscriptions", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "publicationId", Field: "publications_id"},
			{Param: "newsletterListId", Field: "id"},
		}},
		{Name: "podcasts_episodes", ParentTable: "podcasts", ParentIDParam: "podcastShowId", PathTemplate: "/publications/{publicationId}/podcasts/{podcastShowId}/episodes", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "publicationId", Field: "publications_id"},
			{Param: "podcastShowId", Field: "id"},
		}},
		{Name: "polls_responses", ParentTable: "polls", ParentIDParam: "pollId", PathTemplate: "/publications/{publicationId}/polls/{pollId}/responses", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "publicationId", Field: "publications_id"},
			{Param: "pollId", Field: "id"},
		}},
		{Name: "segments_members", ParentTable: "segments", ParentIDParam: "segmentId", PathTemplate: "/publications/{publicationId}/segments/{segmentId}/members", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "publicationId", Field: "publications_id"},
			{Param: "segmentId", Field: "id"},
		}},
	}
}
...
var reconcileTypedTables = map[string]string{
	"advertisement-opportunities":    "advertisement_opportunities",
	"authors":                        "authors",
	"automations":                    "automations",
	"bulk-subscription-updates":      "bulk_subscription_updates",
	"bulk-subscriptions":             "bulk_subscriptions",
	"complimentary-access":           "complimentary_access",
	"condition-sets":                 "condition_sets",
	"custom-fields":                  "custom_fields",
	"data-privacy":                   "data_privacy",
	"email-blasts":                   "email_blasts",
	"emails":                         "emails",
	...
	"jwt_token":                      "jwt_token",
	"members":                        "members",
	"newsletter-lists":               "newsletter_lists",
	"newsletter_lists_subscriptions": "newsletter_lists_subscriptions",
	"podcasts":                       "podcasts",
	"polls":                          "polls",
...
func responsePathForResource(resource, path string) []string {
	...
	case "advertisement-opportunities\x00/publications/{publicationId}/advertisement_opportunities":
		return []string{"data"}
	case "authors\x00/publications/{publicationId}/authors":
		return []string{"data"}
	case "automations\x00/publications/{publicationId}/automations":
		return []string{"data"}
	case "bulk-subscription-updates\x00/publications/{publicationId}/bulk_subscription_updates":
		return []string{"data"}
	case "complimentary-access\x00/publications/{publicationId}/complimentary_access":
		return []string{"data"}
	case "condition-sets\x00/publications/{publicationId}/condition_sets":
		return []string{"data"}
	case "custom-fields\x00/publications/{publicationId}/custom_fields":
		return []string{"data"}
	case "data-privacy\x00/publications/{publicationId}/data_privacy/deletion_requests":
		return []string{"data"}
	case "email-blasts\x00/publications/{publicationId}/email_blasts":
		return []string{"data"}
	case "engagements\x00/publications/{publicationId}/engagements":
		return []string{"data"}
	case "exports\x00/publications/{publicationId}/exports/subscriptions":
		return []string{"data"}
	case "newsletter-lists\x00/publications/{publicationId}/newsletter_lists":
		return []string{"data"}
	case "podcasts\x00/publications/{publicationId}/podcasts":
		return []string{"data"}
	case "polls\x00/publications/{publicationId}/polls":
		return []string{"data"}
	case "post-templates\x00/publications/{publicationId}/post_templates":
		return []string{"data"}
	case "posts\x00/publications/{publicationId}/posts":
		return []string{"data"}
	case "publications\x00/publications":
		return []string{"data"}
	case "referral-program\x00/publications/{publicationId}/referral_program":
		return []string{"data"}
	case "segments\x00/publications/{publicationId}/segments":
		return []string{"data"}
	case "subscriptions\x00/publications/{publicationId}/subscriptions":
		return []string{"data"}
	case "tiers\x00/publications/{publicationId}/tiers":
		return []string{"data"}
	case "webhooks\x00/publications/{publicationId}/webhooks":
		return []string{"data"}
	}
	return nil
}
