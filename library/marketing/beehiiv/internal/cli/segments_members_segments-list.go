...
func newSegmentsMembersSegmentsListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Aliases:     []string{"get"},
		Short:       "List all members in a segment with full subscription data.",
		Example:     "  beehiiv-pp-cli segments members segments-list pub_00000000-0000-0000-0000-000000000000 seg_00000000-0000-0000-0000-000000000000",
	...
	cmd.Flags().StringVar(&flagExpand, "expand", "", "Optionally expand the response to include additional data. `stats` - Returns statistics about the subscription(s).")
