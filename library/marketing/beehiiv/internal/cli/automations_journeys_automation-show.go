...
func newAutomationsJourneysAutomationShowCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  beehiiv-pp-cli automations journeys automation-show pub_00000000-0000-0000-0000-000000000000 aut_00000000-0000-0000-0000-000000000000 aj_00000000-0000-0000-0000-000000000000",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			if len(args) == 0 {
				...
				if flags.asJSON {
					if printErr := printJSONFiltered(cmd.OutOrStdout(), map[string]any{
						...
						"usage": fmt.Sprintf("%s%s", cmd.CommandPath(), " <publicationId> <automationId> <automationJourneyId>"),
					}, flags); printErr != nil {
						return printErr
					}
				}
				return usageErr(fmt.Errorf("missing required argument\nUsage: %s%s", cmd.CommandPath(), " <publicationId> <automationId> <automationJourneyId>"))
			}
			...
			data, prov, err := resolveReadWithStrategyAndResponsePath(cmd.Context(), c, flags, "live", "journeys", false, path, params, nil, "", cmd.ErrOrStderr())
			if err != nil {
