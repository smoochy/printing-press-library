...
func newSegmentsResultsSegmentsExpandCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Aliases:     []string{"get"},
		Short:       "List subscriber IDs for a segment.",
		Example:     "  beehiiv-pp-cli segments results segments-expand pub_00000000-0000-0000-0000-000000000000 seg_00000000-0000-0000-0000-000000000000",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolvePaginatedReadWithStrategy(cmd.Context(), c, flags, "live", "results", path, map[string]string{
