...
func newSegmentsShowCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  beehiiv-pp-cli segments show pub_00000000-0000-0000-0000-000000000000 seg_00000000-0000-0000-0000-000000000000",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveReadWithStrategyAndResponsePath(cmd.Context(), c, flags, "live", "segments", false, path, params, nil, "", cmd.ErrOrStderr())
			if err != nil {
