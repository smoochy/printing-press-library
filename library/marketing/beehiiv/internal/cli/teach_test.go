...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/marketing/beehiiv/internal/cliutil/testenv"
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"beehiiv-pp-cli auth login",
		"beehiiv-pp-cli doctor",
		"beehiiv-pp-cli help items",
		"beehiiv-pp-cli sync",
		"beehiiv-pp-cli profile list",
		"beehiiv-pp-cli feedback list",
		"beehiiv-pp-cli which",
		"beehiiv-pp-cli agent-context",
		"beehiiv-pp-cli completion bash",
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"beehiiv-pp-cli recall",
		"beehiiv-pp-cli learnings",
		"beehiiv-pp-cli teach-pattern",
		"beehiiv-pp-cli teach-lookup",
		"beehiiv-pp-cli items list",
	}
