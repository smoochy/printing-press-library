...
func newSubscriptionsGetByEmailCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Aliases:     []string{"get"},
		Short:       "<Info>Please note that this endpoint requires the email to be URL encoded.",
		Example:     "  beehiiv-pp-cli subscriptions get-by-email pub_00000000-0000-0000-0000-000000000000 user@example.com",
