...
import (
	...
	"errors"
	"fmt"
	"github.com/mvanhorn/printing-press-library/library/cloud/clickhouse-cloud/internal/client"
...
func classifyAPIError(err error, flags *rootFlags) error {
	...
	case strings.Contains(msg, "HTTP 400") && cliutil.LooksLikeAuthError(msg):
		return authErr(fmt.Errorf("%w\nhint: the API rejected the request — this usually means auth is missing or invalid."+
			"\n      Set Basic credentials with: export CLICKHOUSE_CLOUD_USERNAME=\"your-username\" CLICKHOUSE_CLOUD_PASSWORD=\"your-password\""+
			"\n      Get a key at: https://clickhouse.com/docs/cloud/manage/openapi"+
			"\n      Run 'clickhouse-cloud-pp-cli doctor' to check auth status."+
			"\n      Response: "+cliutil.SanitizeErrorBody(msg), err))
	case strings.Contains(msg, "HTTP 401"):
		return authErr(fmt.Errorf("%w\nhint: check your Basic credentials."+
			" Set Basic credentials with: export CLICKHOUSE_CLOUD_USERNAME=\"your-username\" CLICKHOUSE_CLOUD_PASSWORD=\"your-password\""+
			"\n      Get a key at: https://clickhouse.com/docs/cloud/manage/openapi"+
			"\n      Run 'clickhouse-cloud-pp-cli doctor' to check auth status.", err))
...
// - Shell-based agent hosts: stdout piped to JSON
