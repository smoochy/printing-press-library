...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/ai/rundown/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "rundown-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
