...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/ai/pinecone/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("PINECONE_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "pinecone-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
