...
but do not stop the import.`,
  ...
  keenable-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  keenable-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | keenable-pp-cli import <resource> --input -`,
