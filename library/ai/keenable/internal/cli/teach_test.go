...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/ai/keenable/internal/cliutil/testenv"
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"keenable-pp-cli auth login",
		"keenable-pp-cli doctor",
		"keenable-pp-cli help items",
		"keenable-pp-cli sync",
		"keenable-pp-cli profile list",
		"keenable-pp-cli feedback list",
		"keenable-pp-cli which",
		"keenable-pp-cli agent-context",
		"keenable-pp-cli completion bash",
		"keenable-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"keenable-pp-cli recall",
		"keenable-pp-cli learnings",
		"keenable-pp-cli teach-pattern",
		"keenable-pp-cli teach-lookup",
		"keenable-pp-cli items list",
	}
