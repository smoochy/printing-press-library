...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"groq-pp-cli auth login",
		"groq-pp-cli doctor",
		"groq-pp-cli help items",
		"groq-pp-cli sync",
		"groq-pp-cli profile list",
		"groq-pp-cli feedback list",
		"groq-pp-cli which",
		"groq-pp-cli agent-context",
		"groq-pp-cli completion bash",
		"groq-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"groq-pp-cli teach",
		"groq-pp-cli recall",
		"groq-pp-cli learnings",
		"groq-pp-cli teach-pattern",
		"groq-pp-cli teach-lookup",
		"groq-pp-cli items list",
	}
