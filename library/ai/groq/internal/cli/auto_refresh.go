...
var readCommandResources = map[string][]string{
	"groq-pp-cli batches":             {"batches"},
	"groq-pp-cli batches list":        {"batches"},
	"groq-pp-cli batches get":         {"batches"},
	"groq-pp-cli batches search":      {"batches"},
	"groq-pp-cli files":               {"files"},
	"groq-pp-cli files list":          {"files"},
	"groq-pp-cli files get":           {"files"},
	"groq-pp-cli files search":        {"files"},
	"groq-pp-cli fine_tunings":        {"fine_tunings"},
	"groq-pp-cli fine_tunings list":   {"fine_tunings"},
	"groq-pp-cli fine_tunings get":    {"fine_tunings"},
	"groq-pp-cli fine_tunings search": {"fine_tunings"},
	"groq-pp-cli models":              {"models"},
	"groq-pp-cli models list":         {"models"},
	"groq-pp-cli models get":          {"models"},
	"groq-pp-cli models search":       {"models"},
}
...
func cachePolicy() cliutil.Policy {
	...
	envOptOut := "GROQ_NO_AUTO_REFRESH"
...
func autoRefreshIfStale(ctx context.Context, flags *rootFlags, resources []string) (meta cliutil.FreshnessMeta) {
	...
	if err := runAutoRefresh(refreshCtx, flags, db, resources); err != nil {
		fmt.Fprintf(os.Stderr, "warning: using stale groq-pp-cli cache (refresh failed: %v)\n", err)
