...
large datasets as it has no memory pressure.`,
  ...
  groq-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  groq-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  groq-pp-cli export <resource> --format jsonl | jq '.id'`,
