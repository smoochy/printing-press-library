...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/ai/openrouter-image/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "openrouter-image-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
