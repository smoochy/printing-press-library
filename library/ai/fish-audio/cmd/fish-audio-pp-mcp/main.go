...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/ai/fish-audio/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "fish-audio-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
