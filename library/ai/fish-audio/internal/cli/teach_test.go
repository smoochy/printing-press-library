...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/ai/fish-audio/internal/cliutil/testenv"
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"fish-audio-pp-cli auth login",
		"fish-audio-pp-cli doctor",
		"fish-audio-pp-cli help items",
		"fish-audio-pp-cli sync",
		"fish-audio-pp-cli profile list",
		"fish-audio-pp-cli feedback list",
		"fish-audio-pp-cli which",
		"fish-audio-pp-cli agent-context",
		"fish-audio-pp-cli completion bash",
		"fish-audio-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"fish-audio-pp-cli recall",
		"fish-audio-pp-cli learnings",
		"fish-audio-pp-cli teach-pattern",
		"fish-audio-pp-cli teach-lookup",
		"fish-audio-pp-cli items list",
	}
