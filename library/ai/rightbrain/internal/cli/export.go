...
large datasets as it has no memory pressure.`,
  ...
  rightbrain-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  rightbrain-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  rightbrain-pp-cli export <resource> --format jsonl | jq '.id'`,
