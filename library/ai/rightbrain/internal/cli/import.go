...
but do not stop the import.`,
  ...
  rightbrain-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  rightbrain-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | rightbrain-pp-cli import <resource> --input -`,
