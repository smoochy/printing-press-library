...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/ai/rightbrain/internal/learn/lookups"
...
Resource scoping:
  ...
  rightbrain-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  rightbrain-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  rightbrain-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  rightbrain-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  rightbrain-pp-cli sync --latest-only`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			// Progress events stream to stderr so stdout carries exactly one JSON
			// document — the terminal sync_summary. Emitting the whole event
			// stream to stdout makes `sync --json` newline-delimited JSON: an
			// unfiltered sync produces ~25 documents where the framework's own
			// json_fidelity contract requires one, so the command fails the
			// generator's own check. Nothing is lost — the event stream is still
			// machine-readable, just on the stream that carries progress rather
			// than the one carrying results.
			syncProgressWriter := syncEventWriter
			if !humanFriendly {
				syncProgressWriter = cmd.ErrOrStderr()
			}
			...
			for i := 0; i < concurrency; i++ {
				...
				go func() {
					...
					for resource := range work {
						res := syncResource(cmd.Context(), c, db, resource, sinceTS, full, maxPages, effectiveLatestOnly, prune, userParams, syncProgressWriter)
						results <- res
					}
				}()
			}
			...
			depResults := syncDependentResources(cmd.Context(), c, db, sinceTS, full, maxPages, effectiveLatestOnly, prune, parentFilter, userParams, syncProgressWriter, concurrency)
			...
			if totalSynced > 0 && !c.DryRun && !noLearnActive(flags) && !cliutil.IsVerifyEnv() && !cliutil.IsDogfoodEnv() {
				refreshLookupsFromSyncedStore(cmd.Context(), db.DB(), syncProgressWriter)
			}
			...
			if errCount > 0 && !strict && criticalErrCount == 0 && successCount > 0 {
				if !humanFriendly {
					...
					fmt.Fprintf(syncProgressWriter, `{"event":"sync_warning","reason":"exit_policy_default_changed","errored":%d,"message":"%s"}`+"\n",
...
func determinePaginationDefaults(resource string) paginationDefaults {
	...
	case "project/project_audit_event":
		return paginationDefaults{
			cursorParam: "cursor",
			cursorType:  "cursor",
			limitParam:  "limit",
	...
	case "project/project_collection":
		return paginationDefaults{
			cursorParam: "cursor",
			cursorType:  "cursor",
			limitParam:  "limit",
	...
	case "project/project_mcp_server":
		return paginationDefaults{
			cursorParam: "cursor",
			cursorType:  "cursor",
			limitParam:  "limit",
	...
	case "project/project_oauth_client":
		return paginationDefaults{
			cursorParam: "cursor",
			cursorType:  "cursor",
			limitParam:  "limit",
	...
	case "project/project_reporting_groups":
		return paginationDefaults{
			cursorParam: "cursor",
			cursorType:  "cursor",
			limitParam:  "limit",
	...
	case "project/project_task_agent":
		return paginationDefaults{
			cursorParam: "cursor",
			cursorType:  "cursor",
			limitParam:  "limit",
	...
	case "project/project_task_agent_share":
		return paginationDefaults{
			cursorParam: "cursor",
			cursorType:  "cursor",
			limitParam:  "limit",
	...
	case "project/project_task_forwarder":
		return paginationDefaults{
			cursorParam: "cursor",
			cursorType:  "cursor",
			limitParam:  "limit",
	...
	case "project/project_task_mcp_server":
		return paginationDefaults{
			cursorParam: "cursor",
			cursorType:  "cursor",
			limitParam:  "limit",
	...
	case "project/project_task_mcp_tool":
		return paginationDefaults{
			cursorParam: "cursor",
			cursorType:  "cursor",
			limitParam:  "limit",
	...
	case "project/project_task_share":
		return paginationDefaults{
			cursorParam: "cursor",
			cursorType:  "cursor",
			limitParam:  "limit",
	...
	case "project_document/project_document_embeddings":
		return paginationDefaults{
			cursorParam: "cursor",
			cursorType:  "cursor",
			limitParam:  "limit",
	...
	case "project_mcp_server/project_mcp_server_mcp_run":
		return paginationDefaults{
			cursorParam: "cursor",
			cursorType:  "cursor",
			limitParam:  "limit",
	...
	case "project_task/project_task_eval":
		return paginationDefaults{
			cursorParam: "cursor",
			cursorType:  "cursor",
			limitParam:  "limit",
	...
	case "project_task_agent/project_task_agent_approval_request":
		return paginationDefaults{
			cursorParam: "cursor",
			cursorType:  "cursor",
			limitParam:  "limit",
	...
	case "project_task_agent/project_task_agent_eval":
		return paginationDefaults{
			cursorParam: "cursor",
			cursorType:  "cursor",
			limitParam:  "limit",
	...
	case "project_task_agent/project_task_agent_run":
		return paginationDefaults{
			cursorParam: "cursor",
			cursorType:  "cursor",
			limitParam:  "limit",
...
func resourceSupportsPagination(resource string) bool {
	...
	case "project":
		return true
	case "project_audit_event":
		return true
	case "project_collection":
		return true
	case "project_document":
		return true
	case "project_document_embeddings":
		return true
	case "project_mcp_server":
		return true
	case "project_mcp_server_mcp_run":
		return true
	case "project_oauth_client":
		return true
	case "project_reporting_groups":
		return true
	case "project_scrape":
		return true
	case "project_skill":
	...
	case "project_task":
		return true
	case "project_task_agent":
		return true
	case "project_task_agent_approval_request":
		return true
	case "project_task_agent_eval":
		return true
	case "project_task_agent_run":
		return true
	case "project_task_agent_share":
		return true
	case "project_task_eval":
		return true
	case "project_task_forwarder":
		return true
	case "project_task_mcp_server":
		return true
	case "project_task_mcp_tool":
		return true
	case "project_task_run":
		return true
	case "project_task_share":
		return true
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	switch resource {
	case "agent_shares":
		return db.UpsertAgentShares(data)
	case "avatar":
	...
	case "audit_event":
		return db.UpsertAuditEvent(data)
	case "project_avatar":
		return db.UpsertProjectAvatar(data)
	case "collection":
		return db.UpsertCollection(data)
	case "compose":
		return db.UpsertCompose(data)
	case "config":
		return db.UpsertConfig(data)
	case "document":
		return db.UpsertDocument(data)
	case "guardrail":
		return db.UpsertGuardrail(data)
	case "project_iam":
		return db.UpsertProjectIam(data)
	case "input_processor":
		return db.UpsertInputProcessor(data)
	case "project_integration":
		return db.UpsertProjectIntegration(data)
	case "mcp_server":
		return db.UpsertMcpServer(data)
	case "project_model":
		return db.UpsertProjectModel(data)
	case "oauth_client":
		return db.UpsertOauthClient(data)
	case "reporting_groups":
		return db.UpsertReportingGroups(data)
	case "scrape":
		return db.UpsertScrape(data)
	case "skill":
		return db.UpsertSkill(data)
	case "slack":
		return db.UpsertSlack(data)
	case "tag":
	...
	case "task_agent":
		return db.UpsertTaskAgent(data)
	case "task_forwarder":
		return db.UpsertTaskForwarder(data)
	case "task_forwarder_type":
		return db.UpsertTaskForwarderType(data)
	case "project_task_mcp_server":
		return db.UpsertProjectTaskMcpServer(data)
	case "task_mcp_tool":
		return db.UpsertTaskMcpTool(data)
	case "trigger":
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{ // #nosec G101 -- endpoint paths, not credentials.
		...
		"task-mcp-server": "/task_mcp_server/callback",
		"whoami":          "/whoami",
	}
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "invite", ParentTable: "org", ParentIDParam: "org_id", PathTemplate: "/org/{org_id}/invite", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.org", PathParams: []dependentPathParamDef{
			{Param: "org_id", Field: "id"},
		}},
		{Name: "project", ParentTable: "org", ParentIDParam: "org_id", PathTemplate: "/org/{org_id}/project", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.org", PathParams: []dependentPathParamDef{
			{Param: "org_id", Field: "id"},
		}},
		{Name: "project_audit_event", ParentTable: "project", ParentIDParam: "project_id", PathTemplate: "/org/{org_id}/project/{project_id}/audit_event", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "org_id", Field: "org_id"},
			{Param: "project_id", Field: "id"},
		}},
		{Name: "project_collection", ParentTable: "project", ParentIDParam: "project_id", PathTemplate: "/org/{org_id}/project/{project_id}/collection", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "org_id", Field: "org_id"},
			{Param: "project_id", Field: "id"},
		}},
		{Name: "project_document", ParentTable: "project", ParentIDParam: "project_id", PathTemplate: "/org/{org_id}/project/{project_id}/document", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "org_id", Field: "org_id"},
			{Param: "project_id", Field: "id"},
		}},
		{Name: "project_mcp_server", ParentTable: "project", ParentIDParam: "project_id", PathTemplate: "/org/{org_id}/project/{project_id}/mcp_server", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "org_id", Field: "org_id"},
			{Param: "project_id", Field: "id"},
		}},
		{Name: "project_oauth_client", ParentTable: "project", ParentIDParam: "project_id", PathTemplate: "/org/{org_id}/project/{project_id}/oauth_client", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "org_id", Field: "org_id"},
			{Param: "project_id", Field: "id"},
		}},
		{Name: "project_reporting_groups", ParentTable: "project", ParentIDParam: "project_id", PathTemplate: "/org/{org_id}/project/{project_id}/reporting-groups", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "org_id", Field: "org_id"},
			{Param: "project_id", Field: "id"},
		}},
		{Name: "project_scrape", ParentTable: "project", ParentIDParam: "project_id", PathTemplate: "/org/{org_id}/project/{project_id}/scrape/runs", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "org_id", Field: "org_id"},
			{Param: "project_id", Field: "id"},
		}},
		{Name: "project_skill", ParentTable: "project", ParentIDParam: "project_id", PathTemplate: "/org/{org_id}/project/{project_id}/skill", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "org_id", Field: "org_id"},
			{Param: "project_id", Field: "id"},
		}},
		{Name: "project_skill", ParentTable: "project", ParentIDParam: "project_id", PathTemplate: "/org/{org_id}/project/{project_id}/skill/available", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "org_id", Field: "org_id"},
			{Param: "project_id", Field: "id"},
		}},
		{Name: "project_tag", ParentTable: "project", ParentIDParam: "org_id", PathTemplate: "/org/{org_id}/project/{project_id}/{entity_type}/tag", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "org_id", Field: "org_id"},
			{Param: "project_id", Field: "project_id"},
			{Param: "entity_type", Field: "entity_type"},
		}},
		{Name: "project_task", ParentTable: "project", ParentIDParam: "project_id", PathTemplate: "/org/{org_id}/project/{project_id}/task", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "org_id", Field: "org_id"},
			{Param: "project_id", Field: "id"},
		}},
		{Name: "project_task_agent", ParentTable: "project", ParentIDParam: "project_id", PathTemplate: "/org/{org_id}/project/{project_id}/task-agent/approval-request", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "org_id", Field: "org_id"},
			{Param: "project_id", Field: "id"},
		}},
		{Name: "project_task_agent", ParentTable: "project", ParentIDParam: "project_id", PathTemplate: "/org/{org_id}/project/{project_id}/task-agent", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "org_id", Field: "org_id"},
			{Param: "project_id", Field: "id"},
		}},
		{Name: "project_task_agent_share", ParentTable: "project", ParentIDParam: "project_id", PathTemplate: "/org/{org_id}/project/{project_id}/task_agent_share", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "org_id", Field: "org_id"},
			{Param: "project_id", Field: "id"},
		}},
		{Name: "project_task_forwarder", ParentTable: "project", ParentIDParam: "project_id", PathTemplate: "/org/{org_id}/project/{project_id}/task_forwarder", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "org_id", Field: "org_id"},
			{Param: "project_id", Field: "id"},
		}},
		{Name: "project_task_mcp_server", ParentTable: "project", ParentIDParam: "project_id", PathTemplate: "/org/{org_id}/project/{project_id}/task_mcp_server", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "org_id", Field: "org_id"},
			{Param: "project_id", Field: "id"},
		}},
		{Name: "project_task_mcp_tool", ParentTable: "project", ParentIDParam: "project_id", PathTemplate: "/org/{org_id}/project/{project_id}/task_mcp_tool", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "org_id", Field: "org_id"},
			{Param: "project_id", Field: "id"},
		}},
		{Name: "project_task_run", ParentTable: "project", ParentIDParam: "project_id", PathTemplate: "/org/{org_id}/project/{project_id}/task_run", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "org_id", Field: "org_id"},
			{Param: "project_id", Field: "id"},
		}},
		{Name: "project_task_share", ParentTable: "project", ParentIDParam: "project_id", PathTemplate: "/org/{org_id}/project/{project_id}/task_share", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "org_id", Field: "org_id"},
			{Param: "project_id", Field: "id"},
		}},
		{Name: "project_trigger", ParentTable: "project", ParentIDParam: "project_id", PathTemplate: "/org/{org_id}/project/{project_id}/trigger", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "org_id", Field: "org_id"},
			{Param: "project_id", Field: "id"},
		}},
		{Name: "project_document_embeddings", ParentTable: "project_document", ParentIDParam: "document_id", PathTemplate: "/org/{org_id}/project/{project_id}/document/{document_id}/embeddings", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "org_id", Field: "org_id"},
			{Param: "project_id", Field: "project_id"},
			{Param: "document_id", Field: "id"},
		}},
		{Name: "project_mcp_server_mcp_run", ParentTable: "project_mcp_server", ParentIDParam: "mcp_server_id", PathTemplate: "/org/{org_id}/project/{project_id}/mcp_server/{mcp_server_id}/mcp_run", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "org_id", Field: "org_id"},
			{Param: "project_id", Field: "project_id"},
			{Param: "mcp_server_id", Field: "id"},
		}},
		{Name: "project_task_agent_approval_request", ParentTable: "project_task_agent", ParentIDParam: "task_agent_id", PathTemplate: "/org/{org_id}/project/{project_id}/task-agent/{task_agent_id}/approval-request", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "org_id", Field: "org_id"},
			{Param: "project_id", Field: "project_id"},
			{Param: "task_agent_id", Field: "id"},
		}},
		{Name: "project_task_agent_eval", ParentTable: "project_task_agent", ParentIDParam: "task_agent_id", PathTemplate: "/org/{org_id}/project/{project_id}/task-agent/{task_agent_id}/eval/set", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "org_id", Field: "org_id"},
			{Param: "project_id", Field: "project_id"},
			{Param: "task_agent_id", Field: "id"},
		}},
		{Name: "project_task_agent_eval", ParentTable: "project_task_agent", ParentIDParam: "task_agent_id", PathTemplate: "/org/{org_id}/project/{project_id}/task-agent/{task_agent_id}/eval/run", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "org_id", Field: "org_id"},
			{Param: "project_id", Field: "project_id"},
			{Param: "task_agent_id", Field: "id"},
		}},
		{Name: "project_task_agent_run", ParentTable: "project_task_agent", ParentIDParam: "task_agent_id", PathTemplate: "/org/{org_id}/project/{project_id}/task-agent/{task_agent_id}/run", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "org_id", Field: "org_id"},
			{Param: "project_id", Field: "project_id"},
			{Param: "task_agent_id", Field: "id"},
		}},
		{Name: "project_task_eval", ParentTable: "project_task", ParentIDParam: "task_id", PathTemplate: "/org/{org_id}/project/{project_id}/task/{task_id}/eval/set", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "org_id", Field: "org_id"},
			{Param: "project_id", Field: "project_id"},
			{Param: "task_id", Field: "id"},
		}},
		{Name: "project_task_eval", ParentTable: "project_task", ParentIDParam: "task_id", PathTemplate: "/org/{org_id}/project/{project_id}/task/{task_id}/eval/run", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "org_id", Field: "org_id"},
			{Param: "project_id", Field: "project_id"},
			{Param: "task_id", Field: "id"},
		}},
...
var reconcileTypedTables = map[string]string{
	...
	"project_task_mcp_server": "project_task_mcp_server",
	"public":                  "public",
	...
	"task_forwarder":          "task_forwarder",
	"task_forwarder_type":     "task_forwarder_type",
	"task_mcp_tool":           "task_mcp_tool",
	"trigger":                 "trigger",
	"user":                    "user",
}
...
func responsePathForResource(resource, path string) []string {
	...
	case "agent_shares\x00/org/{org_id}/project/{project_id}/task_agent_share":
		return []string{"results"}
	case "domains\x00/org/{org_id}/domains":
		return []string{"results"}
	case "iam\x00/org/{org_id}/iam/members/{member}":
		return []string{"roles"}
	case "iam\x00/org/{org_id}/iam/members":
		return []string{"results"}
	case "iam\x00/org/{org_id}/iam/test":
		return []string{"permissions"}
	case "invite\x00/org/{org_id}/invite":
		return []string{"roles"}
	case "join\x00/org/{org_id}/join":
		return []string{"roles"}
	case "org\x00/org":
		return []string{"results"}
	case "project\x00/org/{org_id}/project/{project_id}":
		return []string{"datasource_connections"}
	case "project\x00/org/{org_id}/project":
		return []string{"results"}
	case "runs\x00/org/{org_id}/project/{project_id}/task_run":
		return []string{"results"}
	case "shares\x00/org/{org_id}/project/{project_id}/task_share":
		return []string{"results"}
	case "skills\x00/skills/{skill_id}":
		return []string{"tags"}
	case "skills\x00/skills":
		return []string{"results"}
	case "skills\x00/skills/tags":
		return []string{"results"}
	}
	return nil
}
