...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("RIGHTBRAIN_STATE_DIR", "")
	t.Setenv("RIGHTBRAIN_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"rightbrain-pp-cli auth login",
		"rightbrain-pp-cli doctor",
		"rightbrain-pp-cli help items",
		"rightbrain-pp-cli sync",
		"rightbrain-pp-cli profile list",
		"rightbrain-pp-cli feedback list",
		"rightbrain-pp-cli which",
		"rightbrain-pp-cli agent-context",
		"rightbrain-pp-cli completion bash",
		"rightbrain-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"rightbrain-pp-cli recall",
		"rightbrain-pp-cli learnings",
		"rightbrain-pp-cli teach-pattern",
		"rightbrain-pp-cli teach-lookup",
		"rightbrain-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("rightbrain-pp-cli")); err == nil {
