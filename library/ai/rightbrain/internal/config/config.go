...
func Load(configPath string) (*Config, error) {
	...
	// Env var overrides
	if v := os.Getenv("RB_API_KEY"); v != "" {
		cfg.RbApiKey = v
		cfg.markEnvOverride("RbApiKey")
		cfg.AuthSource = "env:RB_API_KEY"
		cfg.CredentialSource = "env:RB_API_KEY"
	}
	...
	if v := os.Getenv("RIGHTBRAIN_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("RIGHTBRAIN_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "rightbrain-pp-cli", "config.toml"), nil
}
...
func (c *Config) AuthHeader() string {
	...
	if c.RbApiKey != "" {
		if c.AuthSource == "" {
			c.AuthSource = "env:RB_API_KEY"
		}
		return "Bearer " + c.RbApiKey
	}
	if c.AccessToken != "" {
...
func (c *Config) ClearTokens() error {
	...
	c.updateFileConfigField("ClientSecret")
	c.RbApiKey = ""
	delete(c.envOverrides, "RbApiKey")
	c.updateFileConfigField("RbApiKey")
	if c.AgentcookieManagedByExternalStore() {
		c.markAgentcookieManaged()
...
func (c *Config) configForSave() Config {
	out := *c
	if c.fileConfig != nil {
		if c.envOverrides["RbApiKey"] {
			out.RbApiKey = c.fileConfig.RbApiKey
		}
	}
...
func (c *Config) updateFileConfigField(field string) {
	...
	case "RbApiKey":
		c.fileConfig.RbApiKey = c.RbApiKey
	}
}
