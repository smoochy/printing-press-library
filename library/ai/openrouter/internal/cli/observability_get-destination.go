...
func newObservabilityGetDestinationCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Aliases:     []string{"get"},
		Short:       "Fetch a single observability destination by its UUID.",
		Example:     "  openrouter-pp-cli observability get-destination 99999999-aaaa-bbbb-cccc-dddddddddddd",
		Annotations: map[string]string{"pp:endpoint": "observability.get-destination", "pp:method": "GET", "pp:path": "/observability/destinations/{id}", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveReadWithStrategyAndResponsePath(cmd.Context(), c, flags, "auto", "observability", false, path, params, headerOverrides, "", cmd.ErrOrStderr())
			if err != nil {
