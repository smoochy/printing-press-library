	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if flagOutputModalities != "" {
				params["output_modalities"] = formatCLIParamValue(flagOutputModalities)
			}
			data, prov, err := resolveReadWithStrategyAndResponsePath(cmd.Context(), c, flags, "auto", "models", false, path, params, headerOverrides, "", cmd.ErrOrStderr())
			if err != nil {
