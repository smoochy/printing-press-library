...
func newObservabilityDeleteDestinationCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "Delete an existing observability destination. This performs a soft delete.",
		Example:     "  openrouter-pp-cli observability delete-destination 99999999-aaaa-bbbb-cccc-dddddddddddd",
		Annotations: map[string]string{"pp:endpoint": "observability.delete-destination", "pp:method": "DELETE", "pp:path": "/observability/destinations/{id}"},
