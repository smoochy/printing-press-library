...
func newContainersFilesPromoteContainerCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "promote-container <container_id> <file_id>",
		Aliases:     []string{"create"},
		Short:       "Copies a file from the container's sandbox prefix into the workspace's durable document storage",
		Example:     "  openrouter-pp-cli containers files promote-container sess_abc123 cfile_b3V0L3JlcG9ydC5jc3Y",
		Annotations: map[string]string{"pp:endpoint": "files.promote-container", "pp:method": "POST", "pp:path": "/containers/{container_id}/files/{file_id}/promote"},
