...
func newPresetsGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get <slug>",
		Short:       "Retrieves a preset by its slug with its currently designated version inline.",
		Example:     "  openrouter-pp-cli presets get my-preset",
		Annotations: map[string]string{"pp:endpoint": "presets.get", "pp:method": "GET", "pp:path": "/presets/{slug}", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveReadWithStrategyAndResponsePath(cmd.Context(), c, flags, "auto", "presets", false, path, params, headerOverrides, "", cmd.ErrOrStderr())
			if err != nil {
