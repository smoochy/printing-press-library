...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/ai/openrouter/internal/cliutil/testenv"
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"openrouter-pp-cli auth login",
		"openrouter-pp-cli doctor",
		"openrouter-pp-cli help items",
		"openrouter-pp-cli sync",
		"openrouter-pp-cli profile list",
		"openrouter-pp-cli feedback list",
		"openrouter-pp-cli which",
		"openrouter-pp-cli agent-context",
		"openrouter-pp-cli completion bash",
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"openrouter-pp-cli recall",
		"openrouter-pp-cli learnings",
		"openrouter-pp-cli teach-pattern",
		"openrouter-pp-cli teach-lookup",
		"openrouter-pp-cli items list",
	}
