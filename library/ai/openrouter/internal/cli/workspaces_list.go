...
func newWorkspacesListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "List all workspaces for the authenticated user.",
		Example:     "  openrouter-pp-cli workspaces list",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if flags.asJSON || (!isTerminal(cmd.OutOrStdout()) && !flags.csv && !flags.quiet && !flags.plain) {
				...
				if flags.selectFields != "" {
					...
					filtered = compactFields(filtered, map[string]bool{"created_at": true, "created_by": true, "default_guardrail_id": true, "default_image_model": true, "default_provider_sort": true, "default_text_model": true, "description": true, "id": true, "include_byok_in_budgets": true, "io_logging_api_key_ids": true, "io_logging_sampling_rate": true, "is_data_discount_logging_enabled": true, "is_observability_broadcast_enabled": true, "is_observability_io_logging_enabled": true, "name": true, "slug": true, "updated_at": true})
				}
			...
			return printOutputWithFlagsMeta(cmd.OutOrStdout(), formatData, flags, map[string]any{"source": "live"}, map[string]bool{"created_at": true, "created_by": true, "default_guardrail_id": true, "default_image_model": true, "default_provider_sort": true, "default_text_model": true, "description": true, "id": true, "include_byok_in_budgets": true, "io_logging_api_key_ids": true, "io_logging_sampling_rate": true, "is_data_discount_logging_enabled": true, "is_observability_broadcast_enabled": true, "is_observability_io_logging_enabled": true, "name": true, "slug": true, "updated_at": true})
		},
	}
