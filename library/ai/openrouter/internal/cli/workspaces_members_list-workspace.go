...
func newWorkspacesMembersListWorkspaceCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Aliases:     []string{"get"},
		Short:       "List all members of a workspace. Returns paginated results.",
		Example:     "  openrouter-pp-cli workspaces members list-workspace production",
		Annotations: map[string]string{"pp:endpoint": "members.list-workspace", "pp:method": "GET", "pp:path": "/workspaces/{id}/members", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return printOutputWithFlagsMeta(cmd.OutOrStdout(), formatData, flags, map[string]any{"source": "live"}, map[string]bool{"created_at": true, "id": true, "role": true, "user_id": true, "workspace_id": true})
		},
	}
