...
func newByokGetByokkeyCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-byokkey <id>",
		Aliases:     []string{"get"},
		Short:       "Get a single bring-your-own-key (BYOK) provider credential by its `id`.",
		Example:     "  openrouter-pp-cli byok get-byokkey 11111111-2222-3333-4444-555555555555",
		Annotations: map[string]string{"pp:endpoint": "byok.get-byokkey", "pp:method": "GET", "pp:path": "/byok/{id}", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveReadWithStrategyAndResponsePath(cmd.Context(), c, flags, "auto", "byok", false, path, params, headerOverrides, "", cmd.ErrOrStderr())
			if err != nil {
