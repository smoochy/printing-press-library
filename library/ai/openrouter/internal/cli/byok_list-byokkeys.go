...
func newByokListByokkeysCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  openrouter-pp-cli byok list-byokkeys",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if flags.asJSON || (!isTerminal(cmd.OutOrStdout()) && !flags.csv && !flags.quiet && !flags.plain) {
				...
				if flags.selectFields != "" {
					...
					filtered = compactFields(filtered, map[string]bool{"allowed_api_key_hashes": true, "allowed_models": true, "allowed_user_ids": true, "created_at": true, "disabled": true, "id": true, "is_fallback": true, "label": true, "name": true, "provider": true, "sort_order": true, "workspace_id": true})
				}
			...
			return printOutputWithFlagsMeta(cmd.OutOrStdout(), formatData, flags, map[string]any{"source": "live"}, map[string]bool{"allowed_api_key_hashes": true, "allowed_models": true, "allowed_user_ids": true, "created_at": true, "disabled": true, "id": true, "is_fallback": true, "label": true, "name": true, "provider": true, "sort_order": true, "workspace_id": true})
		},
	}
	...
	cmd.Flags().StringVar(&flagWorkspaceId, "workspace-id", "", "Optional workspace ID to filter by.")
