...
func newFilesDeleteCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "delete <file_id>",
		Short:       "Deletes a file owned by the requesting workspace. Deletion is irreversible.",
		Example:     "  openrouter-pp-cli files delete or_file_011CNha8iCJcU1wXNR6q4V8w",
		Annotations: map[string]string{"pp:endpoint": "files.delete", "pp:method": "DELETE", "pp:path": "/files/{file_id}"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cmd.Flags().Changed("workspace-id") || flagWorkspaceId != "" {
				params["workspace_id"] = formatCLIParamValue(flagWorkspaceId)
			}
			if cmd.Flags().Changed("provider") || flagProvider != "" {
