...
func newWorkspacesGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get <id>",
		Short:       "Get a single workspace by ID or slug. [Management key](/docs/guides/overview/auth/management-api-keys) required.",
		Example:     "  openrouter-pp-cli workspaces get production",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveReadWithStrategyAndResponsePath(cmd.Context(), c, flags, "auto", "workspaces", false, path, params, headerOverrides, "", cmd.ErrOrStderr())
			if err != nil {
