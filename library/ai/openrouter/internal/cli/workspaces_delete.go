...
func newWorkspacesDeleteCmd(flags *rootFlags) *cobra.Command {
	...
	var flagConfirmDefaultWorkspaceDeletion bool

	cmd := &cobra.Command{
		Use:         "delete <id>",
		Short:       "Delete an existing workspace. Workspaces with active API keys cannot be deleted; remove the keys first.",
		Example:     "  openrouter-pp-cli workspaces delete production",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cmd.Flags().Changed("confirm-default-workspace-deletion") || flagConfirmDefaultWorkspaceDeletion != false {
				params["confirm_default_workspace_deletion"] = formatCLIParamValue(flagConfirmDefaultWorkspaceDeletion)
			}
	...
	cmd.Flags().BoolVar(&flagConfirmDefaultWorkspaceDeletion, "confirm-default-workspace-deletion", false, "Required to delete the default workspace. (one of: true, false)")
