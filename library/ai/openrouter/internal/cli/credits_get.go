...
func newCreditsGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get",
		Aliases:     []string{"list"},
		Short:       "Get total credits purchased and used for the authenticated user.",
		Example:     "  openrouter-pp-cli credits get",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveReadWithStrategyAndResponsePath(cmd.Context(), c, flags, "auto", "credits", false, path, params, headerOverrides, "", cmd.ErrOrStderr())
			if err != nil {
