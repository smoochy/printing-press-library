...
func newOpenrouterAnalyticsGetMetaCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-meta",
		Aliases:     []string{"list"},
		Short:       "Returns the available metrics, dimensions, filter operators, and granularities for the analytics query endpoint.",
		Example:     "  openrouter-pp-cli openrouter-analytics get-meta",
		Annotations: map[string]string{"pp:endpoint": "openrouter-analytics.get-meta", "pp:method": "GET", "pp:path": "/analytics/meta", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveReadWithStrategyAndResponsePath(cmd.Context(), c, flags, "auto", "openrouter-analytics", false, path, params, headerOverrides, "", cmd.ErrOrStderr())
			if err != nil {
