...
func newVideosGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get <jobId>",
		Short:       "Returns job status and content URLs when completed",
		Example:     "  openrouter-pp-cli videos get job-abc123",
		Annotations: map[string]string{"pp:endpoint": "videos.get", "pp:method": "GET", "pp:path": "/videos/{jobId}", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveReadWithStrategyAndResponsePath(cmd.Context(), c, flags, "auto", "videos", false, path, params, headerOverrides, "unsigned_urls", cmd.ErrOrStderr())
			if err != nil {
