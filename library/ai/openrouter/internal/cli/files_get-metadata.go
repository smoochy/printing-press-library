...
func newFilesGetMetadataCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-metadata <file_id>",
		Aliases:     []string{"get"},
		Short:       "Retrieves metadata for a single file owned by the requesting workspace.",
		Example:     "  openrouter-pp-cli files get-metadata or_file_011CNha8iCJcU1wXNR6q4V8w",
		Annotations: map[string]string{"pp:endpoint": "files.get-metadata", "pp:method": "GET", "pp:path": "/files/{file_id}", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveReadWithStrategyAndResponsePath(cmd.Context(), c, flags, "auto", "files", false, path, params, headerOverrides, "", cmd.ErrOrStderr())
			if err != nil {
