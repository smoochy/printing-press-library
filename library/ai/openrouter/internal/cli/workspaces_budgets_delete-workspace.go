...
func newWorkspacesBudgetsDeleteWorkspaceCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "Remove the budget for a given interval. [Management key](/docs/guides/overview/auth/management-api-keys) required.",
		Example:     "  openrouter-pp-cli workspaces budgets delete-workspace production --interval monthly",
		Annotations: map[string]string{"pp:endpoint": "budgets.delete-workspace", "pp:method": "DELETE", "pp:path": "/workspaces/{id}/budgets/{interval}"},
