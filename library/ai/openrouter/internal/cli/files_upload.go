...
func newFilesUploadCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:   "Uploads a file to be referenced in future API calls.",
		// TODO: replace placeholder example values before relying on this for live dogfood.
		Example:     "  openrouter-pp-cli files upload --file example-value",
		Annotations: map[string]string{"pp:endpoint": "files.upload", "pp:method": "POST", "pp:path": "/files"},
