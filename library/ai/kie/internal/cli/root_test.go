...
func TestDeclaredAPISurfaceReachable(t *testing.T) {
	expected := []string{
		"aleph",
		"aleph generate-video",
		"aleph get-video-details",
		"chat",
		"claude",
		"codex",
		"common",
		...
		"file-url-upload",
		"flux",
		"flux generate-or-edit-image",
		"flux get-image-details",
		"gemini",
		"gemini 3-5-flash",
		"gemini 3-6-flash",
		...
		"generate add-vocals",
		"generate extend-music",
		"generate get-music-details",
		...
		"generate sounds",
		"generate upload-and-cover-audio",
		"generate upload-and-extend-audio",
		"gpt-5-2",
		"gpt4o-image",
		"gpt4o-image generate-4o-image",
		"gpt4o-image get-4o-image-details",
		"gpt4o-image get-4o-image-download-url",
		"grok",
		"grok responses",
		"kie-ai-jobs",
		"kie-ai-jobs market-create-task",
		"kie-ai-jobs market-query-task",
		"lyrics",
		"lyrics generate",
		"lyrics get-details",
		"midi",
		...
		"midi get-details",
		"mp4",
		"mp4 create-music-video",
		"mp4 get-music-video-details",
		"omni",
		"omni gemini-audio",
		"omni gemini-character",
		"responses",
		"runway",
		"runway extend-ai-video",
		"runway generate-ai-video",
		"runway get-ai-video-details",
		"style",
		"suno",
		"suno generate-cover",
		"suno get-cover-details",
		"veo",
		"veo extend-veo3-1-video",
		"veo generate-veo3-1-video",
		"veo get-veo3-1-1080p-video",
		"veo get-veo3-1-4k-video",
		"veo get-veo3-1-video-details",
		"vocal-removal",
		"vocal-removal get-vocal-separation-details",
		"vocal-removal separate-vocals",
		"voice",
		"voice suno-check",
		"voice suno-generate",
		"voice suno-record-info",
		"voice suno-regenerate",
		"voice suno-validate",
		"voice suno-validate-info",
		"wav",
		"wav convert-to",
		"wav get-details",
	}
