...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"kie-pp-cli auth login",
		"kie-pp-cli doctor",
		"kie-pp-cli help items",
		"kie-pp-cli sync",
		"kie-pp-cli profile list",
		"kie-pp-cli feedback list",
		"kie-pp-cli which",
		"kie-pp-cli agent-context",
		"kie-pp-cli completion bash",
		"kie-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"kie-pp-cli teach",
		"kie-pp-cli recall",
		"kie-pp-cli learnings",
		"kie-pp-cli teach-pattern",
		"kie-pp-cli teach-lookup",
		"kie-pp-cli items list",
	}
