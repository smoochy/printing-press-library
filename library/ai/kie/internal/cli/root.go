...
type rootFlags struct {
	...
	// invocation. Mirrors the KIE_NO_LEARN env var.
	noLearn bool
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "kie-pp-cli",
		Short: "Manage kie resources via the kie API",
		Long: `Manage kie resources via the kie API.
...
Run 'kie-pp-cli doctor' to verify auth and connectivity.`,
	...
	rootCmd.PersistentFlags().StringVar(&flags.runProfileName, "profile", "", "Apply values from a saved run profile; this does not select a client (see 'kie-pp-cli profile list')")
	...
	rootCmd.AddCommand(newAlephCmd(flags))
	rootCmd.AddCommand(newFluxCmd(flags))
	rootCmd.AddCommand(newGeminiCmd(flags))
	rootCmd.AddCommand(newGemini25FlashCmd(flags))
	rootCmd.AddCommand(newGemini25ProCmd(flags))
	rootCmd.AddCommand(newGemini3ProCmd(flags))
	rootCmd.AddCommand(newGenerateCmd(flags))
	rootCmd.AddCommand(newGpt4oImageCmd(flags))
	rootCmd.AddCommand(newGrokCmd(flags))
	rootCmd.AddCommand(newKieAiJobsCmd(flags))
	rootCmd.AddCommand(newLyricsCmd(flags))
	rootCmd.AddCommand(newMidiCmd(flags))
	rootCmd.AddCommand(newMp4Cmd(flags))
	rootCmd.AddCommand(newOmniCmd(flags))
	rootCmd.AddCommand(newRunwayCmd(flags))
	rootCmd.AddCommand(newSunoCmd(flags))
	rootCmd.AddCommand(newVeoCmd(flags))
	rootCmd.AddCommand(newVocalRemovalCmd(flags))
	rootCmd.AddCommand(newVoiceCmd(flags))
	rootCmd.AddCommand(newWavCmd(flags))
	...
	rootCmd.AddCommand(newClaudePromotedCmd(flags))
	rootCmd.AddCommand(newCodexPromotedCmd(flags))
	rootCmd.AddCommand(newCommonPromotedCmd(flags))
	rootCmd.AddCommand(newFileBase64UploadPromotedCmd(flags))
	rootCmd.AddCommand(newFileStreamUploadPromotedCmd(flags))
	rootCmd.AddCommand(newFileUrlUploadPromotedCmd(flags))
	rootCmd.AddCommand(newGemini31ProPromotedCmd(flags))
	rootCmd.AddCommand(newGemini35FlashOpenaiPromotedCmd(flags))
	rootCmd.AddCommand(newGemini36FlashOpenaiPromotedCmd(flags))
	rootCmd.AddCommand(newGemini3FlashPromotedCmd(flags))
	rootCmd.AddCommand(newGpt52PromotedCmd(flags))
	rootCmd.AddCommand(newResponsesPromotedCmd(flags))
	rootCmd.AddCommand(newStylePromotedCmd(flags))
