...
func newGenerateReplaceSectionCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "replace-section",
		Short:       "Replace a specific time segment within existing music.",
		Example:     "  kie-pp-cli generate replace-section",
		Annotations: map[string]string{"pp:endpoint": "generate.replace-section", "pp:method": "POST", "pp:path": "/api/v1/generate/replace-section"},
