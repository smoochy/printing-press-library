...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/job-boards/ashby/internal/cliutil/testenv"
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"ashby-pp-cli auth login",
		"ashby-pp-cli doctor",
		"ashby-pp-cli help items",
		"ashby-pp-cli sync",
		"ashby-pp-cli profile list",
		"ashby-pp-cli feedback list",
		"ashby-pp-cli which",
		"ashby-pp-cli agent-context",
		"ashby-pp-cli completion bash",
		"ashby-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"ashby-pp-cli teach",
		"ashby-pp-cli recall",
		"ashby-pp-cli learnings",
		"ashby-pp-cli teach-pattern",
		"ashby-pp-cli teach-lookup",
		"ashby-pp-cli items list",
	}
