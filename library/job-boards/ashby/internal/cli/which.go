...
var whichIndex = []whichEntry{
	{Command: "postings list", Description: "Lists only publicly listed Ashby jobs and supports structured filtering across department, team, location, workplace type, employment type, publication date, currency, and compensation range.", Group: "Public job intelligence", WhyItMatters: "Agents and job seekers get keyless machine-readable discovery without surfacing an unlisted posting returned upstream."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  ashby-pp-cli which "stale tickets"
  ashby-pp-cli which "bottleneck"
  ashby-pp-cli which --limit 1 "send message"
  ashby-pp-cli which                                # list the full capability index`,
