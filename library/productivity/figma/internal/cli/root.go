...
See README.md or the bundled SKILL.md for recipes.`,
	...
	rootCmd.AddCommand(newNovelCommentsAuditCmd(flags))
	rootCmd.AddCommand(newNovelDevModeCmd(flags))
	rootCmd.AddCommand(newNovelFingerprintCmd(flags))
	rootCmd.AddCommand(newNovelFrameCmd(flags))
	rootCmd.AddCommand(newNovelOrphansCmd(flags))
	rootCmd.AddCommand(newNovelTokensCmd(flags))
	rootCmd.AddCommand(newNovelVariablesCmd(flags))
