...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/productivity/google-calendar/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "google-calendar-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
