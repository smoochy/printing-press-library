...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/productivity/raindrop/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("RAINDROP_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "raindrop-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
