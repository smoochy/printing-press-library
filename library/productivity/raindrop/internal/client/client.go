...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/productivity/raindrop/internal/cliutil"
	"github.com/mvanhorn/printing-press-library/library/productivity/raindrop/internal/config"
	"github.com/mvanhorn/printing-press-library/library/productivity/raindrop/internal/platform"
)
...
func authPlaceholderCredentialError(cfg *config.Config) error {
	return authPlaceholderCredentialErrorWithSetup(cfg, "export RAINDROP_TOKEN=<your-token> or raindrop-pp-cli auth set-token <token>")
}
...
func (c *Client) maskCredentialText(text string, extraCredentials ...string) string {
	...
	if c != nil && c.Config != nil {
		...
		addCredential(c.Config.RaindropToken)
	}
