...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"seek-pp-cli auth login",
		"seek-pp-cli doctor",
		"seek-pp-cli help items",
		"seek-pp-cli sync",
		"seek-pp-cli profile list",
		"seek-pp-cli feedback list",
		"seek-pp-cli which",
		"seek-pp-cli agent-context",
		"seek-pp-cli completion bash",
		"seek-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"seek-pp-cli teach",
		"seek-pp-cli recall",
		"seek-pp-cli learnings",
		"seek-pp-cli teach-pattern",
		"seek-pp-cli teach-lookup",
		"seek-pp-cli items list",
	}
