...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/productivity/gmail/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("GMAIL_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "gmail-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
