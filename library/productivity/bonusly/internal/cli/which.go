...
var whichIndex = []whichEntry{
	{Command: "recognition audit", Description: "See whether your team's recognition spend is on pace with its monthly budget, broken down by department -- the report Bonusly normally reserves for admins.", Group: "Local state that compounds", WhyItMatters: "Reach for this when a team lead wants pacing/budget visibility without admin access, instead of manually tallying the web feed."},
	{Command: "recognition search-mine", Description: "Search your own given and received recognition offline, without scrolling the public company feed. Requires one live lookup to confirm your identity (no local fallback); not yet verified against a real API response in this build.", Group: "Local state that compounds", WhyItMatters: "Use this for self-review prep or recalling why you were recognized -- the company-wide feed search returns everyone's posts, not just yours."},
	{Command: "balance history", Description: "Track your giving-allowance burn rate over time and see forfeiture coming before the monthly reset, not after.", Group: "Local state that compounds", WhyItMatters: "Check this a few days before month-end to see if points are about to be forfeited."},
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  bonusly-pp-cli which "stale tickets"
  bonusly-pp-cli which "bottleneck"
  bonusly-pp-cli which --limit 1 "send message"
  bonusly-pp-cli which                                # list the full capability index`,
