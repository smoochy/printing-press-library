...
native streaming instead of polling.`,
  ...
  workspace-admin-pp-cli tail --interval 10s

  # Tail a specific resource
  workspace-admin-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  workspace-admin-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
