...
but do not stop the import.`,
  ...
  workspace-admin-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  workspace-admin-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | workspace-admin-pp-cli import <resource> --input -`,
