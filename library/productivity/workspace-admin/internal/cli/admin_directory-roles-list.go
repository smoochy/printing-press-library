...
func newAdminDirectoryRolesListCmd(flags *rootFlags) *cobra.Command {
	var flagMaxResults int
	var flagPageToken string
	var flagAll bool

	cmd := &cobra.Command{
		Use:   "directory-roles-list <customer>",
		Short: "Retrieves a paginated list of all the roles in a domain.",
		// TODO: replace placeholder example values before relying on this for live dogfood.
		Example:     "  workspace-admin-pp-cli admin directory-roles-list example-value",
		Annotations: map[string]string{"pp:endpoint": "admin.directory-roles-list", "pp:method": "GET", "pp:path": "/admin/directory/v1/customer/{customer}/roles", "mcp:read-only": "true"},
