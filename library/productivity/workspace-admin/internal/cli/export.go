...
large datasets as it has no memory pressure.`,
  ...
  workspace-admin-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  workspace-admin-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  workspace-admin-pp-cli export <resource> --format jsonl | jq '.id'`,
