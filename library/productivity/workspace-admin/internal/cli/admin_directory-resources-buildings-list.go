...
func newAdminDirectoryResourcesBuildingsListCmd(flags *rootFlags) *cobra.Command {
	var flagMaxResults int
	var flagPageToken string
	var flagAll bool

	cmd := &cobra.Command{
		Use:   "directory-resources-buildings-list <customer>",
		Short: "Retrieves a list of buildings for an account.",
		// TODO: replace placeholder example values before relying on this for live dogfood.
		Example:     "  workspace-admin-pp-cli admin directory-resources-buildings-list example-value",
		Annotations: map[string]string{"pp:endpoint": "admin.directory-resources-buildings-list", "pp:method": "GET", "pp:path": "/admin/directory/v1/customer/{customer}/resources/buildings", "mcp:read-only": "true"},
