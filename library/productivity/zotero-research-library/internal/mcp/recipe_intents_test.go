...
func TestRecipeIntentHandlerBuildsRecipeArgs(t *testing.T) {
	...
	result, err := handleFullTextDeepSearch(context.Background(), req)
	if err != nil {
...
func TestRecipeIntentHandlerOverridesParams(t *testing.T) {
	...
	if strings.Contains(got, "--fulltext") {
		t.Fatalf("boolean false override should suppress --fulltext: %q", got)
	}
}
