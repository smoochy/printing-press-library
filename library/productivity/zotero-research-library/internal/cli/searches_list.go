...
func newSearchesListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "All saved searches",
		Example:     "  zotero-research-library-pp-cli searches list",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveReadWithStrategyAndResponsePath(cmd.Context(), c, flags, "auto", "searches", true, path, params, nil, "", cmd.ErrOrStderr())
			if err != nil {
