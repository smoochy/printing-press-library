...
var readCommandResources = map[string][]string{
	"zotero-research-library-pp-cli collections":            {"collections"},
	"zotero-research-library-pp-cli collections list":       {"collections"},
	"zotero-research-library-pp-cli collections get":        {"collections"},
	"zotero-research-library-pp-cli collections search":     {"collections"},
	"zotero-research-library-pp-cli collections-top":        {"collections-top"},
	"zotero-research-library-pp-cli collections-top list":   {"collections-top"},
	"zotero-research-library-pp-cli collections-top get":    {"collections-top"},
	"zotero-research-library-pp-cli collections-top search": {"collections-top"},
	"zotero-research-library-pp-cli deleted":                {"deleted"},
	"zotero-research-library-pp-cli deleted list":           {"deleted"},
	"zotero-research-library-pp-cli deleted get":            {"deleted"},
	"zotero-research-library-pp-cli deleted search":         {"deleted"},
	"zotero-research-library-pp-cli items":                  {"items"},
	"zotero-research-library-pp-cli items list":             {"items"},
	"zotero-research-library-pp-cli items get":              {"items"},
	"zotero-research-library-pp-cli items search":           {"items"},
	"zotero-research-library-pp-cli items-top":              {"items-top"},
	"zotero-research-library-pp-cli items-top list":         {"items-top"},
	"zotero-research-library-pp-cli items-top get":          {"items-top"},
	"zotero-research-library-pp-cli items-top search":       {"items-top"},
	"zotero-research-library-pp-cli items-trash":            {"items-trash"},
	"zotero-research-library-pp-cli items-trash list":       {"items-trash"},
	"zotero-research-library-pp-cli items-trash get":        {"items-trash"},
	"zotero-research-library-pp-cli items-trash search":     {"items-trash"},
	"zotero-research-library-pp-cli searches":               {"searches"},
	"zotero-research-library-pp-cli searches list":          {"searches"},
	"zotero-research-library-pp-cli searches get":           {"searches"},
	"zotero-research-library-pp-cli searches search":        {"searches"},
	"zotero-research-library-pp-cli tags":                   {"tags"},
	"zotero-research-library-pp-cli tags list":              {"tags"},
	"zotero-research-library-pp-cli tags get":               {"tags"},
	"zotero-research-library-pp-cli tags search":            {"tags"},
}
...
func cachePolicy() cliutil.Policy {
	...
	envOptOut := "ZOTERO_RESEARCH_LIBRARY_NO_AUTO_REFRESH"
...
func autoRefreshIfStale(ctx context.Context, flags *rootFlags, resources []string) (meta cliutil.FreshnessMeta) {
	...
	if err := runAutoRefresh(refreshCtx, flags, db, resources); err != nil {
		fmt.Fprintf(os.Stderr, "warning: using stale zotero-research-library-pp-cli cache (refresh failed: %v)\n", err)
