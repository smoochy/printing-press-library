...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"zotero-research-library-pp-cli auth login",
		"zotero-research-library-pp-cli doctor",
		"zotero-research-library-pp-cli help items",
		"zotero-research-library-pp-cli sync",
		"zotero-research-library-pp-cli profile list",
		"zotero-research-library-pp-cli feedback list",
		"zotero-research-library-pp-cli which",
		"zotero-research-library-pp-cli agent-context",
		"zotero-research-library-pp-cli completion bash",
		"zotero-research-library-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"zotero-research-library-pp-cli recall",
		"zotero-research-library-pp-cli learnings",
		"zotero-research-library-pp-cli teach-pattern",
		"zotero-research-library-pp-cli teach-lookup",
