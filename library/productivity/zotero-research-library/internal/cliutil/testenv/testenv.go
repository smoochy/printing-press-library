...
var clearedVars = []string{
	"ZOTERO_RESEARCH_LIBRARY_CONFIG",
	"ZOTERO_RESEARCH_LIBRARY_CONFIG_DIR",
	"ZOTERO_RESEARCH_LIBRARY_DATA_DIR",
	"ZOTERO_RESEARCH_LIBRARY_STATE_DIR",
	"ZOTERO_RESEARCH_LIBRARY_CACHE_DIR",
	"ZOTERO_RESEARCH_LIBRARY_HOME",
	"XDG_CONFIG_HOME",
	"XDG_DATA_HOME",
	"XDG_STATE_HOME",
	"XDG_CACHE_HOME",
