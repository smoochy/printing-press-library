...
const (
	journalSessionEnvVar   = "ZOTERO_RESEARCH_LIBRARY_LEARN_SESSION"
	journalNoLearnEnvVar   = "ZOTERO_RESEARCH_LIBRARY_NO_LEARN"
	journalNoCaptureEnvVar = "ZOTERO_RESEARCH_LIBRARY_LEARN_NO_CAPTURE"
)
