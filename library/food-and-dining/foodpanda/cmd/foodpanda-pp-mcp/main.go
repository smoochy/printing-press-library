...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/food-and-dining/foodpanda/internal/cli"
	mcptools "github.com/mvanhorn/printing-press-library/library/food-and-dining/foodpanda/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("FOODPANDA_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "foodpanda-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
