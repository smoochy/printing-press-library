...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/food-and-dining/ifood/internal/config"
	"github.com/mvanhorn/printing-press-library/library/food-and-dining/ifood/internal/platform"
)
...
func authPlaceholderCredentialError(cfg *config.Config) error {
	return authPlaceholderCredentialErrorWithSetup(cfg, "export IFOOD_BEARER_AUTH=<your-token> or ifood-pp-cli auth set-token <token>")
}
...
func (c *Client) maskCredentialText(text string, extraCredentials ...string) string {
	...
	if c != nil && c.Config != nil {
		...
		addCredential(c.Config.IfoodBearerAuth)
	}
