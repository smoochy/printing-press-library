...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "flipp-pp-cli",
		Short: `Find local Flipp flyer deals, coupons, and grocery savings by ZIP or postal code.`,
		Long: `Find local Flipp flyer deals, coupons, and grocery savings by ZIP or postal code.
...
Health check: run 'flipp-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("flipp-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'flipp-pp-cli profile list')")
	...
	rootCmd.AddCommand(newFlyersCmd(flags))
	...
	rootCmd.AddCommand(newNovelUnitPriceCmd(flags))
	...
	rootCmd.AddCommand(newMerchantsPromotedCmd(flags))
