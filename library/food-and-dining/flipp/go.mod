module github.com/mvanhorn/printing-press-library/library/food-and-dining/flipp
...
// Floor x/text above GO-2026-5970 (unicode/norm). It is pulled only
// transitively, so MVS needs this explicit floor.
