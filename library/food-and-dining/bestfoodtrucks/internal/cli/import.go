...
but do not stop the import.`,
  ...
  bestfoodtrucks-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  bestfoodtrucks-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | bestfoodtrucks-pp-cli import <resource> --input -`,
