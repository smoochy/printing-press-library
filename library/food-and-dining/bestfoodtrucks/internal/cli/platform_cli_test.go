...
func TestPlatformMigrationAdoptsOnlyVerifiedTenantDatabase(t *testing.T) {
	...
	paths, err := platform.PathsFor("tenant-adopt", "bestfoodtrucks-pp-cli", "test-source")
	if err != nil {
		t.Fatal(err)
	}
...
func TestPlatformMigrationWrongTenantCannotCreateProfile(t *testing.T) {
	...
	paths, err := platform.PathsFor("tenant-rejected", "bestfoodtrucks-pp-cli", "test-source")
	if err != nil {
		t.Fatal(err)
	}
