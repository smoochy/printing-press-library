...
func buildAgentDiscoveryContext() *agentContextDiscovery {
	return &agentContextDiscovery{
		...
		TargetURL:     "https://www.bestfoodtrucks.com/lots/playa-district",
		EntryCount:    196,
		APIEntryCount: 25,
		Reachability:  "browser_http (78% confidence)",
		Protocols: []string{
			"graphql (92% confidence)",
			"graphql_persisted_query (90% confidence)",
		...
		CandidateCommands: []string{
			...
			"create_track_referrer.json — Derived from observed POST /track-referrer.json traffic.",
			"create_track_request — Derived from observed POST /api/v1/intent_pixel/track_request traffic.",
			"head_schedule.json — Derived from observed HEAD /_next/data/-dh7Qe2PYMUxWzoOQbyo3/lots/playa-district/schedule.json traffic.",
			"list_179609_playa_district_on_2026_08_26.json — Derived from observed GET /_next/data/-dh7Qe2PYMUxWzoOQbyo3/shifts/179609-playa-district-on-2026-08-26.json traffic.",
			"list_attribution_trigger — Derived from observed GET /attribution_trigger traffic.",
			"list_can_track_visitor — Derived from observed GET /api/v1/intent_pixel/can_track_visitor traffic.",
