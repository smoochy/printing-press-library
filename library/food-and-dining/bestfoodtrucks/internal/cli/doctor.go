...
func newDoctorCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  bestfoodtrucks-pp-cli doctor
  bestfoodtrucks-pp-cli doctor --json
  bestfoodtrucks-pp-cli doctor --fail-on warn
  bestfoodtrucks-pp-cli doctor --fail-on stale`,
			...
			if cfg != nil && cfg.BaseURL != "" {
				...
				if clientErr != nil {
					...
					if authHeader == "" {
						...
						if suggestion != "" {
							report["credentials"] = fmt.Sprintf("present, not verified. Run `%s %s` to confirm the token works end-to-end.", "bestfoodtrucks-pp-cli", suggestion)
						} else {
