...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/food-and-dining/bestfoodtrucks/internal/cliutil/testenv"
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"bestfoodtrucks-pp-cli auth login",
		"bestfoodtrucks-pp-cli doctor",
		"bestfoodtrucks-pp-cli help items",
		"bestfoodtrucks-pp-cli sync",
		"bestfoodtrucks-pp-cli profile list",
		"bestfoodtrucks-pp-cli feedback list",
		"bestfoodtrucks-pp-cli which",
		"bestfoodtrucks-pp-cli agent-context",
		"bestfoodtrucks-pp-cli completion bash",
		"bestfoodtrucks-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"bestfoodtrucks-pp-cli recall",
		"bestfoodtrucks-pp-cli learnings",
		"bestfoodtrucks-pp-cli teach-pattern",
		"bestfoodtrucks-pp-cli teach-lookup",
		"bestfoodtrucks-pp-cli items list",
	}
