...
var whichIndex = []whichEntry{
	{Command: "lot digest", Description: "Turns a lot's upcoming schedule into ready-to-paste announcement text instead of raw structured data.", Group: "Cross-schedule synthesis", WhyItMatters: "Reach for this when the task is 'summarize this week's schedule for humans,' not 'give me structured data.'"},
	{Command: "trucks find", Description: "Finds every upcoming shift at a lot matching a cuisine, without opening each shift page one at a time.", Group: "Cross-schedule synthesis", WhyItMatters: "Use this when a user names a cuisine and a lot rather than a specific date — it walks the whole visible schedule window for you."},
	{Command: "truck schedule", Description: "Shows every lot a specific truck visits, past and future — a view the Best Food Trucks website itself never built.", Group: "Truck-centric views the website never built", WhyItMatters: "Use this to answer 'when does my favorite truck come back' or 'what other lots does this truck serve' — impossible from the live site's own navigation."},
	{Command: "market hotlist", Description: "Ranks trucks operating in a city by review signal, a cross-truck aggregate the site never computes.", Group: "Truck-centric views the website never built", WhyItMatters: "Use this for 'what's the best-rated truck in this city' rather than checking trucks one at a time."},
	{Command: "lots digest", Description: "Combines multiple lots' schedules into one view in a single command instead of visiting each lot's page separately.", Group: "Cross-schedule synthesis", WhyItMatters: "Use this when a user tracks more than one regular lot (e.g., office campus plus a nearby favorite) and wants one combined answer."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  bestfoodtrucks-pp-cli which "stale tickets"
  bestfoodtrucks-pp-cli which "bottleneck"
  bestfoodtrucks-pp-cli which --limit 1 "send message"
  bestfoodtrucks-pp-cli which                                # list the full capability index`,
