...
func Load(configPath string) (*Config, error) {
	cfg := &Config{
		BaseURL: "https://api.bestfoodtrucks.com",
	}
	...
	if v := os.Getenv("BESTFOODTRUCKS_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("BESTFOODTRUCKS_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "bestfoodtrucks-pp-cli", "config.json"), nil
}
