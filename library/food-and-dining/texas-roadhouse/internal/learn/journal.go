...
const (
	journalSessionEnvVar   = "TEXAS_ROADHOUSE_LEARN_SESSION"
	journalNoLearnEnvVar   = "TEXAS_ROADHOUSE_NO_LEARN"
	journalNoCaptureEnvVar = "TEXAS_ROADHOUSE_LEARN_NO_CAPTURE"
)
