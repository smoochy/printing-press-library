...
func Load(configPath string) (*Config, error) {
	cfg := &Config{
		BaseURL: "https://www.texasroadhouse.com",
	}
	...
	// Env var overrides
	if v := strings.ToLower(strings.TrimSpace(os.Getenv("TEXAS_ROADHOUSE_SKIP_TLS_VERIFY"))); v == "1" || v == "true" || v == "yes" || v == "on" {
		cfg.SetSkipTLSVerify(true)
	}

	// Base URL override (used by printing-press verify to point at mock/test servers)
	if v := os.Getenv("TEXAS_ROADHOUSE_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("TEXAS_ROADHOUSE_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "texas-roadhouse-pp-cli", "config.toml"), nil
}
