...
func TestPlatformMigrationAdoptsOnlyVerifiedTenantDatabase(t *testing.T) {
	...
	paths, err := platform.PathsFor("tenant-adopt", "texas-roadhouse-pp-cli", "test-source")
	if err != nil {
		t.Fatal(err)
	}
...
func TestPlatformMigrationWrongTenantCannotCreateProfile(t *testing.T) {
	...
	paths, err := platform.PathsFor("tenant-rejected", "texas-roadhouse-pp-cli", "test-source")
	if err != nil {
		t.Fatal(err)
	}
