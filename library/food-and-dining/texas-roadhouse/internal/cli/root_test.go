...
func TestDeclaredAPISurfaceReachable(t *testing.T) {
	expected := []string{
		...
		"stores",
		"texasroadhouse",
		"texasroadhouse cancel",
		"texasroadhouse checkin",
		"texasroadhouse get-quote",
		"texasroadhouse get-settings",
		"texasroadhouse get-status",
		"texasroadhouse get-test",
		"texasroadhouse submit",
	}
