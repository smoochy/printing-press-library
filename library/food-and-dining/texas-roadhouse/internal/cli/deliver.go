...
func deliverWebhook(url string, body []byte, compact bool) error {
	...
	if ua := os.Getenv("TEXAS_ROADHOUSE_USER_AGENT"); ua != "" {
		req.Header.Set("User-Agent", ua)
	} else {
		req.Header.Set("User-Agent", "github.com/mvanhorn/printing-press-library/library/food-and-dining/texas-roadhouse/deliver")
	}
