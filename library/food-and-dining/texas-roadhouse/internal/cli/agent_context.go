...
func buildAgentDiscoveryContext() *agentContextDiscovery {
	return &agentContextDiscovery{
		...
		TargetURL:     "https://www.texasroadhouse.com/api/mapbox/geocoding/v5/mapbox.places/65804.json",
		EntryCount:    7,
		APIEntryCount: 7,
		...
		CandidateCommands: []string{
			"get_mapbox.places — Derived from observed GET /api/mapbox/geocoding/v5/mapbox.places/{id} traffic.",
			"get_quote — Derived from observed GET /api/texasroadhouse/waitlist/{waitlist_id}/quote traffic.",
			"get_settings — Derived from observed GET /api/texasroadhouse/waitlist/{waitlist_id}/settings traffic.",
			"get_test — Derived from observed GET /api/texasroadhouse/waitlist/{waitlist_id}/test traffic.",
			"list_near — Derived from observed GET /api/stores/near traffic.",
		},
	}
}
