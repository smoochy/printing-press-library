...
large datasets as it has no memory pressure.`,
  ...
  texas-roadhouse-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  texas-roadhouse-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  texas-roadhouse-pp-cli export <resource> --format jsonl | jq '.id'`,
