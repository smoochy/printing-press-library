...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"texas-roadhouse-pp-cli auth login",
		"texas-roadhouse-pp-cli doctor",
		"texas-roadhouse-pp-cli help items",
		"texas-roadhouse-pp-cli sync",
		"texas-roadhouse-pp-cli profile list",
		"texas-roadhouse-pp-cli feedback list",
		"texas-roadhouse-pp-cli which",
		"texas-roadhouse-pp-cli agent-context",
		"texas-roadhouse-pp-cli completion bash",
		"texas-roadhouse-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"texas-roadhouse-pp-cli recall",
		"texas-roadhouse-pp-cli learnings",
		"texas-roadhouse-pp-cli teach-pattern",
		"texas-roadhouse-pp-cli teach-lookup",
		"texas-roadhouse-pp-cli items list",
	}
