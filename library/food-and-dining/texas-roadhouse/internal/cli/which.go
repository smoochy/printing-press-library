...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  texas-roadhouse-pp-cli which "stale tickets"
  texas-roadhouse-pp-cli which "bottleneck"
  texas-roadhouse-pp-cli which --limit 1 "send message"
  texas-roadhouse-pp-cli which                                # list the full capability index`,
