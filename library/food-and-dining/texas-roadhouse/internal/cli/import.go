...
but do not stop the import.`,
  ...
  texas-roadhouse-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  texas-roadhouse-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | texas-roadhouse-pp-cli import <resource> --input -`,
