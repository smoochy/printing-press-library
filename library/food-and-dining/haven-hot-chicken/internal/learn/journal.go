...
const (
	journalSessionEnvVar   = "HAVEN_HOT_CHICKEN_LEARN_SESSION"
	journalNoLearnEnvVar   = "HAVEN_HOT_CHICKEN_NO_LEARN"
	journalNoCaptureEnvVar = "HAVEN_HOT_CHICKEN_LEARN_NO_CAPTURE"
)
