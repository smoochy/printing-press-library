...
func Load(configPath string) (*Config, error) {
	...
	if v := cliutil.EnvOverride("HAVEN_HOT_CHICKEN_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("HAVEN_HOT_CHICKEN_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "haven-hot-chicken-pp-cli", "config.toml"), nil
}
