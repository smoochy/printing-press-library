...
func TestPlatformMigrationAdoptsOnlyVerifiedTenantDatabase(t *testing.T) {
	...
	paths, err := platform.PathsFor("tenant-adopt", "haven-hot-chicken-pp-cli", "test-source")
	if err != nil {
		t.Fatal(err)
	}
...
func TestPlatformMigrationWrongTenantCannotCreateProfile(t *testing.T) {
	...
	paths, err := platform.PathsFor("tenant-rejected", "haven-hot-chicken-pp-cli", "test-source")
	if err != nil {
		t.Fatal(err)
	}
