...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"haven-hot-chicken-pp-cli auth login",
		"haven-hot-chicken-pp-cli doctor",
		"haven-hot-chicken-pp-cli help items",
		"haven-hot-chicken-pp-cli sync",
		"haven-hot-chicken-pp-cli profile list",
		"haven-hot-chicken-pp-cli feedback list",
		"haven-hot-chicken-pp-cli which",
		"haven-hot-chicken-pp-cli agent-context",
		"haven-hot-chicken-pp-cli completion bash",
		"haven-hot-chicken-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"haven-hot-chicken-pp-cli recall",
		"haven-hot-chicken-pp-cli learnings",
		"haven-hot-chicken-pp-cli teach-pattern",
		"haven-hot-chicken-pp-cli teach-lookup",
		"haven-hot-chicken-pp-cli items list",
	}
