...
var whichIndex = []whichEntry{
	{Command: "haven compare", Description: "Compare the same named menu item across saved location menus.", Group: "Saved menu comparisons", WhyItMatters: "Compare the same named menu item across saved location menus."},
	{Command: "haven subtotal", Description: "Estimate a meal base-price subtotal from explicit item IDs and quantities.", Group: "Meal and pickup planning", WhyItMatters: "Estimate a meal base-price subtotal from explicit item IDs and quantities."},
	{Command: "haven changes", Description: "Show additions, removals, price and availability changes between two complete saved menus.", Group: "Saved menu comparisons", WhyItMatters: "Show additions, removals, price and availability changes between two complete saved menus."},
	{Command: "haven common", Description: "Find items marked available in every selected saved location menu.", Group: "Saved menu comparisons", WhyItMatters: "Find items marked available in every selected saved location menu."},
	{Command: "haven nearby", Description: "Rank saved shops by straight-line distance from supplied coordinates.", Group: "Meal and pickup planning", WhyItMatters: "Rank saved shops by straight-line distance from supplied coordinates."},
	{Command: "menu-categories", Description: "List menu categories", Group: "menu-categories", WhyItMatters: "List menu categories"}, // pp:which-promoted
	{Command: "menus", Description: "List menus", Group: "menus", WhyItMatters: "List menus"}, // pp:which-promoted
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one. Machine output (--json/--csv/--plain/--quiet, or a pipe) still exits 2 and writes {"matches":[]} (or the equivalent empty table) to stdout.`,
		SilenceUsage: true,
		Example: `  haven-hot-chicken-pp-cli which "stale tickets"
  haven-hot-chicken-pp-cli which "bottleneck"
  haven-hot-chicken-pp-cli which --limit 1 "send message"
  haven-hot-chicken-pp-cli which                                # list the full capability index`,
