...
func initLearn(ctx context.Context, db *sql.DB) error {
	...
	seeds := map[string][]lookups.SeedConfig{
		"location": {
			{Canonical: "North Haven, CT", Values: []string{"north haven"}},
			{Canonical: "New Haven, CT", Values: []string{"new haven"}},
			{Canonical: "Middletown, CT", Values: []string{"middletown"}},
			{Canonical: "Oxford, CT", Values: []string{"oxford"}},
			{Canonical: "Newington, CT", Values: []string{"newington"}},
			{Canonical: "Orange, CT", Values: []string{"orange"}},
			{Canonical: "Fairfield, CT", Values: []string{"fairfield"}},
			{Canonical: "Norwalk, CT", Values: []string{"norwalk"}},
			{Canonical: "Storrs, CT", Values: []string{"storrs"}},
			{Canonical: "Franklin, MA", Values: []string{"franklin"}},
		},
	}
...
func runLearnInitOnce(ctx context.Context) {
	learnInitOnce.Do(func() {
		...
		if err != nil {
			fmt.Fprintf(os.Stderr, "warning: haven-hot-chicken-pp-cli: learn init: open store: %v\n", err)
			return
		}
		defer s.Close()
		if err := initLearn(ctx, s.DB()); err != nil {
			fmt.Fprintf(os.Stderr, "warning: haven-hot-chicken-pp-cli: learn init: %v\n", err)
		}
	})
}
...
func learnResourceTypeFields() map[string][]string {
	return map[string][]string{
		"categories":      {"id", "name", "title", "display_name", "full_name", "short_name", "label", "slug", "key", "code", "address"},
		"items":           {"name", "title", "display_name", "full_name", "short_name", "label", "slug", "key", "code", "id", "address"},
		"locations":       {"id", "name", "title", "display_name", "full_name", "short_name", "label", "slug", "key", "code", "address"},
		"menu-categories": {"id", "name", "title", "display_name", "full_name", "short_name", "label", "slug", "key", "code", "address"},
		"menu_categories": {"id", "name", "title", "display_name", "full_name", "short_name", "label", "slug", "key", "code", "address"},
		"menus":           {"id", "name", "title", "display_name", "full_name", "short_name", "label", "slug", "key", "code", "address"},
		"modifiers":       {"id", "name", "title", "display_name", "full_name", "short_name", "label", "slug", "key", "code", "address"},
	}
}
