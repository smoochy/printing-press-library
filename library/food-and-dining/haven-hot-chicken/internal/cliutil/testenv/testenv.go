...
var clearedVars = []string{
	"HAVEN_HOT_CHICKEN_CONFIG",
	"HAVEN_HOT_CHICKEN_CONFIG_DIR",
	"HAVEN_HOT_CHICKEN_DATA_DIR",
	"HAVEN_HOT_CHICKEN_STATE_DIR",
	"HAVEN_HOT_CHICKEN_CACHE_DIR",
	"HAVEN_HOT_CHICKEN_HOME",
	"XDG_CONFIG_HOME",
	"XDG_DATA_HOME",
	"XDG_STATE_HOME",
	"XDG_CACHE_HOME",
