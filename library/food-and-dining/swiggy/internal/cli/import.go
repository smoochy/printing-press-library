...
but do not stop the import.`,
  ...
  swiggy-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  swiggy-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | swiggy-pp-cli import <resource> --input -`,
