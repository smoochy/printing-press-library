...
func TestDeclaredAPISurfaceReachable(t *testing.T) {
	expected := []string{
		"dineout",
		"dineout book-table",
		"dineout cancel-booking",
		"dineout check-payment-status",
		"dineout confirm-order",
		"dineout create-cart",
		"dineout get-available-slots",
		"dineout get-booking-status",
		"dineout get-payment-options",
		"dineout get-restaurant-details",
		"dineout get-saved-locations",
		"dineout report-error",
		"dineout search-restaurants-dineout",
		"food",
		"food apply-food-coupon",
		"food check-payment-status",
		"food confirm-order",
		"food create-address",
		"food delete-address",
		"food fetch-food-coupons",
		"food flush-food-cart",
		"food get-addresses",
		"food get-food-cart",
		"food get-food-delivery-status",
		"food get-food-order-details",
		"food get-food-orders",
		"food get-payment-options",
		"food get-restaurant-menu",
		"food place-food-order",
		"food report-error",
		"food search-menu",
		"food search-restaurants",
		"food track-food-order",
		"food update-food-cart",
		"instamart",
		"instamart apply-coupon",
		"instamart check-payment-status",
		"instamart checkout",
		"instamart clear-cart",
		"instamart confirm-order",
		"instamart create-address",
		"instamart delete-address",
		"instamart get-addresses",
		"instamart get-cart",
		"instamart get-delivery-status",
		"instamart get-order-details",
		"instamart get-orders",
		"instamart get-payment-options",
		"instamart list-coupons",
		"instamart report-error",
		"instamart search-products",
		"instamart track-order",
		"instamart update-cart",
