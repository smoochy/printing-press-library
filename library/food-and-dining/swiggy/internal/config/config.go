...
func Load(configPath string) (*Config, error) {
	...
	// Env var overrides
	if v := cliutil.EnvOverride("SWIGGY_ACCESS_TOKEN"); v != "" {
		cfg.AccessToken = v
		cfg.markEnvOverride("AccessToken")
		cfg.AuthSource = "env:SWIGGY_ACCESS_TOKEN"
		cfg.CredentialSource = "env:SWIGGY_ACCESS_TOKEN"
	}
	...
	if v := cliutil.EnvOverride("SWIGGY_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	if v := cliutil.EnvOverride("SWIGGY_TOKEN_URL"); v != "" {
		cfg.TokenURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("SWIGGY_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "swiggy-pp-cli", "config.json"), nil
}
...
func (c *Config) AuthHeader() string {
	...
	// A directly-held bearer in SWIGGY_ACCESS_TOKEN (a pasted access token, or a
