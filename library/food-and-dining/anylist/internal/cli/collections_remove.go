	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !apply || dryRunOK(flags) {
				return collectionWritePreview(cmd, flags, "remove recipe "+bodyRecipe+" from collection "+bodyCollection, apply, map[string]any{"collection": bodyCollection, "recipe": bodyRecipe})
			}
