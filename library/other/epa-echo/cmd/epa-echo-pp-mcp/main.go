...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/other/epa-echo/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("EPA_ECHO_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "epa-echo-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
