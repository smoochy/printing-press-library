...
func buildAgentContext(rootCmd *cobra.Command) agentContext {
	return agentContext{
		...
		CLI: agentContextCLI{
			Name:        "govspend-pp-cli",
			Description: "Read-only public-sector spending and opportunity research CLI for USAspending, Grants.gov, and SAM.gov setup.",
		...
		Auth: agentContextAuth{
			...
			EnvVars: []agentContextAuthEnvVar{
				{
					Name:        "GOVSPEND_SAM_API_KEY",
					Kind:        "environment",
					Required:    false,
					Sensitive:   true,
					Description: "Optional SAM.gov Opportunities API key for procurement opportunity search.",
				},
			},
		},
