...
| 4 | Elenco temi | CKAN group_list/group_show | openbdap-pp-cli gruppi elenco | Conteggi e dataset dallo store locale |
...
| 7 | Download CSV integrale | tab "Scarica" del portale | openbdap-pp-cli scarica | Un comando invece di tre clic; https forzato (http fallisce) |
