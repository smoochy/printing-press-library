...
func Load(configPath string) (*Config, error) {
	cfg := &Config{
		BaseURL: "https://bdap-opendata.rgs.mef.gov.it",
	}
	...
	if v := cliutil.EnvOverride("OPENBDAP_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("OPENBDAP_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "openbdap-pp-cli", "config.toml"), nil
}
