...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/other/openbdap/internal/cli"
	...
	"github.com/mvanhorn/printing-press-library/library/other/openbdap/internal/learn"
	"github.com/mvanhorn/printing-press-library/library/other/openbdap/internal/mcp/bound"
	"github.com/mvanhorn/printing-press-library/library/other/openbdap/internal/mcp/cobratree"
...
func RegisterTools(s *server.MCPServer) {
	...
	s.AddTool(
		mcplib.NewTool("catalogo_dettaglio",
			mcplib.WithDescription("Metadati di un dataset (solo per UUID: i nomi non sono risolvibili). Required: id. Returns the Dataset."),
			mcplib.WithString("id", mcplib.Required(), mcplib.Description("UUID del dataset")),
			mcplib.WithReadOnlyHintAnnotation(true),
			mcplib.WithDestructiveHintAnnotation(false),
			mcplib.WithOpenWorldHintAnnotation(true),
		),
		makeAPIHandler("GET", "/SpodCkanApi/api/3/action/package_show", true, false, nil, mcpPageConfig{}, []mcpParamBinding{{PublicName: "id", WireName: "id", Location: "query"}}, []string{}),
	)
	s.AddTool(
		...
		makeAPIHandler("GET", "/SpodCkanApi/api/3/action/package_list", true, false, nil, mcpPageConfig{}, []mcpParamBinding{}, []string{}),
	)
	s.AddTool(
		mcplib.NewTool("catalogo_ricerca",
			mcplib.WithDescription("Ricerca testuale lato portale (il campo count non e' affidabile e fq viene ignorato). Required: q. Optional: rows (default: 20), start (default: 0). Returns array of Dataset."),
			mcplib.WithString("q", mcplib.Required(), mcplib.Description("Testo da cercare")),
			mcplib.WithNumber("rows", mcplib.Description("Numero di dataset da restituire")),
			mcplib.WithNumber("start", mcplib.Description("Dataset da saltare")),
			mcplib.WithReadOnlyHintAnnotation(true),
			mcplib.WithDestructiveHintAnnotation(false),
			mcplib.WithOpenWorldHintAnnotation(true),
		),
		makeAPIHandler("GET", "/SpodCkanApi/api/3/action/package_search", true, false, nil, mcpPageConfig{}, []mcpParamBinding{{PublicName: "q", WireName: "q", Location: "query"}, {PublicName: "rows", WireName: "rows", Location: "query", Default: "20"}, {PublicName: "start", WireName: "start", Location: "query", Default: "0"}}, []string{}),
	)
	s.AddTool(
		mcplib.NewTool("dati_colonne",
			mcplib.WithDescription("Colonne del dataset: nome leggibile, nome fisico, identificativo da usare nei filtri, tipo, cardinalita' e valori distinti. Required: id. Returns array of Colonna."),
			mcplib.WithString("id", mcplib.Required(), mcplib.Description("Identificativo OData della risorsa")),
			mcplib.WithReadOnlyHintAnnotation(true),
			mcplib.WithDestructiveHintAnnotation(false),
			mcplib.WithOpenWorldHintAnnotation(true),
		),
		makeAPIHandler("GET", "/ODataProxy/MdData('{id}@rgs')/DataColumns", true, false, nil, mcpPageConfig{}, []mcpParamBinding{{PublicName: "id", WireName: "id", Location: "path"}}, []string{"id"}),
	)
	s.AddTool(
		mcplib.NewTool("dati_conta",
			mcplib.WithDescription("Conta le righe del dataset, rispettando il filtro. Required: id. Optional: count (default: true), filtro. Returns array of Conteggio."),
			mcplib.WithString("id", mcplib.Required(), mcplib.Description("Identificativo OData della risorsa")),
			mcplib.WithBoolean("count", mcplib.Description("Chiede il totale invece delle righe")),
			mcplib.WithString("filtro", mcplib.Description("Filtro OData grezzo")),
			mcplib.WithOpenWorldHintAnnotation(true),
		),
		makeAPIHandler("GET", "/ODataProxy/MdData('{id}@rgs')/DataRows", false, false, nil, mcpPageConfig{}, []mcpParamBinding{{PublicName: "id", WireName: "id", Location: "path"}, {PublicName: "count", WireName: "count", Location: "query", Default: "true"}, {PublicName: "filtro", WireName: "$filter", Location: "query"}}, []string{"id"}),
	)
	s.AddTool(
		mcplib.NewTool("dati_metadati",
			mcplib.WithDescription("Metadati OData del dataset (ultimo aggiornamento, stato). Required: id. Returns the MetadatiOData."),
			mcplib.WithString("id", mcplib.Required(), mcplib.Description("Identificativo OData della risorsa (non l'UUID del dataset)")),
			mcplib.WithReadOnlyHintAnnotation(true),
			mcplib.WithDestructiveHintAnnotation(false),
			mcplib.WithOpenWorldHintAnnotation(true),
		),
		makeAPIHandler("GET", "/ODataProxy/MdData('{id}@rgs')", true, false, nil, mcpPageConfig{}, []mcpParamBinding{{PublicName: "id", WireName: "id", Location: "path"}}, []string{"id"}),
	)
	s.AddTool(
		mcplib.NewTool("dati_misure",
			mcplib.WithDescription("Misure numeriche dichiarate dal dataset. Required: id. Returns array of Misura."),
			mcplib.WithString("id", mcplib.Required(), mcplib.Description("Identificativo OData della risorsa")),
			mcplib.WithReadOnlyHintAnnotation(true),
			mcplib.WithDestructiveHintAnnotation(false),
			mcplib.WithOpenWorldHintAnnotation(true),
		),
		makeAPIHandler("GET", "/ODataProxy/MdData('{id}@rgs')/DataMeasures", true, false, nil, mcpPageConfig{}, []mcpParamBinding{{PublicName: "id", WireName: "id", Location: "path"}}, []string{"id"}),
	)
	s.AddTool(
		mcplib.NewTool("dati_righe",
			mcplib.WithDescription("Righe del dataset, con filtri OData. Required: id. Optional: top (default: 50), skip (default: 0), filtro (plus 2 more). Returns array of Riga."),
			mcplib.WithString("id", mcplib.Required(), mcplib.Description("Identificativo OData della risorsa")),
			mcplib.WithNumber("top", mcplib.Description("Numero massimo di righe (oltre 5000 il servizio va in timeout)")),
			mcplib.WithNumber("skip", mcplib.Description("Righe da saltare")),
			mcplib.WithString("filtro", mcplib.Description("Filtro OData grezzo, per esempio Cccodice_cup_1267962549 eq 'I77H11000120009'")),
			mcplib.WithString("campi", mcplib.Description("Identificativi di colonna da restituire, separati da virgola")),
			mcplib.WithString("ordina", mcplib.Description("Ordinamento, per esempio <colonna> desc")),
			mcplib.WithOpenWorldHintAnnotation(true),
		),
		makeAPIHandler("GET", "/ODataProxy/MdData('{id}@rgs')/DataRows", false, false, nil, mcpPageConfig{}, []mcpParamBinding{{PublicName: "id", WireName: "id", Location: "path"}, {PublicName: "top", WireName: "$top", Location: "query", Default: "50"}, {PublicName: "skip", WireName: "$skip", Location: "query", Default: "0"}, {PublicName: "filtro", WireName: "$filter", Location: "query"}, {PublicName: "campi", WireName: "$select", Location: "query"}, {PublicName: "ordina", WireName: "$orderby", Location: "query"}}, []string{"id"}),
	)
	s.AddTool(
		mcplib.NewTool("gruppi_dettaglio",
			mcplib.WithDescription("Dettaglio di un tema, con gli UUID dei dataset che contiene. Required: id. Returns the Gruppo."),
			mcplib.WithString("id", mcplib.Required(), mcplib.Description("Nome del tema, per esempio 172_opere-pubbliche")),
			mcplib.WithReadOnlyHintAnnotation(true),
			mcplib.WithDestructiveHintAnnotation(false),
			mcplib.WithOpenWorldHintAnnotation(true),
		),
		makeAPIHandler("GET", "/SpodCkanApi/api/3/action/group_show", true, false, nil, mcpPageConfig{}, []mcpParamBinding{{PublicName: "id", WireName: "id", Location: "query"}}, []string{}),
	)
	s.AddTool(
		...
		makeAPIHandler("GET", "/SpodCkanApi/api/3/action/group_list", true, false, nil, mcpPageConfig{}, []mcpParamBinding{}, []string{}),
	)
	s.AddTool(
		...
		makeAPIHandler("GET", "/SpodCkanApi/api/3/action/license_list", true, false, nil, mcpPageConfig{}, []mcpParamBinding{}, []string{}),
	)
	s.AddTool(
		mcplib.NewTool("scarica_csv",
			mcplib.WithDescription("Scarica l'intero dataset in CSV (separatore punto e virgola). Required: id."),
			mcplib.WithString("id", mcplib.Required(), mcplib.Description("UUID del dataset")),
			mcplib.WithReadOnlyHintAnnotation(true),
			mcplib.WithDestructiveHintAnnotation(false),
			mcplib.WithOpenWorldHintAnnotation(true),
		),
		makeAPIHandler("GET", "/SpodCkanApi/api/3/datastore/dump/{id}.csv", true, false, nil, mcpPageConfig{}, []mcpParamBinding{{PublicName: "id", WireName: "id", Location: "path"}}, []string{"id"}),
	)
	s.AddTool(
		...
		makeAPIHandler("GET", "/SpodCkanApi/api/3/action/tag_list", true, false, nil, mcpPageConfig{}, []mcpParamBinding{}, []string{}),
	)
	...
	s.AddTool(
		mcplib.NewTool("sql",
			...
			mcplib.WithString("query", mcplib.Required(), mcplib.Description("SQL query (SELECT or WITH...SELECT). Synced records live in resources(resource_type, id, data); filter by resource_type and use json_extract on data, e.g. SELECT json_extract(data,'$.name') FROM resources WHERE resource_type='catalogo'.")),
			mcplib.WithReadOnlyHintAnnotation(true),
			mcplib.WithDestructiveHintAnnotation(false),
		),
		handleSQL,
		...
		if err != nil {
			...
			case strings.Contains(msg, "HTTP 401"):
				return mcpToolError("authentication failed: " + msg +
					...
					"\n      Run 'openbdap-pp-cli doctor' to check auth status."), nil
...
func openMCPReadOnlyStore(path string) (*store.Store, *mcplib.CallToolResult) {
	...
	if err != nil {
		return nil, mcplib.NewToolResultError(fmt.Sprintf("opening local data store %s: %v. Run openbdap-pp-cli sync to refresh the store, or use live endpoint MCP tools for unsynced data.", path, err))
	}
	return db, nil
}

func mcpMissingStoreMessage(path string) string {
	return fmt.Sprintf("No local data store found at %s. Run openbdap-pp-cli sync before using MCP search/sql, or use live endpoint MCP tools for unsynced data.", path)
}
...
func mcpEmptyStoreNextStep() string {
	return "Run openbdap-pp-cli sync to populate the local SQLite store before using MCP search/sql."
}

func mcpPartialStoreNextStep() string {
	return "The latest sync attempt is incomplete. Resume or rerun openbdap-pp-cli sync before treating local search/sql results as a complete snapshot."
}
...
func mcpSQLQueryError(queryCtx context.Context, err error) string {
	...
	if strings.Contains(strings.ToLower(msg), "no such table") {
		return fmt.Sprintf("query failed: %v. Synced records live in resources(resource_type, id, data), not one SQL table per resource. Filter by resource_type, for example resource_type='catalogo', and read JSON fields with json_extract(data,'$.field').", err)
	}
...
func handleContextResult(s *server.MCPServer, _ context.Context, _ mcplib.CallToolRequest) (*mcplib.CallToolResult, error) {
	...
	ctx := map[string]any{
		...
		"tool_surface": "MCP exposes typed endpoint tools plus a runtime mirror of user-facing CLI commands. Endpoint tools keep typed schemas; command-mirror tools shell out to the companion openbdap-pp-cli binary.",
		...
		"resources": []map[string]any{
			{
				...
				"endpoints":   []string{"dettaglio", "elenco", "ricerca"},
				"syncable":    true,
				"searchable":  true,
			},
			{
				...
				"endpoints":   []string{"colonne", "conta", "metadati", "misure", "righe"},
				"searchable":  true,
				"writable":    true,
			},
			{
				...
				"endpoints":   []string{"dettaglio", "elenco"},
				"syncable":    true,
				"searchable":  true,
			},
			{
		...
		"command_mirror_capabilities": registeredCommandMirrorCapabilities(s, []map[string]string{
			...
			{"name": "Mappa della famiglia MOP", "command": "mop", "cli_command": "mop", "description": "Quale dataset MOP interrogare per ogni regione e ruolo, con il relativo identificativo OData.", "rationale": "Lato OData non esiste alcun elenco: ruolo e regione si ricavano dai nomi dei dataset conservati nello store.", "via": "mcp-command-mirror"},
		...
		"playbook": []map[string]string{
			...
			{"topic": "Ricerca per CIG", "insight": "Il CIG non compare nel dataset nazionale e va cercato in parallelo sui dataset di gare e partecipanti regionali."},
		},
	}
