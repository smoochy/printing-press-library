...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"openbdap-pp-cli auth login",
		"openbdap-pp-cli doctor",
		"openbdap-pp-cli help items",
		"openbdap-pp-cli sync",
		"openbdap-pp-cli profile list",
		"openbdap-pp-cli feedback list",
		"openbdap-pp-cli which",
		"openbdap-pp-cli agent-context",
		"openbdap-pp-cli completion bash",
		"openbdap-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"openbdap-pp-cli recall",
		"openbdap-pp-cli learnings",
		"openbdap-pp-cli teach-pattern",
		"openbdap-pp-cli teach-lookup",
		"openbdap-pp-cli items list",
	}
