...
var whichIndex = []whichEntry{
	{Command: "dossier", Description: "Il quadro completo di un'opera pubblica a partire dal CUP: progetto, pagamenti, gare, partecipanti, piano dei costi e soggetti titolari.", Group: "Opere pubbliche trasversali", WhyItMatters: "Usalo quando ti serve tutto su un'opera e hai solo il CUP, invece di cinque chiamate OData con filtri diversi."},
	{Command: "serie", Description: "Le annualita', le mensilita' e le regioni disponibili di una stessa serie di dataset.", Group: "Catalogo che si capisce", WhyItMatters: "Usalo per sapere se esiste l'annualita' che ti serve senza scorrere il catalogo."},
	{Command: "opere", Description: "Le opere pubbliche in capo a un ente, a partire dal suo codice fiscale, con il totale reale.", Group: "Opere pubbliche trasversali", WhyItMatters: "Usalo per capire quante e quali opere risultano a un'amministrazione."},
	{Command: "novita", Description: "I dataset il cui ultimo aggiornamento cade nella finestra indicata.", Group: "Catalogo che si capisce", WhyItMatters: "Usalo per sapere cosa e' cambiato di recente senza riscaricare il catalogo."},
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one. Machine output (--json/--csv/--plain/--quiet, or a pipe) still exits 2 and writes {"matches":[]} (or the equivalent empty table) to stdout.`,
		SilenceUsage: true,
		Example: `  openbdap-pp-cli which "stale tickets"
  openbdap-pp-cli which "bottleneck"
  openbdap-pp-cli which --limit 1 "send message"
  openbdap-pp-cli which                                # list the full capability index`,
