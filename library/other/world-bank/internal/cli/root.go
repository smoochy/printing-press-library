...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "world-bank-pp-cli",
		Short: `Every World Bank indicator, queryable offline with cross-country SQL no wrapper has.`,
		Long: `Every World Bank indicator, queryable offline with cross-country SQL no wrapper has.
...
Health check: run 'world-bank-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("world-bank-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'world-bank-pp-cli profile list')")
	...
	rootCmd.AddCommand(newIndicatorsCmd(flags))
	...
	rootCmd.AddCommand(newNovelTrendCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newDataPromotedCmd(flags))
	rootCmd.AddCommand(newIncomeLevelsPromotedCmd(flags))
	rootCmd.AddCommand(newLendingTypesPromotedCmd(flags))
