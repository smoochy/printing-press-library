...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/other/screener/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("SCREENER_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "screener-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
