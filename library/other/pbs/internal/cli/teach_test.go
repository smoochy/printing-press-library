...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"pbs-pp-cli auth login",
		"pbs-pp-cli doctor",
		"pbs-pp-cli help items",
		"pbs-pp-cli sync",
		"pbs-pp-cli profile list",
		"pbs-pp-cli feedback list",
		"pbs-pp-cli which",
		"pbs-pp-cli agent-context",
		"pbs-pp-cli completion bash",
		"pbs-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"pbs-pp-cli teach",
		"pbs-pp-cli recall",
		"pbs-pp-cli learnings",
		"pbs-pp-cli teach-pattern",
		"pbs-pp-cli teach-lookup",
		"pbs-pp-cli items list",
	}
