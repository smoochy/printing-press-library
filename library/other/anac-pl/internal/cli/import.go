...
but do not stop the import.`,
  ...
  anac-pl-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  anac-pl-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | anac-pl-pp-cli import <resource> --input -`,
