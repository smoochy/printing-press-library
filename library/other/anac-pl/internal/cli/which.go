...
var whichIndex = []whichEntry{
	...
	{Command: "cig check", Description: "Verifica struttura e cifra di controllo di un CIG, offline", Group: "cig", WhyItMatters: "Verifica struttura e cifra di controllo di un CIG, offline"},                                                                                   // pp:which-promoted
	{Command: "tipologie schede", Description: "Descrive i codici scheda degli avvisi (AD3, A1_29, P1_16), offline", Group: "tipologie", WhyItMatters: "Descrive i codici scheda degli avvisi (AD3, A1_29, P1_16), offline"},                                                      // pp:which-promoted
