# ANAC Pubblicità a Valore Legale Printed CLI Agent Guide

This directory is a generated `anac-pl-pp-cli` printed CLI. It was produced by [CLI Printing Press](https://github.com/mvanhorn/cli-printing-press), so treat systemic fixes as upstream Printing Press fixes first. Keep local edits narrow and document why a generated-tree patch belongs here.
...
anac-pl-pp-cli agent-context --pretty
```

Use runtime discovery instead of relying on a copied command list:

```bash
anac-pl-pp-cli which "<capability>" --json
anac-pl-pp-cli <command> --help
```
...
```bash
anac-pl-pp-cli <command> --help
anac-pl-pp-cli <command> --dry-run --agent
```
