...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/other/cfpb-complaints/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("CFPB_COMPLAINTS_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "cfpb-complaints-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
