...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/other/passive-indices/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("PASSIVE_INDICES_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "passive-indices-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
