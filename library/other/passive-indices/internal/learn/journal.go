...
const (
	journalSessionEnvVar   = "PASSIVE_INDICES_LEARN_SESSION"
	journalNoLearnEnvVar   = "PASSIVE_INDICES_NO_LEARN"
	journalNoCaptureEnvVar = "PASSIVE_INDICES_LEARN_NO_CAPTURE"
)
