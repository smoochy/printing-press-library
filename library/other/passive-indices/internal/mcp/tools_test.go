...
func TestMCPPathResolutionMatchesCLIResolverWithHomeEnv(t *testing.T) {
	...
	t.Setenv("PASSIVE_INDICES_HOME", root)
...
func TestMCPPathResolutionMatchesCLIResolverWithPlatformDefaults(t *testing.T) {
	...
	if want := filepath.Join(home, ".config", "passive-indices-pp-cli", "config.toml"); cfg.Path != want {
	...
	if want := filepath.Join(home, ".local", "share", "passive-indices-pp-cli", "data.db"); gotDB != want {
...
func resetMCPPathEnv(t *testing.T) string {
	...
	for _, name := range []string{
		"PASSIVE_INDICES_CONFIG",
		"PASSIVE_INDICES_CONFIG_DIR",
		"PASSIVE_INDICES_DATA_DIR",
		"PASSIVE_INDICES_STATE_DIR",
		"PASSIVE_INDICES_CACHE_DIR",
		"PASSIVE_INDICES_HOME",
		"XDG_CONFIG_HOME",
		"XDG_DATA_HOME",
		"XDG_STATE_HOME",
		"XDG_CACHE_HOME",
...
func TestMCPRegisterToolsPreservesTypedSpecialTools(t *testing.T) {
	s := server.NewMCPServer("passive-indices", "test")
	RegisterTools(s)
