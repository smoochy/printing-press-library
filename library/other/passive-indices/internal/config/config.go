...
func Load(configPath string) (*Config, error) {
	...
	if v := os.Getenv("PASSIVE_INDICES_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("PASSIVE_INDICES_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "passive-indices-pp-cli", "config.toml"), nil
}
