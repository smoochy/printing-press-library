...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("PASSIVE_INDICES_STATE_DIR", "")
	t.Setenv("PASSIVE_INDICES_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"passive-indices-pp-cli auth login",
		"passive-indices-pp-cli doctor",
		"passive-indices-pp-cli help items",
		"passive-indices-pp-cli sync",
		"passive-indices-pp-cli profile list",
		"passive-indices-pp-cli feedback list",
		"passive-indices-pp-cli which",
		"passive-indices-pp-cli agent-context",
		"passive-indices-pp-cli completion bash",
		"passive-indices-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"passive-indices-pp-cli recall",
		"passive-indices-pp-cli learnings",
		"passive-indices-pp-cli teach-pattern",
		"passive-indices-pp-cli teach-lookup",
		"passive-indices-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("passive-indices-pp-cli")); err == nil {
