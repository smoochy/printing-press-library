...
type rootFlags struct {
	...
	// invocation. Mirrors the PASSIVE_INDICES_NO_LEARN env var.
	noLearn       bool
	selectFields  string
	configPath    string
	homePath      string
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "passive-indices-pp-cli",
		Short: `Passive Indices CLI — Unifies NSE's index data with the ETFs and index funds that track them — a join neither source site offers.`,
		Long: `Passive Indices CLI — Unifies NSE's index data with the ETFs and index funds that track them — a join neither source site offers.
...
See README.md or the bundled SKILL.md for recipes.`,
	...
	rootCmd.SetVersionTemplate("passive-indices-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'passive-indices-pp-cli profile list')")
	...
	rootCmd.AddCommand(newIndexCmd(flags))
	...
	rootCmd.AddCommand(newNovelFundCmd(flags))
