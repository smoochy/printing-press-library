...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  passive-indices-pp-cli which "stale tickets"
  passive-indices-pp-cli which "bottleneck"
  passive-indices-pp-cli which --limit 1 "send message"
  passive-indices-pp-cli which                                # list the full capability index`,
