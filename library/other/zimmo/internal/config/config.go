...
func Load(configPath string) (*Config, error) {
	cfg := &Config{
		BaseURL: "https://search-api.zimmo.be",
	}
	...
	if v := cliutil.EnvOverride("ZIMMO_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("ZIMMO_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "zimmo-pp-cli", "config.toml"), nil
}
