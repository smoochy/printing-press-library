...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"zimmo-pp-cli auth login",
		"zimmo-pp-cli doctor",
		"zimmo-pp-cli help items",
		"zimmo-pp-cli sync",
		"zimmo-pp-cli profile list",
		"zimmo-pp-cli feedback list",
		"zimmo-pp-cli which",
		"zimmo-pp-cli agent-context",
		"zimmo-pp-cli completion bash",
		"zimmo-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"zimmo-pp-cli teach",
		"zimmo-pp-cli recall",
		"zimmo-pp-cli learnings",
		"zimmo-pp-cli teach-pattern",
		"zimmo-pp-cli teach-lookup",
		"zimmo-pp-cli items list",
	}
