...
Resource scoping:
  ...
  zimmo-pp-cli sync --resources geocode,places

  # Full resync (ignore previous checkpoint)
  zimmo-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  zimmo-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  zimmo-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  zimmo-pp-cli sync --latest-only`,
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{ // #nosec G101 -- endpoint paths, not credentials.
		"geocode":       "https://geo-api.zimmo.be/geocode",
		"places":        "https://geo-api.zimmo.be/places/by-postal-code-and-or-name",
		"sublocalities": "https://geo-api.zimmo.be/sublocalities",
	}
