...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"immovlan-pp-cli auth login",
		"immovlan-pp-cli doctor",
		"immovlan-pp-cli help items",
		"immovlan-pp-cli sync",
		"immovlan-pp-cli profile list",
		"immovlan-pp-cli feedback list",
		"immovlan-pp-cli which",
		"immovlan-pp-cli agent-context",
		"immovlan-pp-cli completion bash",
		"immovlan-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"immovlan-pp-cli recall",
		"immovlan-pp-cli learnings",
		"immovlan-pp-cli teach-pattern",
		"immovlan-pp-cli teach-lookup",
		"immovlan-pp-cli items list",
	}
