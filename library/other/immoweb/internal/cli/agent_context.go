...
func buildAgentDiscoveryContext() *agentContextDiscovery {
	return &agentContextDiscovery{
		...
		TargetURL:     "https://www.immoweb.be/en/search-results",
		EntryCount:    12,
		APIEntryCount: 12,
		...
		CandidateCommands: []string{
			"get_get_result — Derived from observed GET /en/classified/get-result/{get_result_id} traffic.",
			"list_autocomplete — Derived from observed GET /en/search/autocomplete traffic.",
			"list_search_results — Derived from observed GET /en/search-results traffic.",
			"list_search_results_count — Derived from observed GET /en/search-results-count traffic.",
			"list_search_results_map — Derived from observed GET /en/search-results-map traffic.",
			"list_search_similar_results — Derived from observed GET /en/search-similar-results traffic.",
		},
	}
}
