...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"immoweb-pp-cli auth login",
		"immoweb-pp-cli doctor",
		"immoweb-pp-cli help items",
		"immoweb-pp-cli sync",
		"immoweb-pp-cli profile list",
		"immoweb-pp-cli feedback list",
		"immoweb-pp-cli which",
		"immoweb-pp-cli agent-context",
		"immoweb-pp-cli completion bash",
		"immoweb-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"immoweb-pp-cli recall",
		"immoweb-pp-cli learnings",
		"immoweb-pp-cli teach-pattern",
		"immoweb-pp-cli teach-lookup",
		"immoweb-pp-cli items list",
	}
