...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/other/nepra/internal/cliutil/testenv"
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"nepra-pp-cli auth login",
		"nepra-pp-cli doctor",
		"nepra-pp-cli help items",
		"nepra-pp-cli sync",
		"nepra-pp-cli profile list",
		"nepra-pp-cli feedback list",
		"nepra-pp-cli which",
		"nepra-pp-cli agent-context",
		"nepra-pp-cli completion bash",
		"nepra-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"nepra-pp-cli teach",
		"nepra-pp-cli recall",
		"nepra-pp-cli learnings",
		"nepra-pp-cli teach-pattern",
		"nepra-pp-cli teach-lookup",
		"nepra-pp-cli items list",
	}
