...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/other/cpsc-recalls/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("CPSC_RECALLS_LEARN_SURFACE", "mcp")
	s := server.NewMCPServer(
		"Cpsc Recall Retrieval",
		version,
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "cpsc-recalls-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
