...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/other/fec/internal/mcp"
...
func main() {
	...
	_ = os.Setenv("FEC_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "fec-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
