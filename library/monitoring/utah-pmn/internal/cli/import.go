...
but do not stop the import.`,
  ...
  utah-pmn-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  utah-pmn-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | utah-pmn-pp-cli import <resource> --input -`,
