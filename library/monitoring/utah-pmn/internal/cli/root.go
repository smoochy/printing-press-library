...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "utah-pmn-pp-cli",
		Short: `Monitor Utah public-body meetings, agendas, and minutes from the state Public Notice Website — tuned for land-use approval tracking in Delta City and Millard County.`,
		Long: `Monitor Utah public-body meetings, agendas, and minutes from the state Public Notice Website — tuned for land-use approval tracking in Delta City and Millard County.
...
Health check: run 'utah-pmn-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("utah-pmn-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'utah-pmn-pp-cli profile list')")
	...
	rootCmd.AddCommand(newNovelLanduseCmd(flags))
	rootCmd.AddCommand(newNovelLocationsCmd(flags))
	rootCmd.AddCommand(newNovelMillardCmd(flags))
	rootCmd.AddCommand(newNovelSinceCmd(flags))
	rootCmd.AddCommand(newNovelWatchCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newNoticePromotedCmd(flags))
