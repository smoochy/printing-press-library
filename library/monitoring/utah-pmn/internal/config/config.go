...
func Load(configPath string) (*Config, error) {
	cfg := &Config{
		BaseURL: "https://www.utah.gov/pmn",
	}
	...
	if v := os.Getenv("UTAH_PMN_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("UTAH_PMN_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "utah-pmn-pp-cli", "config.json"), nil
}
